...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
	                                   $as_denfuefin,$as_codigo,$as_nombre,$as_conordcom,$as_rifpro,$as_diaplacom,$ls_condicion,$as_dirpro,
									   $ls_forpagcom,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 21/06/2007                                Fecha Creación: 13/03/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->line(15,40,585,40);
		$io_pdf->line(480,690,480,760);   // Linea vertical
		$io_pdf->line(480,730,585,730);  // Linea horizontal fecha y numero
		...
		/*$ls_titulo1="<b>CAFE VENEZUELA S.A.</b>";
		$ls_titulo2="<b>CAPITAL SOCIAL SUSCRITO Y PAGADO 2.357.083.000,00</b>";
		$ls_titulo3="<b>CARRETERA PRINCIPAL,EL CRUCE MONAY,SECTOR TABOR,LOCAL S/N.</b>";
		$ls_titulo4="<b>PAMPAN ESTADO TRUJILLO.TELF: (0272)6781018 - 6781718 FAX:(0272)6781752</b>";
		$io_pdf->addText(250,740,9,$ls_titulo1); // Agregar el título
		$io_pdf->addText(165,730,9,$ls_titulo2); // Agregar el título 130
		$io_pdf->addText(130,720,9,$ls_titulo3); // Agregar el título
		$io_pdf->addText(120,710,9,$ls_titulo4); // Agregar el título*/
                $io_pdf->addText(230,730,14,$ls_titulo); // Agregar el título
		...
		$io_pdf->addText(40,122,7,"SOLICITADO POR"); // Agregar el título
              $io_pdf->addText(40,108,7,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(43,63,7,"FIRMA Y FECHA"); // Agregar el título
		$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(167,122,7,"APROBADO POR"); // Agregar el título
              $io_pdf->addText(148,108,7,"JEFE DE ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(167,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(300,122,7,"APROBADO POR"); // Agregar el título
              $io_pdf->addText(290,108,7,"JEFE DE PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(305,63,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(470,122,7,"AUTORIZADO POR"); // Agregar el título
              $io_pdf->addText(480,108,7,"PRESIDENTE"); // Agregar el título
		$io_pdf->addText(480,63,7,"PRESIDENCIA"); // Agregar el título
		...
		$la_data[1]=array('columna1'=>'<b>Unidad Ejecutora</b>    '.$ls_uniadm,'columna2'=>'<b>Forma de Pago</b>    '.$ls_forpagcom,
		                  'columna3'=>'<b>Condición de Pago</b>    '.$ls_condicion);
		...
		//$la_data[1]=array('columna1'=>'<b>Concepto</b>         '.$as_consol); //OLGA
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_condicion,$ls_dirpro,$ls_forpagcom,&$io_pdf);
