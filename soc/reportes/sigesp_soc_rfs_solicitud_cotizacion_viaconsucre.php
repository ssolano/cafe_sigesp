<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_vycs.jpg',40,705,555,55); // Agregar Logo
		$li_tm=$io_pdf->getTextWidth(10,$as_titulo);		
		$io_pdf->addText(200,720,14,"<b>".$as_titulo."</b>"); // Agregar el título
		$io_pdf->addText(430,725,8,"<b>   No.:</b>");      // Agregar texto
		$io_pdf->addText(465,725,8,$as_numsolcot); // Agregar Numero de la solicitud
		$io_pdf->addText(420,715,8,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(465,715,8,$as_fecsolcot); // Agregar la Fecha
		$io_pdf->addText(555,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(560,760,7,date("h:i a")); // Agregar la hora
		$io_pdf->addText(40,698.9,7,"G-20005595-2"); // Agregar el título
		$io_pdf->addText(40,693.8,7,"Av. Lecuna, Parque Central, Torre Este, piso 1, Oficina 1"); // Agregar el título
...
/*		$io_pdf->addText(17,130,8,"NOTA: Toda Cotización debe llevar:"); // Agregar el título
		$io_pdf->addText(17,117,8,".Condiciones de Pago"); // Agregar el título
		$io_pdf->addText(17,107,8,".Tiempo de Entrega"); // Agregar el título
		$io_pdf->addText(17,97,8,".Garantia"); // Agregar el título
		$io_pdf->addText(17,87,8,".Si incluye IVA"); // Agregar el título
		$io_pdf->addText(17,77,8,".Validez de la Oferta"); // Agregar el título
		$io_pdf->addText(425,125,9,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$io_pdf->addText(230,63,8,"Enviar Cotización al FAX No. (0212) 576-84-19"); // Agregar el título
		$io_pdf->line(300,73,300,138);	//VERTICAL		
