<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,680,11,'<b>'.$as_titulo.'</b>'); // Agregar el t�tulo
	...
	function uf_print_cabecera($as_nomemp,$as_codper,$as_nompro,$as_nomrespro,$ls_nomper,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data=array(array('name'=>'Entre <b>'.$as_nomemp.'</b> representado en este acto por el ciudadano <b>'.$ls_nomper.'</b> por una parte y por la otra "LA EMPRESA" <b>'.$as_nompro.'</b> representada en este acto por el ciudadano <b>'.$as_nomrespro.'</b>, se ha procedido a efectuar la recepci�n de los servicios consistentes en: '));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>'centre', // Orientaci�n de la tabla
	...
	function uf_print_cuerpo($as_nomemp,$as_numordcom,$ad_fecordcom,$ai_montot,$as_totordser,$as_ciuemp,$ad_fecrecser,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-15);
		$la_data1[1]=array('empresa'=>"ENTREGA CONFORME",'empresa1'=>"RECIBE CONFORME");
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>490, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'rowGap' => 1.5 ,
						 'cols'=>array('empresa'=>array('justification'=>'left','width'=>245), // Justificaci�n y ancho de la columna
						 			   'empresa1'=>array('justification'=>'left','width'=>245))); // Justificaci�n y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-10);
		$la_columna=array('denser'=>'<b>Denominacion</b>',
						  'canser'=>'<b>Cantidad</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('denser'=>array('justification'=>'left','width'=>340), // Justificaci�n y ancho de la columna
						 			   'canser'=>array('justification'=>'right','width'=>80), // Justificaci�n y ancho de la columna
						 			   'monuniser'=>array('justification'=>'right','width'=>70))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	if ($lb_valido)
	   {
		 ...
		 if ($lb_valido==false) // Existe alg�n error � no hay registros
		 ...
		 else // Imprimimos el reporte
		    {
			  ...
			  $io_pdf->ezSetCmMargins(4,3,2,2.2); // Configuraci�n de los margenes en cent�metros
			  ...
			  if ($li_numrows>0)
			     {
				           ...
				           if ($li_i==1)
						      {
				                ...
				                $ls_contenido="Entre <b>".$ls_nomemp."</b> representado en este acto por el ciudadano <b>".$ls_nomper."</b> por una parte y por la otra 'LA EMPRESA' <b>".$ls_nompro."</b> representada en este acto por el ciudadano <b>".$ls_nomreppro."</b>, se ha procedido a efectuar la recepcion de los servicios consistentes en: ";
					...
					$io_pdf->ezSetDy(-5);
					$ls_contenido="Los cuales fueron concluidos en fecha <b>".$ls_fecaceser."</b> segun Orden de Servicio # <b>".
											  $ls_numordcom."</b> de fecha <b>".$ls_fecordcom."</b>   Acta levantada al efecto, en la forma siguiente:";
					$io_pdf->ezText($ls_contenido,9,array('justification' =>'full','spacing' =>1));
					$io_pdf->ezSetDy(-5);
					$ls_contenido="El representante del '<b>".$ls_nomemp."</b>', luego de haber constatado que 'LA EMPRESA' ejecuto los servicios señalados en la referida Orden de Servicio, declara ACEPTADOS dichos servicios.";
					$io_pdf->ezText($ls_contenido,9,array('justification' =>'full','spacing' =>1));
					$io_pdf->ezSetDy(-5);
