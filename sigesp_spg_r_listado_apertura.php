...
?>
  ...
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
	   ...
	   ?>
        <table width="275" height="77" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="formato-blanco">
            ...
            <td width="59" colspan="6"><a href="javascript:catalogo_estpro2();"></a><a href="javascript:catalogo_estpro3();"></a></td>
          </tr>
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td height="20">
            ...
            <td width="59" colspan="6"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
          <tr class="formato-blanco">
      ...
      <td width="292" align="center"><div align="left">
        <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td colspan="3" align="center"><label>
        <input name="chksaldol" type="checkbox" id="chksaldol" value="checkbox">
      Mostrar Saldos en Dolares</label></td>
    </tr>
    <tr>
		...
		if(estmodest==1)
		{
			   pagina="reportes/"+ls_reporte+"?codestpro1="+codestpro1
				...
				+"&codestpro3h="+codestpro3h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
							+"&estclades="+estclades+"&estclahas="+estclahas+"&saldol="+saldol;
...
function catalogo_estpro4()
{
	...
	else
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!=""))
		{
			pagina="sigesp_cat_public_estpro4.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&tipo=reporte&estcla="+estcla;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");	
		}
		else
		{
...
function catalogo_estpro5()
{
	...
	if((codestpro2=='**')||(codestpro1=='**')||(codestpro3=='**')||(codestpro4=='**'))
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!="")&&(codestpro4!=""))
		{
			pagina="sigesp_cat_estpro5.php?tipo=reporte&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&estcla="+estcla;;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
