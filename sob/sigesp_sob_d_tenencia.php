        ...
        <td width="516" height="161"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td><textarea name="txtdesten" cols="53" rows="2" id="txtdesten" value="<?php print $ls_desten; ?>"  onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event))"><?php print $ls_desten?></textarea></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
