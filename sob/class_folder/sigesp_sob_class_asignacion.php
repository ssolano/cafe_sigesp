	...
	function uf_update_dtcargos($as_codasi,$as_basimp,$aa_cargosnuevos,$ai_totalfilas,$aa_seguridad)
	{
		...
		if($lb_existe)
		{
			for ($li_i=1;$li_i<$li_totalnuevas;$li_i++)
			{
				...
				if (!$lb_existe)
				{
					$lb_valido=$this->uf_guardar_dtcargos($as_codasi,$aa_cargosnuevos["codcar"][$li_i],$as_basimp,$aa_cargosnuevos["moncar"][$li_i],$aa_cargosnuevos["formula"][$li_i],$aa_cargosnuevos["codestpro"][$li_i],$aa_cargosnuevos["spgcuenta"][$li_i],$aa_seguridad);
					if(!$lb_valido)
					{return false;}
				}
			}
