...
<table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      <tr>
        ...
        <input name="estmodest" type="hidden" id="estmodest" value="<?php print $ls_modalidad; ?>"></td>
      </tr>
      <tr>
...
{
	window.open("sigesp_cat_estpre1.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	f=document.formulario;
	f.estcla.value="";
