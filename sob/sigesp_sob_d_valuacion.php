	...
	if ($ls_operacion != "ue_cargarcargo" && $ls_operacion != "ue_removercargo")
	{
		...
		{		
			...
			$la_objectcargos[$li_i][2]="<input name=txtnomcar".$li_i." type=text id=txtnomcar".$li_i." class=sin-borde style= text-align:left size=60 value='".$ls_nombre."' readonly >".
										"<input name=codestpro".$li_i." type=text id=codestpro".$li_i." value='".$ls_codestpro."'><input name=spgcuenta".$li_i." type=hidden id=spgcuenta".$li_i." value='".$ls_spgcuenta."'><input name=estcla".$li_i." type=hidden id=estcla".$li_i." value='".$ls_estcla."'>";
...
elseif($ls_operacion=="ue_cargarcargo")
{
	...
	for($li_i=1;$li_i<$li_filascargos;$li_i++)
	{
		...
		$ls_nombre=$_POST["txtnomcar".$li_i];
		$ls_formula=$_POST["formu".$li_i];
		$ls_codestpro=$_POST["codestpro".$li_i];	print "->".$ls_codestpro;
		$ls_spgcuenta=$_POST["spgcuenta".$li_i];
		$ls_estcla=$_POST["estcla".$li_i];
	...
	for($li_i=1;$li_i<=$li_filascargos;$li_i++)
	{
		...
		{		
			...
			$la_objectcargos[$li_temp][2]="<input name=txtnomcar".$li_temp." type=text id=txtnomcar".$li_temp." class=sin-borde style= text-align:left size=60 value='".$ls_nombre."' readonly >".
										  "<input name=codestpro".$li_temp." type=text id=codestpro".$li_temp." value='".$ls_codestpro."' ><input name=spgcuenta".$li_temp." type=hidden id=spgcuenta".$li_temp." value='".$ls_spgcuenta."' ><input name=estcla".$li_temp." type=hidden id=estcla".$li_temp." value='".$ls_estcla."'>";
   ...
   /*****************************************************************************************/ 	 
	if($lb_valido)
	{
		...
		for ($li_i=1;$li_i<$li_filascargos;$li_i++)
		{
			...
			$la_cargos["codestpro"][$li_i]=$_POST["codestpro".$li_i];print "->".$_POST["codestpro".$li_i];
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
       ...
       <tr class="formato-blanco">
        ...
        <td colspan="4"><input name="txtfecha" type="text" id="txtfecha" value="<?php print $ls_fecha; ?>" size="10" maxlength="10" readonly="true" style="text-align:center"></td>
      </tr>
	  <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
        <td height="22"><div align="right">Fecha Inicio </div></td>
        <td width="83"><input name="txtfecinival" type="text" id="txtfecinival"  style="text-align:left" value="<?php print $ls_fecinival; ?>" size="11" maxlength="11"   onKeyPress="javascript:ue_validafecha();" datepicker="true" readonly="true"></td>
        <td width="158"><div align="right">Fecha Fin </div></td>
        <td width="155"><input name="txtfecfinval" type="text" id="txtfecfinval"  style="text-align:left" value="<?php print $ls_fecfinval; ?>" size="11" maxlength="11"   onKeyPress="javascript:ue_validafecha();" datepicker="true" readonly="true"></td>
        <td>&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
...
%            </span></td>
      ...
      <tr class="formato-blanco">
        ...
        <td><input name="txttotreten" type="text" id="txttotreten" value="<?php print $ls_totreten ?>" style="text-align:right "></td>
      </tr>
      <tr class="formato-blanco">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="22" colspan="2"><div align="left">
          ...
          <a href="javascript: ue_buscartipodocumento();"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar tipo de Documento" width="15" height="15" border="0"></a>
...
function ue_cargarvaluacion(ls_codval,ls_codasi,ls_codcon,ls_fecha,ls_fecinival,ls_fecfinval,ls_obsval,ls_amoval,ls_obsamoval,ls_amoantval,ls_amototval,ls_amoresval,ls_basimpval,ls_montotval,ls_subtotpar,ls_totreten,ls_subtot,ls_nomestval)
{
    f=document.form1;
