		...
		{		
			...
			if($lb_valido)
			{
				for($li_i=1;$li_i<$li_filasgarantias;$li_i++)
				{
					...
					{
						   $io_msg->message("Hubo un error al intentar insertar la garantia $li_i");
						   $lb_valido=false;
						   break;
					}
				}
			...
			if($lb_valido)
			{
				...
				if($li_estado==1 && $li_estadocontabilizacion==0)
				{
					...
					if($lb_valido)
					{
						...
						$lb_valido=$io_contrato->uf_update_condiciones($ls_codcon,$la_condiciones,$li_filascondiciones,$la_seguridad);
						...
						$lb_valido=$io_contrato->uf_update_garantias($ls_codcon ,$la_garantias,$li_filasgarantias,$la_seguridad);
...
<div align="right"></div></td>
      ...
      <tr class="formato-blanco">
        <td height="39">&nbsp;</td>
        <td height="39"><div align="right">Prefijo</div></td>
        <td height="39" colspan="6" align="left" valign="middle" id="tbcombo" >
		<?Php
			$lb_valido=$io_contrato->uf_llenarcombo_prefijos($la_datos);					
			if($lb_valido)
			{
				$io_datastore->data=$la_datos;
				$li_totalfilas=$io_datastore->getRowCount("precon");					
			}
			else
			{
				$li_totalfilas=0;
			...
			print "<script>";
			print "combojs=new ComboBox('combojs',document.getElementById('tbcombo'));";
			print "combojs.add(";
			for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
			{
				$ls_prefijo=$io_datastore->getValue("precon",$li_i);
				if($li_i==$li_totalfilas)
					print "new ComboBoxItem('".$ls_prefijo."','".$ls_prefijo."')";		
				else
					print "new ComboBoxItem('".$ls_prefijo."','".$ls_prefijo."'),";
			}	
			print  ");";			
			if($ls_hidprefijo!="")
				print "combojs.choose('".$ls_hidprefijo."','".$ls_hidprefijo."');";			
			print "</script>"; 
		...
		?>        
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Código
			<input name="txtcodcon" id="txtcodcon"    readonly="true" style="text-align:center " value="<?php print $ls_codcon?>" type="text" size="12" maxlength="12">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <td height="39"><div align="right">Fecha</div></td>
        <td width="173" height="39"><input name="txtfeccon" type="text" id="txtfeccon"  style="text-align:center" value="<?php print $ls_feccon ?>" size="10" maxlength="10"  readonly="true" ></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
...
<input name="txtdestipcon" type="text" class="sin-borde" value="<?php print $ls_destipcon ?>" readonly="true"></td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="26" rowspan="2">&nbsp;</td>
        <td height="24" colspan="2" align="right">Fecha de Inicio     <input name="txtfecinicon"   type="text" id="txtfecinicon"  style="text-align:left" value="<?php print $ls_fecinicon ?>" size="11" maxlength="10"   onBlur="javascript: ue_comparar_intervalo('txtfeccon','txtfecinicon','');" readonly="true" datepicker="true"></td>
        <td height="26" colspan="2" rowspan="2"> <div align="right">Duraci&oacute;n (Aprox.) </div></td>
        <td height="26" rowspan="2"><input name="txtplacon" type="text" id="txtplacon" onKeyUp="javascript:ue_activar_unidad(this)"    onKeyPress="return validaCajas(this,'i',event)"  onBlur="javascript: ue_calcularperiodo(this);" style="text-align:right" value="<?php print $li_placon ?>" size="6" maxlength="6" ></td>
        ...
        <input name="hidduracion" type="hidden" id="hidduracion" value="<?php print $ls_coduniduracion ?>">		</td>
      </tr>
      <tr class="formato-blanco">
        <td height="13" colspan="2" align="right">Fecha de Finaliz.         <input name="txtfecfincon" type="text" id="txtfecfincon"  style="text-align:left" value="<?php print $ls_fecfincon ?>" size="11" maxlength="10"   onBlur="javascript: ue_calcularperiodo(this);" datepicker="true" readonly="true" onChange="javascript: ue_calcularperiodo(this);"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="34">&nbsp;</td>
        <td height="34">&nbsp;</td>
        <td height="34" colspan="2" align="right">Monto<input name="txtmonto" type="text"  style="text-align:right" id="txtmonto" readonly="true" size="21" value="<?php print $ls_monto?>" maxlength="21">
        </td>
      ...
      <tr class="formato-blanco">
		...
		<?Php
              ...
              <input name="hidretraso" type="hidden" id="hidretraso" value="<?php print $ls_coduniretraso ?>">
		</td>
      </tr>
      <tr class="formato-blanco">
        <td height="28">&nbsp;</td>
        ...
        <td height="28" colspan="8">Lapso de Garant&iacute;a de la Obra 
          <input name="txtlapgarcon" type="text" id="txtlapgarcon" onKeyPress="return validaCajas(this,'i',event)" value="<?php print $ls_lapgarcon?>" size="9" maxlength="10"  onKeyUp="javascript:ue_activar_unidad(this)"  style="text-align:right ">
		<?Php
				//if($ls_codobr=="")
					//$lb_valido=false;
				//else
        ...
        <?			  
			...
			<select name="cmbgarantia" size="1" id="cmbgarantia" disabled>
			  ...
			  ?>			  
        <input name="hidgarantia" type="hidden" id="hidgarantia" value="<?php print $ls_codunigarantia ?>">		</td>
        <td height="28">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="61">&nbsp;</td>
					...
					<td colspan="8" rowspan="2" align="center" valign="top">
					  <table width="277" height="87" border="0" cellpadding="1" cellspacing="1" class="letras-peque&ntilde;as" id="detalleasignacion">
                        <tr>
                          ...
                          <td height="20"><input name="txtestcon" id="txtestcon" style="text-align:center " type="text" readonly="true" value="<?php print $ls_estado;?>" size="20" maxlength="20"></td>
                        </tr>
                        <tr>
                          <td width="134" height="20"><div align="right">% Ejecuci&oacute;n F&iacute;sica</div></td>
                          <td width="136" height="20"><input name="txtporejefiscon" type="text"  style="text-align:right " id="txtporejefiscon"  value="<?php print $ls_porejefiscon?>" size="21" maxlength="21" readonly="true"></td>
                        </tr>
                        <tr>
                          <td height="22"><div align="right">% Ejecuci&oacute;n Financiera</div></td>
                          <td height="22"><input name="txtporejefincon" id="txtporejefincon"   style="text-align:right " value="<?php print $ls_porejefincon?>" readonly="true" type="text" size="21" maxlength="21" >                          </td>
                        </tr>
                        <tr>
                          <td height="20" valign="top"><div align="right">Total Ejecuci&oacute;n Financiera</div></td>
                          <td valign="top"><input name="txtmonejefincon" type="text" id="txtmonejefincon"   style="text-align:right " value="<?php print $ls_monejefincon?>" readonly="true"  size="21" maxlength="21" ></td>
                        </tr>
                      </table></td>
					<td height="18">&nbsp;</td>
				  </tr>
...
<input name="hidfilascondiciones" type="hidden" id="hidfilascondiciones" value="<?php print $li_filascondiciones;?>">
<input name="hidfilasgarantias" type="hidden" id="hidfilasgarantias" value="<?php print $li_filasgarantias;?>">
<input name="hidremoverretenciones" type="hidden" id="hidremoverretenciones" value="<?php print $li_removerretenciones;?>">
<input name="hidremovercondiciones" type="hidden" id="hidremovercondiciones" value="<?php print $li_removercondiciones;?>">
<input name="hidremovergarantias" type="hidden" id="hidremovergarantias" value="<?php print $li_removergarantias;?>">
...
function ue_guardar()
{
	...
	if(((lb_status=="C")&&(li_cambiar==1))||(lb_status!="C")&&(li_incluir==1))
	{
		...
		if(combojs.value=="")
		{
			lb_valido=confirm("El campo Prefijo del Contrato está vacío,\n ¿Desea guardar de todas maneras?");
		}
