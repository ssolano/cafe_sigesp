	...
	}else
	{
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($li_z=1;$li_z<=$li_totrow;$li_z++)
			{
				...
				print "<td><a href=\"javascript: aceptar('$ls_codval','$ls_codasi','$ls_codcon','$ls_fecha','$ls_fecinival','$ls_fecfinval','$ls_obsval','$ls_amoval','$ls_obsamoval','$ls_amoantval','$ls_amototval','$ls_amoresval','$ls_basimpval','$ls_montotval','$ls_subtotpar','$ls_totreten','$ls_subtot','$ls_nomestval');\">".$ls_codcon."</a></td>";
...
function aceptar(ls_codval,ls_codasi,ls_codcon,ls_fecha,ls_fecinival,ls_fecfinval,ls_obsval,ls_amoval,ls_obsamoval,ls_amoantval,ls_amototval,ls_amoresval,ls_basimpval,ls_montotval,ls_subtotpar,$ls_totreten,ls_subtot,ls_nomestval)
  {
    opener.ue_cargarvaluacion(ls_codval,ls_codasi,ls_codcon,ls_fecha,ls_fecinival,ls_fecfinval,ls_obsval,ls_amoval,ls_obsamoval,ls_amoantval,ls_amototval,ls_amoresval,ls_basimpval,ls_montotval,ls_subtotpar,$ls_totreten,ls_subtot,ls_nomestval);
	close();
  }
