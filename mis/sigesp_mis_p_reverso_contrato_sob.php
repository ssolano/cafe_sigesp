<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","sigesp_mis_p_reverso_contrato_sob.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="sigesp_mis_p_reverso_contrato_sob.php";
			f.submit();
		}
		else
		{
...
function uf_verdetalle(codcon)
{
	...
	window.open("sigesp_mis_pdt_sobcon.php?codcon="+codcon+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
</script>
