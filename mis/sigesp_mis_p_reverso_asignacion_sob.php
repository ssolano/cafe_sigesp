<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","sigesp_mis_p_reverso_asignacion_sob.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="sigesp_mis_p_reverso_asignacion_sob.php";
			f.submit();
		}
		else
		{
