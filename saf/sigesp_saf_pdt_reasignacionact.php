...
<form name="form1" method="post" action="" id="sigesp_saf_pdt_reasignacionact.php">
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <input name="totalfilas" type="text" id="totalfilas" value="<?php print $li_totrows;?>"></td>
...
*/		//obj1=eval("opener.document.form1.txtcontable"+li_totrows+"");
		//obj1.value=ls_sccuenta;
/*		obj=eval("opener.document.form1.txtcontable"+totrowscg+"");
		obj.value=ls_sccuenta;*/
		//obj1=eval("opener.document.form1.txtcuentaact"+li_totrows+"");
		//obj1.value=ls_codact;
/*		obj1=eval("opener.document.form1.txtcuentaide"+li_totrows+"");
		obj1.value=ls_ideact;
		obj1=eval("opener.document.form1.txtmontocont"+li_totrows+"");
		obj1.value=li_monact;
		obj1=eval("opener.document.form1.txtdebhab"+li_totrows+"");
		obj1.value="H";
		obj1=eval("opener.document.form1.txtdocscg"+li_totrows+"");
		obj1.value=ls_ideact;
*/
