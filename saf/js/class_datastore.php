...
class class_datastore
{
    ...
    function sortData($column)//Metodo que ordena de forma descendente el datastore, filtrando por la columna enviada como parametro
	{
		$temp=array();
    ...
    function updateRow($column,$value,$row)//Metodo para actualización de filas del datastore de envia la columna,el valor y el numero de la fila
	{
	...
	function resetds($column)//Metodo para blanqueo del datastore
	{
	...
	function getRowCount($column)//Metodo que retorna el numero de filas del datastore
	{
