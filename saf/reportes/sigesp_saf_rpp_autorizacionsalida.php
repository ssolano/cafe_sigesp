<?php
		                 ...
		                 $ls_concepto,$ld_fecent,$ld_fecdevo,&$io_pdf)
	{
	    ...
	    $la_data=array(array('name'=>'   <b>Dependencia:</b> '.$ls_denuniadmcede.'     '),
				       array('name'=>'   <b>Entregado A:</b>  '.$ls_nomrepre.',     C.I  Nº: '.$ls_cedrepre.''),
					   array('name'=>'   <b>Representante de la Empresa: </b>'.$ls_nomprov.''),
					   array('name'=>'   <b>Por Concepto de : </b>'.$ls_concepto.''),
					   array('name'=>'   <b>Fecha de Entrega:</b> '.$ld_fecent.'       <b>Fecha de Devolución:</b> '.$ld_fecdevo.''));
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   ...
						 			   'ideact'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
	...
	function uf_print_pie_detalle($ls_obser,&$io_pdf)
	{
		...
		$io_pdf->saveState();*/
		$io_pdf->ezSetDy(-10);
	    $la_data=array(array('name'=>'   <b>Observación:</b> '.$ls_obser.''));
	...
	function uf_print_pie_cabecera($ls_denuniadmcede,$ls_nomprov,$io_pdf)
	{
        ...
        $io_pdf->addText(355,155,9,"<b>OFICINA DE ADMINISTRACIÓN Y</b>");
