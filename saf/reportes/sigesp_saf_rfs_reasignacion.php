<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		$tm=504-($li_tm/2);
		$io_pdf->addText($tm,545,14,$as_titulo); // Agregar el título
		...
		$io_pdf->addText(130,102,7,"<b>ELABORADO POR</b>"); // Agregar el título
//		$io_pdf->addText(140,43,7,"COMPRAS"); // Agregar el título
		$io_pdf->addText(355,102,7,"<b>VERIFICADO POR</b>"); // Agregar el título
//		$io_pdf->addText(355,43,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(580,102,7,"<b>AUTORIZADO POR</b>"); // Agregar el título
//		$io_pdf->addText(560,43,7,"ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		$io_pdf->addText(815,102,7,"<b>PROVEEDOR</b>"); // Agregar el título
//		$io_pdf->addText(780,43,7,"FIRMA AUTOGRAFA, SELLO, FECHA"); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('fectraact'=>array('justification'=>'left','width'=>55), // Justificación y ancho de la columna
						 			   'codact'=>array('justification'=>'left','width'=>90),   // Justificación y ancho de la columna
						 			   ...
						 			   'codres'=>array('justification'=>'left','width'=>111), // Justificación y ancho de la columna
						 			   'coduniadm'=>array('justification'=>'left','width'=>111), // Justificación y ancho de la columna
						 			   'codresnew'=>array('justification'=>'left','width'=>111), // Justificación y ancho de la columna
						 			   'coduniadmnew'=>array('justification'=>'left','width'=>111), // Justificación y ancho de la columna
						 			   'monact'=>array('justification'=>'right','width'=>81))); // Justificación y ancho de la columna
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>900, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>819), // Justificación y ancho de la columna
						 			   'monact'=>array('justification'=>'right','width'=>81))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
