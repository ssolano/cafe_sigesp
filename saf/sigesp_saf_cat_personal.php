...
function ue_beneficiariopres(ls_codper,ls_nomper,ls_apeper)
{
	opener.document.form1.txtcodbenpre.value=ls_codper;
	opener.document.form1.txtnombenpre.value=ls_nomper+" "+ls_apeper;
	close();
}
function ue_search()
{
