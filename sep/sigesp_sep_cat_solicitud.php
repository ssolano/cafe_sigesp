...
function ue_aceptar(ls_numsol,ls_codtipsol,ls_coduniadm,ls_codfuefin,ls_estsol,ls_tipo_destino,ls_codigo,ls_denuniadm,
					...
					ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif)
{
	...
	opener.document.formulario.txtconsol.value=as_consol;
...
{
   window.open('sigesp_sep_cat_unidad_ejecutora.php?tipo=',"_blank","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,left=50,top=50,location=no,resizable=yes");
}
