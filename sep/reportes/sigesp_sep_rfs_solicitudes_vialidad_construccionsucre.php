<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		// cuadro inferior
      	$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(15,60,570,120);
		$io_pdf->addText(17,170,7,"<b>OBSERVACIONES:</b>"); // Agregar el título
		$io_pdf->line(15,156,585,156);    //linea horizonal obsevaciones
		$io_pdf->line(15,132,585,132);    //linea horizonal 
		$io_pdf->line(15,108,585,108);    //linea horizonal 
		$io_pdf->line(15,84,585,84);    //linea horizonal 
	    $io_pdf->line(157,60,157,156);	// linea vertical
	    $io_pdf->line(300,60,300,156);	// linea vertical
	    $io_pdf->line(442,60,442,156);	// linea vertical
		// primera columna
		$io_pdf->addText(45,145,8,"<b>UNIDAD SOLICITANTE</b>"); // Agregar el título
		$io_pdf->addText(30,135,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		$io_pdf->addText(45,97,8,"<b>GERENTE DE UNIDAD</b>"); // Agregar el título
		$io_pdf->addText(30,87,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		// segunda columna
		$io_pdf->addText(180,145,8,"<b>ANALISTA DE LOGISTICA</b>"); // Agregar el título
		$io_pdf->addText(175,135,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		$io_pdf->addText(180,97,8,"<b>GERENTE DE LOGISTICA</b>"); // Agregar el título
		$io_pdf->addText(173,87,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		// tercera columna
		$io_pdf->addText(330,145,8,"<b>ANALISTA DE RRHH</b>"); // Agregar el título
		$io_pdf->addText(315,135,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		$io_pdf->addText(330,97,8,"<b>GERENTE DE RRHH</b>"); // Agregar el título
		$io_pdf->addText(315,87,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		// cuarta columna
		$io_pdf->addText(465,145,8,"<b>ANALISTA DE ADMON.</b>"); // Agregar el título
		$io_pdf->addText(457,135,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		$io_pdf->addText(466,97,8,"<b>GERENTE DE ADMON.</b>"); // Agregar el título
		$io_pdf->addText(457,87,8,"NOMBRE Y APELLIDO  FIRMA"); // Agregar el título
		

/*    	$io_pdf->setStrokeColor(0,0,0);
        $io_pdf->Rectangle(15,60,570,120);
		$io_pdf->addText(17,170,7,"<b>OBSERVACIONES:</b>"); // Agregar el título
		$io_pdf->line(15,146,585,146);    //linea horizonal obsevaciones
		$io_pdf->addText(60,138,7,"<b>UNIDAD SOLICITANTE</b>"); // Agregar el título
		$io_pdf->addText(320,138,7,"<b>GERENCIA DE ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título
		$io_pdf->line(15,135,585,135);    //linea horizonal nombre y apellido
		$io_pdf->line(15,115,585,115);    //linea horizonal 
		$io_pdf->line(130,95,130,135);	// 1 era linea vertical
		$io_pdf->line(190,95,190,145);	// 2 da linea vertical
		$io_pdf->addText(36,125,7,"NOMBRE Y APELLIDO"); // Agregar el título
		$io_pdf->addText(145,125,7,"FIRMA"); // Agregar el título
		$io_pdf->line(190,125,585,125);    //linea horizonal
		$io_pdf->addText(240,128,7,"<b>ANALISTA DE COMPRAS</b>"); // Agregar el título
		$io_pdf->addText(410,128,7,"<b>GERENTE DE ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título
		$io_pdf->addText(210,118,7,"NOMBRE Y APELLIDO"); // Agregar el título
	    $io_pdf->line(310,95,310,125);	// linea vertical
		$io_pdf->addText(330,118,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(450,118,7,"NOMBRE Y APELLIDO"); // Agregar el título
		$io_pdf->line(15,95,585,95);    //linea horizonal gerencia
		$io_pdf->addText(200,88,7,"GERENCIA DE LOGISTICA"); // Agregar el título
		$io_pdf->addText(449,88,7,"FECHA DE RECEPCIÓN"); // Agregar el título
		$io_pdf->line(15,73,380,73);	//linea horizontal abajo	
		$io_pdf->line(15,85,585,85);    //linea horizonal analista	
		$io_pdf->line(130,60,130,73);	//linea vertical	
		$io_pdf->line(190,60,190,85);	// 2da Linea vertical
		$io_pdf->line(380,60,380,135);	//3era linea vertical	
		$io_pdf->addText(60,76,7,"<b>ANALISTA DE LOGISTICA</b>"); // Agregar el título
		$io_pdf->addText(36,63,7,"NOMBRE Y APELLIDO"); // Agregar el título
		$io_pdf->addText(240,76,7,"<b>GERENTE DE LOGISTICA</b>"); // Agregar el título
		$io_pdf->addText(145,63,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(210,63,7,"NOMBRE Y APELLIDO"); // Agregar el título
		$io_pdf->line(310,60,310,73);	//linea vertical
		$io_pdf->addText(330,63,7,"FIRMA"); // Agregar el título
*/		
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,9.5,3,3); // Configuración de los margenes en centímetros
