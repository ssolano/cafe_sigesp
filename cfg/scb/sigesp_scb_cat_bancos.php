			...
			else
			{
				...
				if($row=$SQL->fetch_row($rs_banco))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						$swift=$data["swift"][$z];
						print "<td><a href=\"javascript: aceptar('$codigo','$nombre','$direccion','$gerente','$telefono','$movil','$email','$esttesnac','$codsudeban','$swift');\">".$codigo."</a></td>";
						print "<td>".$nombre."</td>";
						print "</tr>";			
					}
				}
...
<script language="JavaScript">
  function aceptar(codigo,deno,direccion,gerente,telefono,celular,email,esttesnac,codsudeban,swift)
  {
	...
	opener.document.form1.txtswift.value=swift;
