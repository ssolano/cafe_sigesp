	    ...
	    if ($lb_encontrado)
	       {
			 ...
			 if (!$lb_existe)
			    {
				  $lb_valido = $io_estpro5->uf_spg_insert_estprog5($ls_codemp,$ls_codestp1,$ls_codestp2,$ls_codestp3,$ls_codestp4,$ls_codestp5,$ls_denestpro5,$ls_codfuefin,$li_estmodest,$ls_clasificacion,$la_seguridad);		
				  if ($lb_valido)
					 {
					   $io_sql->commit();
			    ...
			    {
				  $lb_valido = $io_estpro5->uf_spg_update_estprog5($ls_codemp,$ls_codestp1,$ls_codestp2,$ls_codestp3,$ls_codestp4,$ls_codestp5,$ls_denestpro5,$ls_codfuefin,$la_seguridad);		
				  if ($lb_valido)
					 { 
					   $io_sql->commit();
