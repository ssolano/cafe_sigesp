  ...
  <p align="center">&nbsp;</p>
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      <tr class="titulo-celda">
        ...
        Cat&aacute;logo de Consolidaci&oacute;n de Presupuesto </td>
       </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
...
$ls_fila=$io_fun_cfg->uf_obtenervalor_get("fila",""); 
		  ...
		  for ($z=1;$z<=$totrow;$z++)
		      {
				...
				$ls_proyacc=substr($ls_proyacc,'20','25');
				...
				print "<td  style=text-align:center width=150><a href=\"javascript: aceptar('$ls_nombasd','$ls_proyacc','$ls_estcla','$totrow','$ls_fila');\">".$ls_nombasd."</a></td>";
...
<script language="JavaScript">
	function aceptar(ls_nombasd,ls_proyacc,ls_estcla,totrow,ls_fila)
	{
		fop = opener.document.formulario;
		fop.txtcodestpro1.value= ls_proyacc;
		fop.operacion.value= "";
		fop.hidestcla.value= ls_estcla;
		fop.txtbd.value=ls_nombasd;
		fop.txtcodestpro1.readOnly = true;
		fop.txtbd.readOnly = true;
		close();
	}
	...
	function ue_search()
	{
		...
		f.action= "sigesp_cfg_cat_consolidacion.php";
		f.submit();
	}
</script>
</html>