...
/*	if(($ls_tipodeduccion=="S")||($ls_tipodeduccion==""))
	  ...
	  ?>
                      <td width="99" height="22">
                        ...
                        I.S.L.R.</td>
                      <td width="86" height="22"><input name="radiotipodeduccion" type="radio" class="sin-borde" value="I" onClick="cambiarestatus()" <?php print $ls_deduciva?>>
                        Ret. IVA</td>
                      <td height="22"><input name="radiotipodeduccion" type="radio" class="sin-borde" value="M" onClick="cambiarestatus()" <?php print $ls_deducmunicipal ?>>
                        Ret. Municipal</td>
                      <td height="22"><input name="radiotipodeduccion" type="radio" class="sin-borde" onClick="cambiarestatus()" value="A" <?php print $ls_deducsocial ?>>
                        Ret. Aporte Social </td>
                      <td><label><input name="radiotipodeduccion" type="radio" class="sin-borde" value="1" onClick="cambiarestatus()" <? print $ls_deducmil?>>
                      Ret 1x1000 </label></td>
                      <td height="22" ><input name="radiotipodeduccion" type="radio" class="sin-borde" value="O" onClick="cambiarestatus()" <? print $ls_deducotras?>>
Otras </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td height="22" colspan="2" style="text-align:left"><input name="txtdeducible" type="text" id="txtdeducible" value="<?php print $ld_deducible ?>" style="text-align:right"  onKeyPress="return(currencyFormat(this,'.',',',event))">                      </td>
	...
	if(($ls_deducisrl=="checked"))
	  ...
	  ?>
                    ...
                    <tr>
                      ...
                      <input name="txtdenconret" type="text" class="sin-borde" id="txtdenconret" value="<?php print $ls_denconret; ?>" size="80" readonly>                      </td>
                    </tr>
