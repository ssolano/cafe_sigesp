	 ...
	 for ($z=1;$z<=$totrow;$z++)
		 {
		    ...
		    print "<td style=text-align:center><a href=\"javascript: aceptar('$ls_codded','$ls_dended','$ld_porded','$ls_cuenta','$ls_dencue','$ld_monded','$ls_forded','$ls_tipded','$tipopersdeduccion','$ls_codconret','$ls_denconret','$li_impmil');\">".$ls_codded."</a></td>";
...
<script language="JavaScript">
  function aceptar(codigo,denominacion,porcentaje,cuenta,denocuenta,deducible,formula,tipodeduccion,tipopersdeduccion,ls_codconret,ls_denconret,li_impmil)
  {
    ...
    if (tipodeduccion=="O")
	   {
	     opener.document.form1.radiotipodeduccion[5].checked=true;
		 opener.document.form1.radiotipoperdeduccion[0].disabled=true;
	     opener.document.form1.radiotipoperdeduccion[1].disabled=true;
	   }
