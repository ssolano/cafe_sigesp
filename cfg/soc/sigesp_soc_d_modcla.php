         ...
         if ($row=$io_sql->fetch_row($rs_data))
	        {
              ...
              for ($i=1;$i<=$totrow;$i++)	   	   
                  {							                  
			        ...
			        $object[$i][2]="<input name=txtdencla".$li_row." type=text  id=txtdencla".$li_row."  class=sin-borde  size=70 style=text-align:left  value='".$ls_dencla."' readonly>";
       ...
       for ($li_i=1;$li_i<=$li_total;$li_i++)
           {
	         if ($li_i!=$li_rowdel)
	            {		
	              ...
	              $object[$li_temp][2]="<input name=txtdencla".$li_temp."  type=text id=txtdencla".$li_temp."  class=sin-borde  size=70 value='".$ls_dencla."' readonly>";
	   ...
	   {     
          ...
          for($i=1;$i<=$total;$i++)
          {
			 ...
			 {//3
				 ...
				 $object[$i][2]="<input name=txtdencla".$i." type=text id=txtdencla".$i." class=sin-borde  size=70  style=text-align:left value='".$ls_dencla."'>";
