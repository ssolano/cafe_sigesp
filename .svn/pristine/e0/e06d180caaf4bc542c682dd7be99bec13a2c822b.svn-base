...
$io_fun_activo->uf_load_seguridad("SIV","sigesp_siv_r_recepcion.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
	...
	if(valido)
	{
		...
		if(li_imprimir)
		{
			...
			if ((ld_desde!="")&&(ld_hasta!=""))
			{
				...
				window.open("reportes/sigesp_siv_rpp_recepcion.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
