...
class sigesp_sep_c_solicitud
 {
	...
	function uf_load_tiposolicitud($as_seleccionado)
	{
		...
		$ls_sql= " SELECT * FROM SSS_USUARIOS_EN_GRUPOS WHERE CODEMP='".$this->ls_codemp."'".
				 " AND NOMGRU='ASISTENTE' AND CODUSU='".$_SESSION["la_logusr"]."'";
		$rs_data=$this->io_sql->select($ls_sql);		
		if ($this->io_sql->num_rows($rs_data)==0) //EL USUARIO NO ESTA EN EL GRUPO DE ASISTENTE
		{
	...
	function uf_guardar($as_existe,$ad_fecregsol,&$as_numsol,$as_coduniadm,$as_codfuefin,$as_tipodestino,$as_codprovben,$as_consol,
						...
						$ai_totrowconceptos,$ls_nombenalt,$aa_seguridad,&$as_estsol,$as_tipsepbie)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (sigesp_sep_p_solicitud.php)
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_delete_solicitud($as_numsol,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
