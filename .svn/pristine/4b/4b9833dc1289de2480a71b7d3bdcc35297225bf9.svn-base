...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_hvacacpersonal($adt_anocurnom,$as_codperi)
	{
		...
		$ls_sql= " INSERT INTO sno_hvacacpersonal (codemp, anocur, codnom, codperi, codper,codvac, fecvenvac, fecdisvac, ".
                 ...
                 "                                 diaadibon, diafer, sabdom,diapervac,pagpersal,calpagvac, profueper ) ".
				 ...
				 "			   sno_vacacpersonal.sabdom,sno_vacacpersonal.diapervac,sno_vacacpersonal.pagpersal,sno_vacacpersonal.calpagvac, sno_vacacpersonal.profueper ".
	...
	function uf_insert_hconcepto($adt_anocurnom,$as_codperi)
	{
		...
		$ls_sql= " INSERT INTO  sno_hconcepto (codemp, codnom, anocur, codperi, codconc, nomcon, titcon, sigcon, forcon, ".
				 ...
				 "							   consunicon, estcla, intingcon, spi_cuenta, poringcon, quirepcon, asifidper, asifidpat, frevarcon,persalnor,aplresenc,conperenc,codente,guarrepcon ) ".
				 ...
				 "			  estcla,intingcon, spi_cuenta, poringcon, quirepcon, asifidper, asifidpat, frevarcon, persalnor,aplresenc,conperenc, codente,guarrepcon".
                 "       FROM sno_concepto ".
                 "      WHERE codemp='".$this->ls_codemp."' ".
				 "        AND codnom='".$this->ls_codnom."' ";
		$li_row=$this->io_sql->execute($ls_sql);
