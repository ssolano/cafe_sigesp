...
<form name="form1" method="post" action="">
  <p align="center">
    ...
    <input name="coddestino" type="text" id="coddestino" value="<?php print $ls_coddestino ?>">
    <input name="tipo"       type="hidden" id="tipo"       value="<?php print $ls_tipo ?>">
    <input name="tipcmp"       type="hidden" id="tipcmp"       value="<?php print $ls_tipcmp ?>">
...
print "<td width='120'>Causa</td>";
print "<td width='30'>Tipo</td>";
...
if($ls_operacion=="BUSCAR")
{
	...
	if ($ls_tipcmp!=""){
		$ls_sql.="   AND saf_movimiento.tipcmp= '".$ls_tipcmp."' ";
	}
...
<script language="JavaScript">
					 ...
					 ls_tipresuso,ld_fecent,as_numcmp)
	{
		...
		if(ls_coddestino!="reporte")
		{
			...
			}else if (tipo=="incorporacionlote"){
				opener.document.form1.txtnumcmp.value = as_numcmp;
				opener.document.form1.txtcodrespri.value=ls_codrespri;
				opener.document.form1.txtcodrespri.readOnly=true;
				opener.document.form1.txtdenrespri.value=ls_denrespri;
