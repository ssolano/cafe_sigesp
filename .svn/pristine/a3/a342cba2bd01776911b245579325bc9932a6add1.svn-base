...
if($ls_operacion=="BUSCAR")
{
	...
	if($li_numrows>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print " <td><a href=\"javascript: aceptar('$ls_codact','$ls_denact','$ls_obsact','$ls_maract','$ls_modact','$ld_fecregact','$ld_feccmpact',".
...
<script language="JavaScript">   
  function aceptar(ls_codact,ls_denact,ls_obsact,ls_maract,ls_modact,ld_fecregact,ld_feccmpact,li_cosact,ls_codconbie,ls_denconbie,ls_codfuefin,
