...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo_vycs.jpg',30,705,565,55); // Agregar Logo
		if($as_estcondat=="B") 
        {
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText(200,720,14,"<b>".$ls_titulo."</b>"); // Agregar el título

		$io_pdf->addText(430,725,8,"<b>   No.:</b>");      // Agregar texto
		$io_pdf->addText(465,725,8,$as_numordcom); // Agregar Numero de la solicitud
		$io_pdf->addText(420,715,8,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(465,715,8,$ad_fecordcom); // Agregar la Fecha
