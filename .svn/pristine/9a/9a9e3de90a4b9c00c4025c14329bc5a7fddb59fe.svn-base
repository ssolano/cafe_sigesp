<?php
	...
	function uf_print_personal()
   	{
		...
		print "</tr>";
		$ls_sql_1 = "SELECT DISTINCT max(CASE sno_nomina.racnom WHEN 1 THEN
              ...
              $ls_sql = "SELECT * from sno_personal where cedper LIKE '%".$ls_cedper."%' and nomper LIKE '%".$ls_nomper."%' and apeper LIKE '%".$ls_apeper."%' ";
				  ...
				  if (!empty($la_spgctas))
				     {
					   ...
					   $ls_sql = "SELECT TRIM(siv_articulo.codart) as codart,siv_articulo.denart,siv_articulo.ultcosart,
	 				   ...
	 				   $rs_data=$io_sql->select($ls_sql);
                                           ...
                                           //echo $ls_sql;//CAMB //DEBUG
					   if ($rs_data===false)
					      {
						    $io_mensajes->message("ERROR->".$io_sql->message); 
					      }
					   else
				 	      {
	...
	function uf_print_proveedor($ls_tipo)
   	{
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				{
					case "SC":
				        echo "<td style='cursor:pointer'><a href=\"javascript: ue_aceptar_proveedor_solicitud_cotizacion('".$ls_codpro."','".$ls_nompro."','".$ls_dirpro."','".$ls_telpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					break;
					case "RC":
				        echo "<td style='cursor:pointer'><a href=\"javascript: ue_aceptar_proveedor_registro_cotizacion('".$ls_codpro."','".$ls_nompro."','".$ls_tipconpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					break;
					case "":
				        echo "<td style='cursor:pointer'><a href=\"javascript: ue_aceptar('".$ls_codpro."','".$ls_nompro."','".$ls_tipconpro."','".$ls_rifpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					break;
				  	case "REPDES":
				        echo "<td style='cursor:pointer'><a href=\"javascript: aceptar_reportedesde('".$ls_codpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					break;
					case "REPHAS":
				        echo "<td style='cursor:pointer'><a href=\"javascript: aceptar_reportehasta('".$ls_codpro."');\"><img src='../shared/imagebank/tools20/aprobado.gif' title='Agregar Proveedor' width='15' height='15' border='0'></a></td>";
					break;
				}
			    echo "</tr>";
				$rs_data->MoveNext();
	...
	function uf_print_fuente_financiamiento($ls_codestpro1, $ls_codestpro2, $ls_codestpro3, $ls_codestpro4, $ls_codestpro5, $ls_estcla)
	{
		...
		$ls_sql=" select a.codfuefin, a.denfuefin ".
				...
				"		and b.estcla='".$ls_estcla."'"; //print $ls_sql;
		$rs_data=$io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$io_mensajes->message("ERROR->".$io_funciones->uf_convertirmsg($io_sql->message)); 
		...
		print "</tr>";
 		$ls_sql = " SELECT soc_sol_cotizacion.numsolcot,
					  ...
					  FROM soc_sol_cotizacion, spg_unidadadministrativa, spg_dt_unidadadministrativa, sno_personal,
					       spg_ep1, spg_ep2, spg_ep3, spg_ep4, spg_ep5 $ls_tabla
					 WHERE soc_sol_cotizacion.codemp='".$ls_codemp."' $ls_filtro $ls_cadaux
					   ...
					   AND soc_sol_cotizacion.coduniadm=spg_unidadadministrativa.coduniadm 
			 	       AND spg_unidadadministrativa.codemp=spg_dt_unidadadministrativa.codemp
					   AND spg_unidadadministrativa.coduniadm=spg_dt_unidadadministrativa.coduniadm
					   AND soc_sol_cotizacion.codemp=spg_dt_unidadadministrativa.codemp 
					   AND soc_sol_cotizacion.coduniadm=spg_dt_unidadadministrativa.coduniadm 
					   AND soc_sol_cotizacion.codestpro1=spg_dt_unidadadministrativa.codestpro1
					   AND soc_sol_cotizacion.codestpro2=spg_dt_unidadadministrativa.codestpro2
					   AND soc_sol_cotizacion.codestpro3=spg_dt_unidadadministrativa.codestpro3
					   AND soc_sol_cotizacion.codestpro4=spg_dt_unidadadministrativa.codestpro4
					   AND soc_sol_cotizacion.codestpro5=spg_dt_unidadadministrativa.codestpro5
					   AND soc_sol_cotizacion.estcla=spg_dt_unidadadministrativa.estcla 
