<?php
	...
	function uf_inicializar_variables()
	{
		...
		{	
			if(file_exists ($ls_directorio))
			{
				...
				//$ls_contenido="138.00-5.00-28.00-20.00-30.00-26.00-32.00-34.00-30.00-41.00-75.00-41.00-135.00-63.00-129.00-68.00";
	...
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf)
	{
		...
		global $valores;
		//Imprimo el monto
		$io_pdf->add_texto($valores[0],$valores[1],13,"<b>***".$ldec_monto."***</b>");
		//Beneficiario del Cheque
		$io_pdf->add_texto($valores[4],$valores[5],10,"<b>      $ls_nomproben</b>");
		...
		if(array_key_exists(0,$la_arreglo))
			$io_pdf->add_texto($valores[2],$valores[3],10,"<b>     $la_arreglo[0]</b>");
...
//$ls_anio=substr($ls_fecha,-4);
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,&$io_pdf)
	{
		...
		$la_data=array(array('banco'=>'<b>Banco</b>  ','cheque'=>'<b>Doc/Cheque</b>  ','cuenta'=>'<b>Cuenta:</b>  ','voucher'=>'<b>Voucher:</b>  '),
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->line(11,74.6,590,74.6);	//horizantal 2	
		...
		$io_pdf->addText(290,137.6,9,'<b>Administracion:</b>');		
		$io_pdf->addText(440,137.6,9,'<b>Presidencia:</b>');
		$io_pdf->addText(258,78.85,10,'<b>RecibioConforme</b>');
		
		$io_pdf->addText(16,63.27,10,'<b>Nombre:</b>');		
		$io_pdf->addText(196,63.27,10,'<b>Cedula de Identidad:</b>');		
