...
<?php
	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
		    ...
		    {
				uf_load_variables();			
				$lb_valido=$io_unidadadm->uf_guardar($lb_existe,$ls_codigo,$ls_denominacion,$ls_codpro,$ls_estcla,$la_seguridad);
				if($lb_valido)
				{
					uf_limpiarvariables();
					$lb_existe="FALSE";
		  ...
		  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
            ...
            <tr>
                ...
                <td>
                 ...
                 <input name="txtestcla2" type="hidden" id="txtestcla2" size="2" value="<?php print $ls_estcla2;?>"></div>
				</td>
            </tr>
            <tr>
              <td height="22">
              ...
              <td>
                ...
                <input name="txtestcla3" type="hidden" id="txtestcla3" size="2" value="<?php print $ls_estcla3;?>"></div></td>
            </tr>
	  ...
	  {?>
            <tr>
              ...
              <td>
                ...
                <input name="txtestcla4" type="hidden" id="txtestcla4" size="2" value="<?php print $ls_estcla4;?>"></div></td>
            </tr>
            <tr>
              <td height="22">
                <div align="right">
              ...
              <td>
                ...
                <input name="txtestcla5" type="hidden" id="txtestcla5" size="2" value="<?php print $ls_estcla5;?>"></div></td>
            </tr>
<?php }?>
            <tr>
