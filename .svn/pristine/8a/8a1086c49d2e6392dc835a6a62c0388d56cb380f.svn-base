...
class sigesp_snorh_class_report
{
	...
	function uf_comparado0506_gasto_real($as_rango,$as_cuenta)
	{
		...
		$ls_sql="SELECT MAX(sno_hperiodo.anocur) AS anocur, SUM(sno_hsalida.valsal) AS total, sno_hconcepto.cueprecon AS cuenta ".
				...
				"   AND SUBSTR(sno_hperiodo.fecdesper::text,6,2)>='".substr($as_rango,0,2)."' ".
				"   AND SUBSTR(sno_hperiodo.fecdesper::text,6,2)<='".substr($as_rango,0,2)."' ".
	...
	function uf_constanciatrabajo_integralpromedio_mensual($as_codnom,$as_codper,$as_mes,$as_anocurnom,&$ai_sueintper,&$ai_sueproper)
	{
		...
		$ls_sql="SELECT SUM(sueintper) AS sueintper, SUM(sueproper) AS sueproper ".
				...
				"   AND SUBSTR(sno_hperiodo.fecdesper::text,6,2)='".$as_mes."' ".
				"   AND sno_hnomina.espnom='0' ".
				"   AND sno_hpersonalnomina.codemp= sno_hperiodo.codemp".
				"   AND sno_hpersonalnomina.codnom= sno_hperiodo.codnom".
				"   AND sno_hpersonalnomina.anocur= sno_hperiodo.anocur".
									    ...
									    $as_perdes,$as_perhas,$as_codconc,$as_conceptocero,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personal.codper,sno_personal.cedper, sno_personal.apeper,sno_personal.fecingper, sno_personal.nomper, MAX(sno_hpersonalnomina.sueintper) as sueintper, sno_hpersonalnomina.codnom, ".
		        "       (SELECT SUM(valsal) ".
				"		   FROM sno_hsalida ".
				...
				" GROUP BY sno_hpersonalnomina.codemp, sno_hpersonalnomina.codnom, sno_personal.fecingper, sno_hpersonalnomina.codper, sno_personal.codper,".
	...
	function uf_ipasme_aporte_concepto($as_codnomdes,$as_codnomhas,$as_ano,$as_mes,$as_conceptocero)
	{
		...
		if(!empty($as_mes))
		{
			$ls_criterio = $ls_criterio." AND SUBSTR(sno_hperiodo.fecdesper::text,6,2)='".$as_mes."' ";
		}
		if(!empty($as_conceptocero))
		{
			$ls_criterio = $ls_criterio." AND sno_hsalida.valsal<>0 ";
	...
	function uf_retencionislr_personal($as_codnomdes,$as_codnomhas,$as_ano,$as_mes,$as_conceptocero,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personalisr.porisr, ".
		        ...
		        "   AND SUBSTR(sno_hperiodo.fecdesper::text,6,2) = '".$as_mes."' ".
		        "   AND SUBSTR(sno_hperiodo.fecdesper::text,1,4) = '".$as_ano."' ".
	...
	function uf_retencionarc_meses($as_codper,$aa_nominas,$ai_total,$as_ano)
	{
		...
		$ls_sql="SELECT sno_personalisr.codper, sno_personalisr.codisr, sno_personalisr.porisr, sno_hsalida.anocur, ".
				...
				"           AND sno_hperiodo.anocur = '".$as_ano."' ".
		        "   		AND SUBSTR(sno_hperiodo.fecdesper::text,1,4) = '".$as_ano."' ".
				"           AND sno_personalisr.codisr = SUBSTR(sno_hperiodo.fecdesper::text,6,2) ".
				"           AND sno_hconcepto.aplarccon = 1 ".
				"           AND (sno_hsalida.tipsal = 'A' OR sno_hsalida.tipsal = 'V1' OR sno_hsalida.tipsal = 'W1' ".
				"            OR sno_hsalida.tipsal = 'D' OR sno_hsalida.tipsal = 'V2' OR sno_hsalida.tipsal = 'W2' ".
				"            OR sno_hsalida.tipsal = 'P1' OR sno_hsalida.tipsal = 'V3' OR sno_hsalida.tipsal = 'W3') ".
		...
		$rs_data=$this->io_sql->select($ls_sql);
		//$this->io_mensajes->message($ls_sql);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_datosjubilado_personal($as_codperdes,$as_codperhas,$as_activo,$as_egresado,
										    $as_causaegreso,$as_activono,$as_vacacionesno,$as_suspendidono,$as_egresadono,
										    $as_orden)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT DISTINCT sno_personal.codper,sno_personal.nomper,sno_personal.apeper,sno_personal.fecingper, ". 
				" sno_jubilados.nomper, sno_jubilados.prirem, sno_jubilados.subtot,sno_jubilados.porpen, ".
				" sno_jubilados.monpen,sno_jubilados.ultrem,sno_jubilados.fecvida,sno_jubilados.tipjub, ".
				...
				" FROM sno_personal, sno_personalnomina, sno_jubilados ".
				" WHERE sno_personal.codemp = '".$this->ls_codemp."' ". 
				"   ".$ls_criterio.
				" AND sno_personal.codemp = sno_personalnomina.codemp ".
				" AND sno_personal.codper = sno_personalnomina.codper ".
				" AND sno_personal.codper = sno_jubilados.codper ".
				" AND sno_personal.codemp = sno_jubilados.codemp ".
				" AND sno_personalnomina.codemp = sno_jubilados.codemp ".
				$ls_orden;
		//print $ls_sql;
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
										    ...
										    $as_orden)
	{
		...
		$ls_sql="SELECT DISTINCT sno_personal.codper,sno_personal.fecingper, sno_guarderias.nomper, ".
				...
				" (SELECT denasicar FROM sno_asignacioncargo WHERE sno_personalnomina.codemp='".$this->ls_codemp."' AND sno_personalnomina.codemp = sno_asignacioncargo.codemp AND sno_personalnomina.codnom = sno_asignacioncargo.codnom AND sno_personalnomina.codasicar = sno_asignacioncargo.codasicar) as denasicar, ".
				" (SELECT descar FROM sno_cargo WHERE sno_personalnomina.codemp='".$this->ls_codemp."' AND sno_personalnomina.codemp = sno_cargo.codemp AND sno_personalnomina.codnom = sno_cargo.codnom AND sno_personalnomina.codcar = sno_cargo.codcar) as descar ".
				" FROM sno_personal, sno_personalnomina, sno_guarderias ".
				" WHERE sno_personal.codemp = '".$this->ls_codemp."' ". 
				"   ".$ls_criterio.
				" AND sno_personal.codemp = sno_personalnomina.codemp ". 
				" AND sno_personal.codper = sno_personalnomina.codper ".
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_recibopago_personal($as_codnom,$as_codnomhas,$ad_fecdesper,$ad_fechasper,$as_codperdes,$as_codperhas,
									$as_coduniadm,$as_conceptocero,$as_conceptop2,$as_conceptoreporte,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		//	    Arguments: as_codnom // Código del nómina donde se va a filtrar
                //	               as_codnomhas // Código de la nómina hasta donde se va a filtrar
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_recibopago_conceptopersonal($as_codnom,$as_codnomhas,$ad_fecdesper,$ad_fechasper,$as_codper,$as_conceptocero,$as_conceptop2,
...
function uf_cuadrect_estructuras ($as_codperi,$as_ano,$as_codestpro,$as_codestpro2,$as_estcla,$as_estcla2,&$rs_data2)
	...
	function uf_faov($as_codnomdes,$as_codnomhas,$as_anodes,$as_mesdes,$as_anohas,$as_meshas,
									    $as_perdes,$as_perhas,$as_codconc,$as_conceptocero,$as_orden){
		/*$as_codconc = array(	"0000000015",
					"0000000004",
					"0000000002",
					"0000000075",
					"0000000002",
		...
		return $this->uf_salarios_mintra_faov($as_codnomdes,$as_codnomhas,$as_anodes,$as_mesdes,$as_anohas,$as_meshas,$as_perdes,$as_perhas,$as_codconc,$as_conceptocero,$as_orden,$as_codconc);
	}// end function uf_aportepatronal_personal
	//-----------------------------------------------------------------------------------------------------------------------------------

	function uf_mintra($as_codnomdes,$as_codnomhas,$as_anodes,$as_mesdes,$as_anohas,$as_meshas,
									    $as_perdes,$as_perhas,$as_codconc,$as_conceptocero,$as_orden){
		$as_codconc = 	  array("0000000015",
					"0000000004",
					"0000000002",
	...
	private function uf_salarios_mintra_faov($as_codnomdes,$as_codnomhas,$as_anodes,$as_mesdes,$as_anohas,$as_meshas,
									    $as_perdes,$as_perhas,$as_codconc,$as_conceptocero,$as_orden,$as_codconc=array()){
       ...
       /*         $as_codconc = array('0000000111','0000000122','0000000124',
                                    '0000000105','0000000901','0000000101',
                                    '0000000113','0000000115','0000000117',
                                    '0000000118','0000000119','0000000216',
                                    '0000000130','0000000190','0000000121',
                                    '0000000126','0000000902','0000000123',
                                    '0000000125','0000000203','0000000211',
                                    '0000000214','0000000217','0000000103',
                                     '0000000112','0000000120');*/
                //codper,codconc,nomcon,valsal
                $ls_criterio = $ls_criterio." AND sno_hsalida.codconc IN ".$this->generar_cadena_in($as_codconc)." ";
		if(!empty($as_conceptocero))
		{
		//	$ls_criterio = $ls_criterio." AND sno_hsalida.valsal>=0 ";
		}
		...
		$ls_sql="SELECT sno_personal.nacper,sno_personal.sexper,sno_personal.fecnacper, ".
			    "sno_personal.cedper,sno_personal.nomper,sno_personal.apeper, ".
			    "sno_hpersonalnomina.descasicar,sno_hpersonalnomina.codnom,".
                            "sno_personal.fecingper,sno_personal.cauegrper,".
                            "(CASE WHEN sno_personal.fecegrper>'1900-01-01' THEN sno_personal.fecegrper ELSE null END) as fecegrper,".
                            "sum(sno_hsalida.valsal)as valsal ".
			    "FROM sno_hsalida, sno_hconcepto, sno_hconceptopersonal,sno_personal ".
			    ",sno_hpersonalnomina ".
                            "WHERE sno_hsalida.codemp='0001' AND sno_hsalida.anocur>='".$as_anodes."' AND sno_hsalida.anocur<='".$as_anohas."' ".
                            " AND sno_hsalida.valsal<>0 AND (sno_hsalida.tipsal='A' ".
                            "OR sno_hsalida.tipsal='V1' OR sno_hsalida.tipsal='W1' OR sno_hsalida.tipsal='D' OR ".
                            "sno_hsalida.tipsal='V2' OR sno_hsalida.tipsal='W2' OR sno_hsalida.tipsal='P1' ".
                            "OR sno_hsalida.tipsal='V3' OR sno_hsalida.tipsal='W3') ".
		            $ls_criterio.
		/*	    " AND sno_hconceptopersonal.codemp = sno_hpersonalnomina.codemp ".
			    " AND sno_hconceptopersonal.codnom = sno_hpersonalnomina.codnom ".
			    " AND sno_hconceptopersonal.anocur = sno_hpersonalnomina.anocur ".
			    " AND sno_hconceptopersonal.codperi = sno_hpersonalnomina.codperi ".
			    " AND sno_hconceptopersonal.codper = sno_hpersonalnomina.codper ".
*/
			    ...
			    " AND sno_hpersonalnomina.codper = sno_hsalida.codper ".
                            ...
                            " AND sno_hsalida.codemp = sno_hconcepto.codemp AND sno_hsalida.codnom = sno_hconcepto.codnom  ".
                            " AND sno_hsalida.anocur = sno_hconcepto.anocur AND sno_hsalida.codperi = sno_hconcepto.codperi  ".
                            " AND sno_hsalida.codconc = sno_hconcepto.codconc AND sno_hsalida.codemp = sno_hconceptopersonal.codemp  ".
                            " AND sno_hsalida.codnom = sno_hconceptopersonal.codnom AND sno_hsalida.anocur = sno_hconceptopersonal.anocur ".
                            " AND sno_hsalida.codperi = sno_hconceptopersonal.codperi AND sno_hsalida.codconc = sno_hconceptopersonal.codconc ".
                            " AND sno_hsalida.codper = sno_hconceptopersonal.codper ".
                          //  " AND sno_hsalida.valsal>=0  ".
                            " AND sno_personal.codper=sno_hconceptopersonal.codper ".
                            " AND sno_personal.estper='1' ".
                            "  GROUP BY sno_personal.cedper,sno_hsalida.anocur ".
                            " ,sno_personal.cedper,sno_personal.codper,sno_personal.nacper,sno_personal.nomper,sno_personal.apeper, ".
                            " sno_personal.fecingper,sno_personal.fecegrper, ".
			    " sno_hpersonalnomina.codper,sno_hpersonalnomina.anocur,".
			    " sno_personal.sexper,sno_personal.fecnacper,sno_personal.cauegrper".
			    " ,sno_hpersonalnomina.descasicar,sno_hpersonalnomina.codnom".
			    "  ".$ls_orden." ASC";

	/*
		,sno_personal.sexper,sno_personal.fecnacper,sno_personal.cauegrper,
		sno_hpersonalnomina.codemp,sno_hpersonalnomina.codnom,sno_hpersonalnomina.codsubnom,sno_hpersonalnomina.codasicar,
		sno_hpersonalnomina.codtab,sno_hpersonalnomina.codgra,sno_hpersonalnomina.codpas,sno_hpersonalnomina.sueper,
		sno_hpersonalnomina.horper,sno_hpersonalnomina.minorguniadm,sno_hpersonalnomina.ofiuniadm,sno_hpersonalnomina.uniuniadm,
		sno_hpersonalnomina.depuniadm,sno_hpersonalnomina.prouniadm,sno_hpersonalnomina.pagbanper,sno_hpersonalnomina.codban,
		sno_hpersonalnomina.codcueban,sno_hpersonalnomina.tipcuebanper,sno_hpersonalnomina.codcar,sno_hpersonalnomina.fecingper,
		sno_hpersonalnomina.staper,sno_hpersonalnomina.cueaboper,sno_hpersonalnomina.fecculcontr,sno_hpersonalnomina.codded,
		sno_hpersonalnomina.codtipper,sno_hpersonalnomina.quivacper,sno_hpersonalnomina.codtabvac,sno_hpersonalnomina.sueintper,
		sno_hpersonalnomina.pagefeper,sno_hpersonalnomina.codage,sno_hpersonalnomina.sueproper,sno_hpersonalnomina.fecegrper,
		sno_hpersonalnomina.fecsusper,sno_hpersonalnomina.cauegrper,sno_hpersonalnomina.codescdoc,sno_hpersonalnomina.codcladoc,
		sno_hpersonalnomina.codubifis,sno_hpersonalnomina.tipcestic,sno_hpersonalnomina.conjub,sno_hpersonalnomina.catjub,
		sno_hpersonalnomina.codclavia,sno_hpersonalnomina.codunirac,sno_hpersonalnomina.pagtaqper,sno_hpersonalnomina.grado,
		sno_hpersonalnomina.fecascper,sno_hpersonalnomina.descasicar,sno_hpersonalnomina.coddep,sno_hpersonalnomina.salnorper,
		sno_hpersonalnomina.estencper,sno_hpersonalnomina.obsrecper,sno_hpersonalnomina.anovig
	*/

                       // print  $ls_sql."<br><br>"; die(); //CAMB //DEBUG
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report MOTODO->uf_faov ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
