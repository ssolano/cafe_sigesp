...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_load_variables()
   {
		...
		//	   Creado Por: Ing. Laura Cabre
		// Fecha Creaci�n: 05/08/2007			Fecha �ltima Modificaci�n : 29/04/2007
		//////////////////////////////////////////////////////////////////////////////
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <input name="txtfecope" type="text" class="sin-borde" id="txtfecope" value="<?php print $ld_fecope ?>" size="15" maxlength="12" /></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
	   ...
	   if (li_leer==1)
		  {
		    if (ls_tipope!='-')
		       ...
		       {
		         alert("Debe seleccionar el Tipo de Operaci�n a realizar (Aprobaci�n/Reverso) !!!");
		       }
	      }
       else
          {
