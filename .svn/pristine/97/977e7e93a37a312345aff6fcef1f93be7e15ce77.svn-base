...
class sigesp_ins_c_cambioiva
 {
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$lb_valido=$this->uf_insert_cargos($ls_newcodcar,$ls_dencar,$ls_codestpro,$ls_spgcuenta,
												   $ai_pornueali,$ls_estlibcom,$as_formula,$aa_seguridad);
							   ...
							   $as_formula,$aa_seguridad)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="INSERT INTO sigesp_cargos(codemp, codcar, dencar, codestpro, spg_cuenta, porcar, estlibcom, formula)".
