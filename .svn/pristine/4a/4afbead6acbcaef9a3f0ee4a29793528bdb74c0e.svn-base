...
if($ls_operacion=="GUARDARPRE")
{
	...
	else
	{
		...
		//$ld_fecha==$fun->uf_formatovalidofecha($ld_fecha);
		$ld_fecdb=$fun->uf_convertirdatetobd($ld_fecha);
...
MODIFICACION PRESUPUESTARIA POR <? print strtoupper($ls_titulo); ?> </td>
  ...
  <tr>
    ...
    <td width="459"><input name="txtdocumento" type="text" id="txtdocumento" style="text-align:center" onBlur="javascript:valid_cmp(this);" size="22" maxlength="15" value="<?php print $ls_documento;?>" <? print $ls_read;?>></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
      <input name="codestpro1" type="text" id="codestpro1" style="text-align:center" size="<?php print $ls_loncodestpro1; ?>" maxlength="<?php print $ls_loncodestpro1; ?>" value="<?php print $ls_estpro1; ?>" readonly>
  ...
  <tr>
    ...
    <td><input name="txtcuenta" type="text" id="txtcuenta" readonly="true" value="<?php print $ls_cuentaplan ?>" size="22" style="text-align:center">
        <a href="javascript:catalogo_cuentasSPG();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a>
        <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion" style="text-align:left" value="<?php print $ls_denominacion ?>" size="50" maxlength="254"></td>
  </tr>
    ...
    <td><input name="txtcodfuefin" type="text" id="txtcodfuefin" readonly="true" value="<?php print $ls_codfuefindet ;?>" size="22" style="text-align:center">
        ...
        <input name="txtdenfuefin" type="text" class="sin-borde" id="txtdenfuefin" style="text-align:left" value="<?php print $ls_denfuefindet ?>" size="50" maxlength="254"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="operacion"   type="hidden" id="operacion">
	    ...
	    <input name="codtipomod"    type="hidden" id="codtipomod" value="<?php print $ls_codtipomod; ?>" >
        </span></td>
  </tr>
</table>
</form>
  ...
  function aceptar_presupuestario()
  {
    ...
    if(estmodest==1)
	{
		...
		(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto!=""))
		{
			...
			f.action="sigesp_w_regdt_adicionalspg.php";
			f.submit();
		}
		else
		{
