...
$io_fun_activo->uf_load_seguridad("SAF","sigesp_saf_r_incorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{
				window.open("reportes/sigesp_saf_rpp_incorporacion.php?desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&orden="+li_orden+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
