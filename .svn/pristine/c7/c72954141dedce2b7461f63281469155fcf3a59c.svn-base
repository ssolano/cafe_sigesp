...
class sigesp_saf_class_report
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT saf_movimiento.cmpmov,saf_movimiento.codcau,saf_movimiento.descmp,saf_movimiento.feccmp,saf_causas.dencau,".
                        " CASE WHEN (saf_movimiento.coduniadm<>'') THEN ".
                        " (select spg_unidadadministrativa.denuniadm from spg_unidadadministrativa where saf_movimiento.coduniadm=spg_unidadadministrativa.coduniadm)".
                        " ELSE".
                        " '' ".
                        " END AS denuniadm,".
                        " CASE WHEN (saf_movimiento.codresuso<>'') THEN ".
                        " (select sno_personal.nomper || ' ' || sno_personal.apeper from sno_personal where sno_personal.codper=saf_movimiento.codrespri)".
                        " ELSE".
                        " '' ".
                        " END AS respri,".
                        " CASE WHEN (saf_movimiento.codresuso<>'') THEN ".
                        " (select sno_personal.nomper || ' ' || sno_personal.apeper from sno_personal where sno_personal.codper=saf_movimiento.codresuso)".
                        " ELSE".
                        " '' ".
                        " END AS resuso,".
                        " saf_movimiento.coduniadm, saf_movimiento.codrespri, saf_movimiento.codresuso ".
                        ...
                        " GROUP BY saf_movimiento.cmpmov,saf_movimiento.codcau,saf_movimiento.descmp,saf_causas.dencau, saf_movimiento.feccmp,".
                        " saf_movimiento.coduniadm, saf_movimiento.codrespri, saf_movimiento.codresuso";
		if($ai_orden!="")
		{
			if($ai_orden==0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="  SELECT saf_dt_movimiento.*,".
				"  (SELECT denact           FROM saf_activo          WHERE saf_activo.codact=saf_dt_movimiento.codact) AS denact, ".
				"  (SELECT seract 		    FROM saf_dta 		   WHERE saf_dta.codact=saf_dt_movimiento.codact ".
	...
	function uf_siv_load_dt_movreasignacion($as_codemp,$as_cmpmov)
	{
		...
		$ls_sql="SELECT saf_dt_traslado.*, saf_dt_movimiento.desmov,saf_dt_movimiento.monact,".
				" (SELECT feccmp FROM saf_movimiento WHERE saf_movimiento.cmpmov=saf_dt_movimiento.cmpmov".
				" AND saf_movimiento.codemp=saf_dt_movimiento.codemp) AS feccmp,".
				" (SELECT descmp FROM saf_movimiento WHERE saf_movimiento.cmpmov=saf_dt_movimiento.cmpmov".
		        " AND saf_movimiento.codemp=saf_dt_movimiento.codemp) AS descmp,".
				" (SELECT codcau FROM saf_movimiento WHERE saf_movimiento.cmpmov=saf_dt_movimiento.cmpmov".
		        " AND saf_movimiento.codemp=saf_dt_movimiento.codemp) AS codcau,".
				" (SELECT dencau FROM saf_causas,saf_movimiento WHERE saf_causas.codcau=saf_movimiento.codcau".
				" AND saf_movimiento.cmpmov=saf_dt_movimiento.cmpmov AND saf_causas.estcat='1') AS dencau,".
				" (SELECT denact FROM saf_activo WHERE saf_activo.codact=saf_dt_movimiento.codact) AS denact,".
				" res.nomper || ' '|| res.apeper as nomres, nw.nomper || ' ' || nw.apeper as nomnew,".
				" uni.denuniadm, uninew.denuniadm as uniadmnew".
				" FROM saf_dt_traslado,saf_dt_movimiento, sno_personal res, sno_personal nw,".
				" spg_unidadadministrativa uni, spg_unidadadministrativa uninew".
				" WHERE saf_dt_traslado.cmpmov=saf_dt_movimiento.cmpmov   AND saf_dt_traslado.codact=saf_dt_movimiento.codact".  
				" AND saf_dt_traslado.codres=res.codper AND saf_dt_traslado.codresnew=nw.codper".
				" AND saf_dt_traslado.coduniadm=uni.coduniadm AND saf_dt_traslado.coduniadmnew=uninew.coduniadm". 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_saf_buscar_autorizacion($as_codemp,$as_cmpsal,$as_coduniadmcede,$ad_fechauto,$as_codprov,
