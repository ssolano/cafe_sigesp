<?php
   ...
   function uf_print($as_codproy, $as_nomproy, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp, codproy, nomproy, estproproy,estcla, ".
				...
				"		    AND spg_ep1.codestpro1=substr(sno_hproyecto.estproproy,0,26) ".
				"           AND spg_ep1.estcla=sno_hproyecto.estcla".
				"           AND spg_ep1.estcla=sno_hproyecto.estcla) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep2.codestpro1=substr(sno_hproyecto.estproproy,0,26) ".
				"		    AND spg_ep2.codestpro2=substr(sno_hproyecto.estproproy,26,25)".
				"           AND spg_ep2.estcla=sno_hproyecto.estcla) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep3.codestpro1=substr(sno_hproyecto.estproproy,0,26) ".
				"		    AND spg_ep3.codestpro2=substr(sno_hproyecto.estproproy,26,25) ".
				"		    AND spg_ep3.codestpro3=substr(sno_hproyecto.estproproy,51,25)".
				"           AND spg_ep3.estcla=sno_hproyecto.estcla) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep4.codestpro1=substr(sno_hproyecto.estproproy,0,26) ".
				"		    AND spg_ep4.codestpro2=substr(sno_hproyecto.estproproy,26,25) ".
				"		    AND spg_ep4.codestpro3=substr(sno_hproyecto.estproproy,51,25) ".
				"		    AND spg_ep4.codestpro4=substr(sno_hproyecto.estproproy,76,25)".
				"           AND spg_ep4.estcla=sno_hproyecto.estcla) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep5.codestpro1=substr(sno_hproyecto.estproproy,0,26) ".
				"		    AND spg_ep5.codestpro2=substr(sno_hproyecto.estproproy,26,25) ".
				"		    AND spg_ep5.codestpro3=substr(sno_hproyecto.estproproy,51,25) ".
				"		    AND spg_ep5.codestpro4=substr(sno_hproyecto.estproproy,76,25) ".
				"		    AND spg_ep5.codestpro5=substr(sno_hproyecto.estproproy,101,25)".
