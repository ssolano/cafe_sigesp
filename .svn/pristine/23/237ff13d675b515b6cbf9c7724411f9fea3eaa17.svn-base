  ...
  with (form1)
  {
    ...
    else
    {
	  ...
	  else
	  {
		...
		f.action="sigesp_scg_plan_unicore.php";
		f.submit();
	  }
	} 
  }
...
{
   f=document.form1;
   pagina="sigesp_catdinamic_ctaspure.php?";
