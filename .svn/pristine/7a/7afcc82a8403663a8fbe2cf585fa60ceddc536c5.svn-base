<?php
	...
	function uf_print_encabezado_pagina1($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,710,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_encabezado_pagina2($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		//    Description: función que imprime los encabezados por página
		//	   Creado Por: Ing. Yesenia Moreno
		//  Modificado por: Ing. Carlos Morales mbancarlos@gmail.com 26/11/2014
		// Fecha Creación: 05/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		...
		$li_tm=$io_pdf->getTextWidth(9,$as_desnom);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,290,9,$as_desnom); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
        */
        //--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_desnom,$as_fecingper,&$io_cabecera,&$io_pdf,$as_desubifis="",$ai_sueper)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera1
		//		   Access: private
		...
		//	    		   io_cabecera // objeto cabecera
		//	    		   io_pdf // Objeto PDF
		//    Description: función que imprime la cabecera por personal aparte de la ubicacion fisica
		//  Modificado por: Ing. Carlos Morales mbancarlos@gmail.com 26/11/2014
		//	   Creado Por: Ing. Yesenia Moreno
		...
		$tm_ubi=306-($li_ubi/2);
		$io_pdf->addText($tm,710,9,$as_desnom); // Agregar el título
		$io_pdf->addText($tm_ubi,698,9,"<b><i>".$as_desubifis."</i></b>"); // Agregar ubicacion fisica
		$io_pdf->addText(40,695,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'sueldomensual'=>'Sueldo Mensual:' ,'fecha'=>'Fecha Ingreso:' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','sueldomensual'=>'','fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 8, // Tamaño de Letras
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   ...
						 			   'cargo'=>array('justification'=>'left','width'=>150),
                                                                           'sueldomensual'=>array('justification'=>'left','width'=>70),
                                                                           'fecha'=>array('justification'=>'left','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,684,'10','______________________________________________________________________________________________');
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100),'sueldomensual'=>  number_format($ai_sueper,2,',','.')." Bs.",'fecha'=>$as_fecingper));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','sueldomensual'=>'','fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 7, // Tamaño de Letras
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'left','width'=>150),
                                                                           'sueldomensual'=>array('justification'=>'center','width'=>70),
                                                                           'fecha'=>array('justification'=>'left','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,666,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetY(668);
		$la_data=array(array('denomasig'=>'<b>DENOMINACIÓN</b>', 'unidad'=>'', 'valorasig'=>'<b>ASIGNACIÓN</b>', 'denomdedu'=>'<b>DENOMINACIÓN</b>','valordedu'=>'<b>DEDUCCIÓN</b>'));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'unidad'=>'<b>UNIDAD</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
						  'denomdedu'=>'<b>DENOMINACIÓN</b>',
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_desnom,$as_fecingper,&$io_cabecera,&$io_pdf,$as_desubifis, $ai_sueper)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private
		...
		$tm_ubi=306-($li_ubi/2);
		$io_pdf->addText($tm,290,9,$as_desnom); // Agregar el título
		$io_pdf->addText($tm_ubi,278,9,"<b><i>".$as_desubifis."</i></b>"); // Agregar ubicacion fisica
		$io_pdf->addText(40,275,'10','______________________________________________________________________________________________');
		$io_pdf->ezSetDy(-175);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:','sueldomensual'=>'Sueldo Mensual:', 'fecha'=>'Fecha Ingreso:' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'', 'sueldomensual'=>'','fecha'=>'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'left','width'=>220),
                                                                            'sueldomensual'=>array('justification'=>'left','width'=>70),
                                                                           'fecha'=>array('justification'=>'left','width'=>80))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,246,'10','______________________________________________________________________________________________');
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//	   			   io_pdf // Objeto PDF
		//    Description: función que imprime el detalle por personal y ademas muestra las unidades de conceptos
		//  Modificado por: Ing. Carlos Morales mbancarlos@gmail.com 26/11/2014
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 05/05/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('denomasig'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
									   'unidad'=>array('justification'=>'right','width'=>30), // Justificación y ancho de la columna
						 			   'valorasig'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'denomdedu'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'valordedu'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
			...
			if($lb_valido)
			{
				...
				{					
					...
					{					
						...
						$ls_tipsal=rtrim($io_report->rs_data_detalle->fields["tipsal"]);
						$ls_unidad=$io_report->rs_data_detalle->fields["unidad"]; 
						$ls_denunidad=$io_report->rs_data_detalle->fields["denunidad"]; 
...
//echo "<pre>".print_r($la_data_a,true)."</pre>***"; exit(); //CAMB DEBUG		
