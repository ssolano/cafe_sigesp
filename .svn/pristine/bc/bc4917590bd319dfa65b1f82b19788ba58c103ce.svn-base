...
/********************************************************************************************************************************/	
    function  sigesp_spg_reporte_bsf()
    {
   ...
   function  uf_spg_reporte_comprobante_formato2($as_spg_cuenta_ori,$as_spg_cuenta_des,$adt_fecini,$adt_fecfin,$as_comprobante,$as_procede)
   {
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT * ".
	          ...
	          "               MV.operacion = OP.operacion AND MV.codestpro1=PR.codestpro1 AND MV.codestpro2=PR.codestpro2 AND ".
			  "               MV.codestpro3=PR.codestpro3 AND MV.codestpro4=PR.codestpro4 AND MV.codestpro5=PR.codestpro5 AND ".
              "               MV.estcla=CC.estcla  AND  CC.estcla=PR.estcla	".$ls_cad_where3."  ".$ls_cad_filtro2."    ".
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    16/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT DM.*, DM.montoaux as monto, GC.denominacion ".
...
/********************************************************************************************************************************/	
    function uf_spg_reporte_select_apertura($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori, 
	                                        ...
	                                        $as_codestpro4_des,$as_codestpro5_des,$adt_fecini,$adt_fecfin,$as_codfuefindes,
											$as_codfuefinhas,&$rs_data,$as_estclades,$as_estclahas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reporte_apertura
	 //         Access :	private
	 //     Argumentos :    as_codestpro1_ori ... $as_codestpro5_ori //rango nivel estructura presupuestaria origen
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_cuentas===false)
		{   //error interno sql
		   $this->io_msg->message("Error en Reporte Acumulado por Cuenta  ".$this->fun->uf_convertirmsg($this->SQL->message));
           return false;
		}
		else
        {
...
/********************************************************************************************************************************/	
	function uf_calcular_acumulado_operacion_anterior($as_str_sql_where,$adt_fecini,$as_spg_cuenta,$adec_monto,
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql=" SELECT distinct (".$ls_str_sql_2.") as programatica ".
			 ...
			 "       MV.estcla=C.estcla AND (".$ls_str_sql_2." BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."') AND ".
			 "       ".$ls_tabla.".codfuefin BETWEEN '".trim($as_codfuefindes)."' AND '".trim($as_codfuefinhas)."'  ".
			 "       ".$ls_cadena_fuefin."    ".
			 " ORDER BY programatica"; 
	    /*$ls_sql=" SELECT distinct (".$ls_str_sql_2.") as programatica ".
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
	  ...
	  $ls_sql=" SELECT   MV.* , C.denominacion,MV.montoaux as monto_mov,MV.montoaux as monto  ". 
             " FROM   spg_dt_cmp MV,spg_operaciones OPE,spg_cuentas C ".
             " WHERE  MV.codemp='".$ls_codemp."' AND MV.operacion=OPE.operacion AND ".
             "        MV.codestpro1=C.codestpro1 AND MV.codestpro2=C.codestpro2 AND ".
			 "        MV.codestpro3=C.codestpro3 AND MV.codestpro4=C.codestpro4 AND ".
  	 ...
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ai_ckbhasfec==0)
		{
            $lb_valido=$this->uf_spg_reporte_select_cuenta($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$rs_data,
										  ...
										  $as_codestpro5_des,$as_cuenta_from,$as_cuenta_to,$as_ckbctasinmov,$as_estclades,$as_estclahas);
			if($lb_valido)
			{
		     $li_numrows=$this->SQL->num_rows($rs_data);
		     if($li_numrows<=0)
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_ejecutado($as_spg_cuenta,$as_estructura_desde,$as_estructura_hasta,$ai_mesdes,
	                                           $ai_meshas,&$ad_monto_ejecutado,&$ad_monto_acumulado,$as_codfuefindes,
											   $as_codfuefinhas,$ls_estcla)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    26/01/2007          Fecha última Modificacion :      Hora :
	  ...
	  $as_spg_cuenta=$this->sigesp_int_spg->uf_spg_cuenta_sin_cero($as_spg_cuenta)."%";
	  $ls_sql=" SELECT DT.fecha, (DT.montoaux) as monto, (OP.aumentoaux) as aumento, (OP.disminucionaux) as disminucion, ".
	          "        (OP.precomprometeraux) as precomprometer,(OP.comprometeraux) as comprometer, (OP.causaraux) as causar,".
			  "        (OP.pagaraux) as pagar ".
