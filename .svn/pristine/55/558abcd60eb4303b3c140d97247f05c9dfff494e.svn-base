...
//					if(($ai_generarcontable=="1")&&($as_estcontable=="1")&&(($li_iva!="1")||($ls_estretiva=="C")||($li_islr!="1")))
	...
	{	
		...
		$lo_title[3]=utf8_encode("Estatus");
		$lo_title[4]=utf8_encode("Código Estadístico");
		$lo_title[5]="Monto"; 
		$lo_title[6]=" "; 
		...
		for($li_fila=1;$li_fila<=$li_totrow;$li_fila++)
		{
			...
			switch($ls_estcla)
			{
				case "A":
					...
					$_SESSION['presuestatus']=utf8_encode("Acción");
					break;
				case "P":
					$ls_estatus=utf8_encode("Proyecto");
					$_SESSION['presuestatus']=utf8_encode("Proyecto");
					break;
				default:
					$ls_estatus=$_SESSION['presuestatus'];
					if($ls_estatus=="Proyecto")
					{
						$ls_estcla = "P";
					}else{
							$ls_estcla = "A";
