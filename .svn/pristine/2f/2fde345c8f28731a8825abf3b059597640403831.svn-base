...
?>	
  ...
  <table width="828" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td width="109"><input name="txtestant"  readonly="true" type="text" class="celdas-grises" id="txtestant" style="text-align:center " value="<?php print $ls_estant;?>" size="15" maxlength="20"></td>
        <td height="39" colspan="3">&nbsp;</td>
        <td width="34" height="39"><div align="right">Fecha</div></td>
        <td width="124" height="39"><input name="txtfecant" type="text" id="txtfecant"  style="text-align:center" value="<?php print $ls_fecant ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="26" colspan="4"><input name="txtporant"  style="text-align:right "type="text" id="txtporant" onKeyPress="return keyRestrict(event,'0123456789'+',');"   onBlur="javascript:ue_validaporcentaje(this)" value="<?php print $ls_porant?>" size="21" maxlength="6" onFocus="javascript:ue_guardarvalor()">        
        %</td>
		<td height="26"><div align="right">Monto del Anticipo</div></td>
        <td height="26" colspan="2"><input name="txtmonto" type="text"  style="text-align:right" id="txtmonto"size="21"   value="<?php print $ls_monto?>" maxlength="21" onKeyPress="return(validaCajas(this,'d',event,21)) " onBlur="javascript:ue_validamonto(this)" onFocus="javascript:ue_guardarvalor()" >        
        Bs.</td>
        <td height="26">&nbsp;</td>
      </tr>
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="2"><input name="txtmontotant" type="text" id="txtmontotant" style=" text-align:right" value="<?php print $ls_montotant?>" size="21" maxlength="21" readonly="true"></td>
        <td>&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="11">&nbsp;</td>
