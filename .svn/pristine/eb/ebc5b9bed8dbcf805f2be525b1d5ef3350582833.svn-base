...
//Fecha de modificacion: 09 de Julio de 2009
	...
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,&$io_cabecera,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>230), // Justificación y ancho de la columna
						 			   'cedula'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
						 			   'cargo'=>array('justification'=>'left','width'=>245))); // Justificación y ancho de la columna
