...
//---------------------------------------------------------------------------------------------------------------------------------------
	function  uf_select_items_cotizacion($as_numcot,$as_codpro,$as_numanacot,$as_tipsolcot,&$aa_items,&$li_i)
	{
		...
		if($as_tipsolcot=="B")
		{				
			$ls_sql="SELECT DISTINCT d.codart as codigo, 
			                a.denart as denominacion, p.nompro, 
							soc_dtsc_bienes.canart as cantidad, 
							dt.preuniart as precio, 
							dt.moniva,dt.montotart as monto,
					        d.obsanacot, d.numcot, d.cod_pro,
							soc_dtsc_bienes.numsep,       
						    soc_dtsc_bienes.coduniadm,
						    soc_dtsc_bienes.codestpro1,
						    soc_dtsc_bienes.codestpro2,
						    soc_dtsc_bienes.codestpro3,
						    soc_dtsc_bienes.codestpro4,
						    soc_dtsc_bienes.codestpro5,
		...
		else
		{
				$ls_sql="SELECT DISTINCT d.codser as codigo, a.denser as denominacion, p.nompro, soc_dtsc_servicios.canser as cantidad, dt.monuniser as precio, dt.moniva,dt.montotser as monto,
					            d.obsanacot, d.numcot, d.cod_pro,
								soc_dtsc_servicios.numsep,       
								soc_dtsc_servicios.coduniadm,
								soc_dtsc_servicios.codestpro1,
								soc_dtsc_servicios.codestpro2,
								soc_dtsc_servicios.codestpro3,
								soc_dtsc_servicios.codestpro4,
								soc_dtsc_servicios.codestpro5,
								soc_dtsc_servicios.estcla
