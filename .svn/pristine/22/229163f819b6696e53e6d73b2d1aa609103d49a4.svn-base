...
class sigesp_soc_c_solicitud_cotizacion
{
  function sigesp_soc_c_solicitud_cotizacion($as_path)
  {
	...
	{		
		...
		//				   as_numsolcot          // N�mero de la Solicitud de Cotizacion.
		//				   as_tipsolcot          // Tipo de la Solicitud de Cotizacion.
		//				   as_obssolcot          // Observaci�n de la Solicitud de Cotizaci�n.
		//				   ad_fecregsolcot  	 // Fecha de Registro de la Solicitud de Cotizaci�n.
		//				   as_codunieje 		 // Codigo de Unidad Ejecutora.
		//				   as_cedpersol  		 // C�dula del Personal Silicitante de la Base de Datos.
		//				   ai_totrowbienes  	 // Total de Filas de Bienes
		//				   ai_totrowservicios  	 // Total de Filas de Servicios
		//				   ai_totrowsep          // Total de Filas de Solicitudes de Ejecuci�n Presupuestaria.
		//				   ai_totrowproveedores  // Total de Filas de Proveedores.
		//				   as_telpersol          // Tel�fono de la Persona Solicitante.
		...
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 04/05/2007 								Fecha �ltima Modificaci�n : 16/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido     = false;	
											...
											$ai_totrowsep,$ai_totrowproveedores,$as_tabla,$as_campo,$as_tipbiesol,$aa_seguridad)
	{
		...
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 03/05/2007 								Fecha �ltima Modificaci�n : 03/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($lb_valido)
		{
			...
			if($li_row===false)
			{
				...
				{
				  $lb_valido=false;
				  $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_insert_solicitud_cotizacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			...
			else
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� la solicitud de Cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
				...
				if($lb_valido)//Se almacenan Las Solicitudes de Ejecuci�n Presupuestarias asociadas a una Solicitud de Cotizaci�n.
				{	
				...
				{	
					...
					{
						$this->io_mensajes->message("Se Asigno el Numero de Solicitud de Cotizaci�n: ".$as_numsolcot);
					}
											...
											$ai_totrowsep,$ai_totrowproveedores,$as_tabla,$ls_campo,$as_tipbiesol,$aa_seguridad)
	{
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_update_solicitud_cotizacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$this->io_sql->rollback();
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� la Solicitud de Cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////	
	...
	//		   Access: private
	//	    Arguments: as_numsolcot     // N�mero de Solicitud de Cotizacion.
	//           $ai_totrowproveedores  // Total de Filas de Proveedores.
	//				   ai_totrowbienes  // Total de Filas de Bienes
	//				   aa_seguridad     // arreglo de las variables de seguridad
	//	      Returns: lb_valido True si se ejecuto el insert � False si hubo error en el insert
					   ...
					   for ($i=1;($i<$ai_totrowbienes)&&($lb_valido);$i++)
						   {
							 ...
							 if ($rs_data===false)
								{
									$lb_valido=false;
									$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_insert_bienes ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
								}
								else
								{
									...
									if ($lb_valido)
									   {
										 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
										 $ls_evento="INSERT";
										 $ls_descripcion ="Insert� el Articulo ".$ls_codart." a la Solicitud de Cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
										 $lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
																		$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
																		$aa_seguridad["ventanas"],$ls_descripcion);
										 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
					   ...
					   for ($i=1;($i<$ai_totrowservicios)&&($lb_valido);$i++)
						   {
							 ...
							 if ($rs_data===false)
								{
									$lb_valido=false;
									$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_insert_servicios ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
								}
								else
								{
								  ...
								  if ($lb_valido)
									 {
									   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
									   $ls_evento="INSERT";
									   $ls_descripcion ="Insert� el Servicio ".$ls_codser." a la Solicitud de Cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
									   $lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
																		$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
																		$aa_seguridad["ventanas"],$ls_descripcion);
										/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			  ...
			  if (!empty($ls_numsep))
				 {
				   ...
				   if ($rs_data===false)
					  {
						$lb_valido=false;
						$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_insert_solicitudes_presupuestarias; ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
					  }
				   else
					  {
				        ...
				        if ($lb_valido)
					       {
							 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
							 $ls_evento="INSERT";
							 $ls_descripcion ="Insert� SEP  ".$ls_numsep." a la Solicitud de Cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
							 $lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
															 $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
															 $aa_seguridad["ventanas"],$ls_descripcion);
							 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_select_solicitud_cotizacion($as_numsolcot)
	{
		...
		//		   Access: private
		//	    Arguments: as_numsolcot  //  N�mero de Solicitud
		// 	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si la Solicitud de Cotizaci�n Existe.
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 17/03/2007 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_select_solicitud_cotizacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_validar_fecha_solicitud_cotizacion($ad_fecregsolcot)
	{
		...
		//		   Access: private
		//		 Argument: $ad_fecregsolcot // Fecha de registro de la nueva Solicitud de Cotizaci�n.
		//	  Description: Funci�n que busca la fecha de la �ltima Solicitud de Cotizacion y la compara con la fecha actual.
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 17/03/2007								Fecha �ltima Modificaci�n : 
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion->M�TODO->uf_validar_fecha_solicitud_cotizacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_bienes($as_numsolcot)
	{
		...
		//	  Description: Funci�n que busca los bienes asociados a una solicitud de cotizacion
		//	   Creado Por: Ing. Nestor Falcon.
		// Fecha Creaci�n: 08/05/2007								Fecha �ltima Modificaci�n : 08/05/2007
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_bienes ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	function uf_load_servicios($as_numsolcot)
	{
		...
		//		   Access: public
		//		 Argument: as_numsolcot // N�mero de solicitud
		//	  Description: Funci�n que busca los bienes asociados a una solicitud de cotizacion
		//	   Creado Por: Ing. Nestor Falcon.
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_servicios ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	function uf_load_proveedores($as_numsolcot,$as_tipsolcot)
	{
		...
		//		   Access: public
		//		 Argument: as_numsol // N�mero de solicitud
		//	  Description: Funci�n que busca los proveedores asociados a una solicitud de cotizacion
		//	   Creado Por: Ing. Nestor Falcon.
		// Fecha Creaci�n: 11/05/2007								Fecha �ltima Modificaci�n : 11/05/2007
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_proveedores.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	function uf_delete_solicitud_cotizacion($as_numsolcot,$as_tipsolcot,$ai_totrowsep,$aa_seguridad)
	{
		...
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 13/03/2007 								Fecha �ltima Modificaci�n : 13/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$this->io_sql->begin_transaction();
		if ($as_tipsolcot=='B')
		...
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_delete_solicitud_cotizacion.php->ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
				$this->io_sql->rollback();
			}
			else
			{
	...
	function uf_delete_detalles($as_numsolcot,$as_tipsolcot,$ai_totrows,$as_tabla,$aa_seguridad)
	{
		...
		//		   Access: private
		//	    Arguments: as_numsol  // N�mero de Solicitud de cotizacion.
		//				   as_tabla  // Tabla donde se deben insertar los cargos
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el delete � False si hubo error en el mismo.
		//	  Description: Funcion que elimina los detalles de una solicitud de cotizacion.
		//	   Creado Por: Ing. N�stor Falcon.
		// Fecha Creaci�n: 13/05/2007 								Fecha �ltima Modificaci�n : 13/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = true;
		...
		if ($rs_data===false)
		   {
		     $this->io_sql->rollback();
			 $lb_valido = false;
			 $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_delete_detalles(Bienes)->ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		   }
		if ($lb_valido)
		   {
			 ...
			 if ($rs_data===false)
			    {
				  $lb_valido=false;
			      $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_delete_detalles ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		  	    }
		   }
		if ($lb_valido)
		   {
		...
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="DELETE";
			$ls_descripcion ="Elimin� todos los detalles de la solicitud de cotizacion ".$as_numsolcot." Asociado a la empresa ".$this->ls_codemp;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////	
	...
	function uf_load_bienes_sep($as_numsol)
	{
		...
		//		   Access: public
		//		 Argument: as_numsol // N�mero de solicitud
		//	  Description: Funci�n que busca los Bienes asociados a una Solicitud de Ejecuci�n Presupuestaria.
		//	   Creado Por: Ing. Nestor Falcon.
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_bienes_sep.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	function uf_load_servicios_sep($as_numsol)
	{
		...
		//		   Access: public
		//		 Argument: as_numsol // N�mero de solicitud
		//	  Description: Funci�n que busca los Servicios asociados a una Solicitud de Ejecuci�n Presupuestaria.
		//	   Creado Por: Ing. Nestor Falcon.
		// Fecha Creaci�n: 16/05/2007								Fecha �ltima Modificaci�n : 16/05/2007
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_servicios_sep.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	function uf_load_sep_solcot($as_numsolcot)
	{
		...
		//		   Access: public
		//		 Argument: as_numsolcot // N�mero de solicitud de Cotizacion
		//	  Description: Funci�n que busca los Solicitudes de Ejecuci�n Presupuestaria Asociadas a una Solicitud de Cotizacion.
		//	   Creado Por: Ing. Nestor Falcon.
		// Fecha Creaci�n: 20/05/2007								Fecha �ltima Modificaci�n : 20/05/2007
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_load_sep_solcot.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	//		   Access: public
	//		 Argument: $as_numsolcot       //Numero de la Solicitud de Cotizaci�n.
	//                 $as_numsep          //N�mero de la Solicituds de Ejecuci�n Presupuestaria. 
	//                 $as_tipsolcot       //Tipo de Solicitud de Cotizaci�n B= Bienes, S= Servicios.  
	//                 $as_codigo          //
	//                 $as_desope	       //Si la operacion a realizar es un Insert o un Delete.
	//	  Description: Funci�n actualiza el estatus de incorporacion del item en las Tabla de Detalles de la SEP.
	//	   Creado Por: Ing. Nestor Falcon.
	// Fecha Creaci�n: 20/05/2007								Fecha �ltima Modificaci�n : 20/05/2007
	//////////////////////////////////////////////////////////////////////////////
		...
		if ($rs_recordset===false)
		   {
			 $lb_valido = false;
			 $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_update_estatus_incorporacion->ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			 $this->io_sql->rollback();
		   }
		return $lb_valido;
	...
	//      $as_numsep //N�mero de la Solicitud de Ejecuci�n Presupuestaria.
	...
	//	  Description: Funci�n actualiza el estatus de la SEP a procesada en caso de que ningun Item se encuentre como 
	//                 NI = NO INCORPORADO.
	//	   Creado Por: Ing. Nestor Falcon.
	// Fecha Creaci�n: 26/07/2007								Fecha �ltima Modificaci�n : 20/07/2007
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      if ($as_desope=='INSERT')
	     {
		   ...
		   if ($rs_data===false)
		      {
			    $lb_valido = false;
			    $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_update_estatus_sep(INSERT)->ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			  }
		 } 
      else
	     {
		   ...
		   if ($rs_data===false)
		      {
			    $lb_valido = false;
			    $this->io_mensajes->message("CLASE->sigesp_soc_c_solicitud_cotizacion.php->M�TODO->uf_update_estatus_sep->ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			  }
		   else
		      {
