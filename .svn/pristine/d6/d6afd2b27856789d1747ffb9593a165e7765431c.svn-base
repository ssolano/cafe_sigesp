...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	if($ls_operacion == "GUARDAR")
	{
		...
		$lb_valido=$in_classbanco->uf_guardar_banco($ls_codigo,$ls_nombre,$ls_direccion,$ls_gerente,$ls_telefono,$ls_celular,$ls_email,$lb_tesoreria,$ls_status,$ls_codsude,$ls_swift);
...
?>
          ...
          <table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr class="formato-blanco">
              <td height="22" style="text-align:right">C&oacute;digo Swift</td>
              <td height="22" colspan="2" style="text-align:left"><input name="txtswift" type="text" id="txtswift" value="<?php print $ls_swift ?>" size="16" maxlength="12" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz ');"  style="text-align:center "></td>
            </tr>
            <tr class="formato-blanco">
	...
	if (((lb_status=="C")&&(li_cambiar==1))||(lb_status=="N")&&(li_incluir==1))
	   {
		 ...
		 ls_swift=f.txtswift.value;
	     if ((ls_nombre!="")&&(ls_nombre!="")&&(ls_direccion!="")&&(ls_gerente!="")&&(ls_telefono!="")&&(ls_celular!="")&&(ls_codsude!="")&&(ls_swift!=""))
	        {
