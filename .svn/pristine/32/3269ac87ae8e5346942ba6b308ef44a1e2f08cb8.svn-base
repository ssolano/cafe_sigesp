<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_dentipsol,&$io_pdf)
	{
		...
		{		
			...
			$io_pdf->addText(150,122,7,"RECIBIDO POR"); // Agregar el título
			$io_pdf->addText(135,73,7,"DPTO DE COMPRAS"); // Agregar el título
			$io_pdf->addText(145,63,7,"FIRMA/SELLO"); // Agregar el título
			$io_pdf->addText(255,122,7,"APROBADO POR"); // Agregar el título
			$io_pdf->addText(260,73,7,"PRESIDENCIA"); // Agregar el título
			$io_pdf->addText(240,63,7,"ING. CARLOS D' LA ROSA"); // Agregar el título
			$io_pdf->addText(365,122,7,"APROBADO POR"); // Agregar el título
			$io_pdf->addText(360,73,7,"GERENCIA TECNICA"); // Agregar el título
			$io_pdf->addText(350,63,7,"ING. AREVALO SALAZAR"); // Agregar el título
			$io_pdf->addText(485,122,7,"APROBADO POR"); // Agregar el título
			$io_pdf->addText(465,73,7,"GERENCIA ADMINISTRATIVA"); // Agregar el título
			$io_pdf->addText(475,63,7,"LCDO. JOSE G. TORRES"); // Agregar el título
		}
		$io_pdf->restoreState();
		$io_pdf->closeObject();
