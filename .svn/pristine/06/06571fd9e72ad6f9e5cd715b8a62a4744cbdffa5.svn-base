<?php
   ...
   function uf_print($as_codtab, $as_destab, $as_tipo)
   {
		...
		print "</tr>";		
		$ls_sql="SELECT sno_tabulador.codtab, sno_tabulador.destab, sno_tabulador.maxpasgra, sno_tabulador.codnom, sno_nomina.desnom  ".
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "<td><a href=\"javascript: aceptar('$ls_codtab','$ls_destab','$li_maxpasgra','$ls_codnom');\">".$ls_codtab."</a></td>";
...
function aceptar(codtab,destab,maxpasgra,codnom)
{
