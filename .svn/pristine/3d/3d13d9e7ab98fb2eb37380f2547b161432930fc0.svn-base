<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,$as_nombre,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText($tm,710,11,$as_periodo); // Agregar el título
                $li_tm=$io_pdf->getTextWidth(11,$as_nombre);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,700,11,$as_nombre); // Agregar el título
	...
	function uf_print_cabecera($as_codconc,$as_nomcon,&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(50,680,501.5,$io_pdf->getFontHeight(14));
        $io_pdf->setColor(0,0,0);
		$io_pdf->addText(55,685,11,'<b>Concepto</b>  '.$as_codconc.' - '.$as_nomcon.''); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	else  // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3.95,2.5,3,3); // Configuración de los margenes en centímetros

		uf_print_encabezado_pagina($ls_titulo,$ls_rango,$ls_periodo,$ls_desnomdes,$io_pdf); // Imprimimos el encabezado de la página
