<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_comparados_forma0714.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparados_forma0714.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_scg_rpp_comparados_forma0714.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
