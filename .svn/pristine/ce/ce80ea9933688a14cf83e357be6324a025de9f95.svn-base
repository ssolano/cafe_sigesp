...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_modif_fuente_finan.php";
...
<title>Reporte de Modificaciones Presupuestarias Detallado por Fuente de Financiamiento</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.gif" width="20" height="20" border="0" title="Imprimir"></a>
	                                                  </a><a href="javascript:ue_openexcel();"></a>
...
if(array_key_exists("operacion",$_POST))
{
	...
	$ls_codunidad=$_POST["txtuniadm"];
	$ls_denunidad=$_POST["txtdenuni"];
	$ls_moneda=$_POST["txtmoneda"];
...
<table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr class="titulo-ventana" >
      <td height="22" colspan="3" align="center">Presupuesto Modificado Detallado por Fuente de Financiamiento</td>
    </tr>
    <tr >
    ...
    <tr >
      <td colspan="3" align="center"><div align="left"><strong> Reporte en</strong>           
          <input name="txtmoneda" type="text" id="txtmoneda"  style="text-align:center" value="<?php print $ls_moneda; ?>" size="10" readonly>
          <a href="javascript:catalogo_moneda();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Moneda"></a>
          <input name="txtdenmoneda" type="text" id="txtdenmoneda"  class="sin-borde" style="text-align:left" value="<?php print $ls_denmoneda; ?>" size="60" readonly>
      </div></td>
    </tr>
    <tr>
      <td colspan="3" align="center">&nbsp;</td>
    ...
    <tr>
      <td colspan="3" align="center"><table width="567" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="3"><strong>Unidad Administrativa  </strong></td>
          </tr>
          <tr>
            <td width="63" height="22"><div align="right">C&oacute;digo</div></td>
            <td width="502"><div align="left">
                <input name="txtuniadm" type="text" id="txtuniadm"  style="text-align:center" value="<?php print $ls_codunidad; ?>" size="10" readonly>
            <a href="javascript:catalogo_unidad();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Unidad Administrativa"></a>
            <input name="txtdenuni" type="text" id="txtdenuni"  class="sin-borde" style="text-align:left" value="<?php print $ls_denunidad; ?>" size="70" readonly>
            </div>		    </td>            
          </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td colspan="2" align="center"><div align="left">
	   ...
	   ?>
        <table width="275" height="119" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          <!--DWLayoutTable-->
	...
	if($li_estmodest==2)
	{
	 ?>
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td height="20"><div align="right"><input name="codestpro4" type="text" id="codestpro4" value="<?php print $ls_codestpro4 ?>" size="<?php print $ls_loncodestpro4; ?>" maxlength="<?php print $ls_loncodestpro4; ?>" style="text-align:center"></div>
          ...
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td height="18"><div align="right"><input name="codestpro5" type="text" id="codestpro5" value="<?php print $ls_codestpro5 ?>" size="<?php print $ls_loncodestpro5; ?>" maxlength="<?php print $ls_loncodestpro5; ?>" style="text-align:center"></div>
  ...
  <?php
	...
	if($li_estmodest==2)
	{
	 ?>
          <tr class="formato-blanco">
            <td height="20"><div align="right"><input name="codestpro4h" type="text" id="codestpro4h" value="<?php print  $ls_codestpro4h ?>" size="<?php print $ls_loncodestpro4; ?>" maxlength="<?php print $ls_loncodestpro4; ?>" style="text-align:center"></div></td>
          ...
          <tr class="formato-blanco">
            <td height="20"><div align="right"><input name="codestpro5h" type="text" id="codestpro5h" value="<?php print  $ls_codestpro5h ?>" size="<?php print $ls_loncodestpro5; ?>" maxlength="<?php print $ls_loncodestpro5; ?>" style="text-align:center"></div></td>
...
function ue_showouput()
{
	...
	coduniad=f.txtuniadm.value;
	denuniad=f.txtdenuni.value;
	codmoneda=f.txtmoneda.value;
	denmoneda=f.txtdenmoneda.value;
	if(li_imprimir==1)
	{
		if (coduniad!="")
		{
			...
			else
			{
				...
				{
				  pagina="reportes/sigesp_spg_rpp_modificacion_fuente_finan.php?codestpro1="+codestpro1
						 +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4
						 +"&codestpro5="+codestpro5+"&codestpro1h="+codestpro1h
						 ...
						 +"&estclades="+estclades+"&estclahas="+estclahas+"&unidad="+coduniad+"&denunidad="+denuniad
						 +"&codmoneda="+codmoneda+"&denmoneda="+denmoneda;
		...
		{
			 alert("Debe Seleccionar una Unidad Administrativa");	
		}		
	}
	else
	{
...
function catalogo_estpro3()
{
	...
	if(estmodest==1)
	{
		...
		{
			pagina="sigesp_cat_public_estpro.php?tipo=reporte"+"&estcla="+estcla+"&unidad="+codunidad;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
	}
	else
...
function catalogo_estpro5()
{
	...
	if((codestpro2=='**')||(codestpro1=='**')||(codestpro3=='**')||(codestpro4=='**'))
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!="")&&(codestpro4!=""))
		{
			...
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&estcla="+estcla+"&unidad="+codunidad;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
...
function catalogo_estprohas3()
{
	...
	if(estmodest==1)
	{
		...
		{
			pagina="sigesp_cat_public_estpro.php?tipo=rephas"+"&estcla="+estcla+"&unidad="+codunidad;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
	}
	else
...
function catalogo_estprohas5()
{
	...
	if((codestpro2=='**')||(codestpro1=='**')||(codestpro3=='**')||(codestpro4=='**'))
	{
		if((codestpro2!="")&&(codestpro1!="")&&(codestpro3!="")&&(codestpro4!=""))
		{
			...
			+"&codestpro4="+codestpro4+"&estcla="+estcla+"&unidad="+codunidad;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
...
{
	window.open("sigesp_spg_cat_uniadm.php","Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=450,left=50,top=50,location=no,resizable=yes,dependent=yes");
}
function catalogo_moneda()
{
	window.open("sigesp_spg_cat_moneda.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=320,left=50,top=50,location=no,resizable=yes,dependent=yes");
}
//--------------------------------------------------------
