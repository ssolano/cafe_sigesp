...
<input name="fila" type="hidden" id="fila" value="<?= $_GET["fila"] ?>">
...
function ue_aceptar(scg_cuenta,denominacion)
{
	fila=document.formulario.fila.value;
        /*
        cuenta='txtsccuentaact'+fila;
        opener.document.formulario.cuenta.value=scg_cuenta;
	opener.document.formulario.txtscdenominacion.value=denominacion;
        */
        obj=eval("opener.document.formulario.txtsccuentaact"+fila+"");
	obj.value=scg_cuenta;
	close();
}
