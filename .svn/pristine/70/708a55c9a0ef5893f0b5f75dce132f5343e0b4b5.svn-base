...
<html>
<head>
<title>Catálogo de Liquidaciones</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_aprob_liquidacion.js"></script>

<link href="../../../shared/css/ventanas.css" rel="stylesheet" type="text/css">
<link href="../../../shared/css/tablas.css" rel="stylesheet" type="text/css">
</head>

<body onLoad="javascript:ue_ver_liquidacion();">
<form name="form1" method="post" action="">
 <table width="500" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  <td colspan="2" class="titulo-ventana">
	  Cat&aacute;logo de Liquidaciones </td>
	</tr>
	...
	<tr>
	  ...
	  <td>        </tr>
	<tr>
	  <td width="30%"><div align="right">Nº Liquidación </div>
	  <td width="69%"><label>
	  <input name="txtnumliq" type="text" id="txtnumliq" onKeyPress="return validaCajas(this,'i',event,50);" onKeyUp="ue_ver_liquidacion(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td><div align="right">Nombre    </div>
	  <td><label>
	    <input name="txtnomper" type="text" id="txtnomper" onKeyPress="return validaCajas(this,'s',event,50);" onKeyUp="ue_ver_liquidacion(this);">
	  </label>    
	  <td>    
    </tr>
	<tr>
	  ...
	  <td><label>
	    <input name="txtapeper" type="text" id="txtapeper" onKeyPress="return validaCajas(this,'s',event,50);" onKeyUp="ue_ver_liquidacion(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td colspan="2">    
 ...
 <table id="data_grid_header" width="500" class="fondo-tabla" cellpadding="1" cellspacing="1">
  <tr class="estilo-celda">
   <td width="120" class="titulo-celda"  > Número </font></td>
