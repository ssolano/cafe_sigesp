...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
stm_aix("p4i0","p1i0",[0," Ejecucion Trimestral de Presupuesto de Ingreso  ","","",-1,-1,0,"sigesp_spi_r_ejecucion_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Consolidado de Ejecuci&oacute;n Trimestral de Ingresos y Aplicaciones Financieras ","","",-1,-1,0,"sigesp_spi_r_instructivo_consolidado_ejecucion_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
