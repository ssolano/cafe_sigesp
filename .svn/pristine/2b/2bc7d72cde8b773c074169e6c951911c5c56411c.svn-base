<?php
	...
	function uf_print_pie_cabecera($ad_totalcomprometer,$ad_totalcausado,$ad_totalpagado,&$io_pdf,$as_titulo)
	{
		...
		$la_data[]=array('cuenta'=>' ','comprobante'=>'','fecha'=>'<b>'.$as_titulo.'</b> ','comprometido'=>$ad_totalcomprometer, //olga
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			$ldt_fecha=$io_report->dts_reporte_final->data["fecha"][$z]; //OLGA
			$ldt_fecha=$io_function->uf_convertirfecmostrar($ldt_fecha); //OLGA
			...
			if (!empty($ls_cod_pro))
		    {
				  ...
				  $la_data[$z]=array('cuenta'=>$ls_spg_cuenta,'comprobante'=>$ls_proc_comp,'fecha'=>$ls_fecha,  //ldtOLGA
			...
			else
			{
				  ...
				  $la_data[$z]=array('cuenta'=>$ls_spg_cuenta,'comprobante'=>$ls_proc_comp,'fecha'=>$ls_fecha, //ldt olga
				                     'comprometido'=>$ld_comprometer,'causado'=>$ld_causado,'pagado'=>$ld_pagado);
