<?PHP
	...
	function uf_print_sello(&$io_pdf)
	{
	    ...
	    $la_data1[3]=array('name1'=>'<b>ELABORADO POR:</b>','name2'=>'ELIANA MORIN','name3'=>'RECIBIDO POR:');
	    ...
	    $la_data2[3]=array('name1'=>'<b>JEFE DE LA UNIDAD:</b>','name2'=>'LIC. ROSA YELITZA ARVELO','name3'=>'NOMBRE Y APELLIDO:');
	    ...
	    $la_data3[3]=array('name1'=>'<b>AGENTE DE RETENCION:</b>','name2'=>'CNEL (EJ) MARCO A. ROJAS T.','name3'=>'CEDULA DE IDENTIDAD:');	
