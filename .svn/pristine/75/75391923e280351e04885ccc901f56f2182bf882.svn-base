...
class sigesp_sno_c_cierre_periodo4
{
										   	   ...
										   	   $ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		{
			$ls_prog1=$this->DS->data["proy1"][$li_i];
			$ls_prog2=$this->DS->data["proy2"][$li_i];
			$ls_prog3=$this->DS->data["proy3"][$li_i];
			$ls_prog4=$this->DS->data["proy4"][$li_i];
			$ls_prog5=$this->DS->data["proy5"][$li_i];
			$ls_programatica=$ls_prog1.$ls_prog2.$ls_prog3.$ls_prog4.$ls_prog5;
										     ...
										     $as_cuentapasivo,$ai_genrecapo,$ai_tipdocapo,$ai_gennotdeb,$ai_genvou)
	{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$ls_tipnom="A"; // tipo de contabilización
		$this->DS->group_by(array('0'=>'codconc','1'=>'proy1','2'=>'proy2','3'=>'proy3','4'=>'proy4','5'=>'proy5','6'=>'cueprepatcon'),array('0'=>'total'),'total');
