  ...
  <div align="center">
    <table width="550" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr class="titulo-celda">
		...
		{
		    $ls_codestpro1  = str_pad($_GET["codestpro1"],25,"0",0);
		}
		else
		{
		   $ls_codestpro1  = "";
		...
		{
		    $ls_codestpro2  = str_pad($_GET["codestpro2"],25,"0",0);
		}
		else
		{
		   $ls_codestpro2  = "";
		...
		{
		    $ls_codestpro3  = str_pad($_GET["codestpro3"],25,"0",0);
		}
		else
		{
		   $ls_codestpro3  = "";
		...
		{
		    $ls_codestpro1h  = str_pad($_GET["codestpro1h"],25,"0",0);
		}
		else
		{
		   $ls_codestpro1h  = "";
		...
		{
		    $ls_codestpro2h  = str_pad($_GET["codestpro2h"],25,"0",0);
		}
		else
		{
		   $ls_codestpro2h  = "";
		...
		{
		    $ls_codestpro3h  = str_pad($_GET["codestpro3h"],25,"0",0);
		}
		else
		{
		   $ls_codestpro3h  = "";
		...
		if($li_estmodest==2)
		{
			...
			{
				$ls_codestpro4  = str_pad($_GET["codestpro4"],25,"0",0);
			}
			else
			{
			   $ls_codestpro4  = "";
			...
			{
				$ls_codestpro5  = str_pad($_GET["codestpro5"],25,"0",0);
			}
			else
			{
			   $ls_codestpro5  = "";
			...
			{
				$ls_codestpro4h  = str_pad($_GET["codestpro4h"],25,"0",0);
			}
			else
			{
			   $ls_codestpro4h  = "";
			...
			{
				$ls_codestpro5h  = str_pad($_GET["codestpro5h"],25,"0",0);
			}
			else
			{
			   $ls_codestpro5h  = "";
	...
	?>
      ...
      <tr>
        ...
        <td width="122" height="22"><input name="codigo" type="text" id="codigo" size="22" maxlength="20"></td>
        <td width="341" height="22">&nbsp;</td>
      </tr>
      <tr>
        <td height="22" style="text-align:right">Denominaci&oacute;n</td>
        <td height="22" colspan="2"><input name="nombre" type="text" id="nombre" size="72"></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22">&nbsp;</td>
...
if ($ls_operacion=="BUSCAR")
   {
	...
	else
	{
	  ...
	  $ls_sql = " SELECT DISTINCT trim(spg_cuenta) as spg_cuenta,max(denominacion) as denspgcta, max(status) as status
	                FROM spg_cuentas
			    ...
			    while(!$rs_data->EOF)
				     {
					   ...
					   $ls_status    = rtrim($rs_data->fields["status"]);
					   if($ls_destino == "txtcuenta")
					   {
					    if (trim($ls_status) == "C")
						{
						 echo "<tr class=celdas-azules>";
					     echo "<td style=text-align:center width=100><a href=\"javascript: aceptar_cuenta('$ls_spgcta','$ls_denspgcta');\">".$ls_spgcta."</a></td>";
						...
						else
						{
						 ...
						 echo "<td style=text-align:center width=100><a>".$ls_spgcta."</a></td>";
				         echo "<td style=text-align:left title='".$ls_denspgcta."' width=450>".$ls_denspgcta."</td>";
					     echo "</tr>";
						}
...
<script language="JavaScript">
  ...
  function aceptar_cuenta(cuenta,deno)
  {
  ...
  function ue_search()
  {
	  ...
	  if(estmodest==1)
	  {
		  ...
		  f.action="sigesp_cat_ctasrep.php?codestpro1=<?php print $ls_codestpro1;?>&codestpro2=<?php print $ls_codestpro2;?>&codestpro3=<?php print $ls_codestpro3;?>&codestpro1h=<?php print $ls_codestpro1h;?>&codestpro2h=<?php print $ls_codestpro2h;?>&codestpro3h=<?php print $ls_codestpro3h;?>&destino=<?php print $ls_destino?>&estclades=<?php print $ls_estclades?>&estclahas=<?php print $ls_estclahas?>";
		  f.submit();
	  }
	  else
	  {
		  f.operacion.value="BUSCAR";
		  f.action="sigesp_cat_ctasrep.php?codestpro1=<?php print $ls_codestpro1;?>&codestpro2=<?php print $ls_codestpro2;?>&codestpro3=<?php print $ls_codestpro3;?>&codestpro4=<?php print $ls_codestpro4;?>&codestpro5=<?php print $ls_codestpro5;?>&codestpro1h=<?php print $ls_codestpro1h;?>&codestpro2h=<?php print $ls_codestpro2h;?>&codestpro3h=<?php print $ls_codestpro3h;?>&codestpro4h=<?php print $ls_codestpro4h;?>&codestpro5h=<?php print $ls_codestpro5h;?>&destino=<?php print $ls_destino?>&estclades=<?php print $ls_estclades?>&estclahas=<?php print $ls_estclahas?>";
		  f.submit();
	  }	  
  }
