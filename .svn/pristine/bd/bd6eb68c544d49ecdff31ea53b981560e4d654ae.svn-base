   ...
   function uf_print($as_codigo, $as_denominacion, $as_tipo, $ls_codnomdes,$ls_codnomhas,$ls_codperides,$ls_codperihas)
   {
		...
		{		 
			$ls_sql="SELECT codemp,minorguniadm,ofiuniadm,uniuniadm,depuniadm,prouniadm,desuniadm,codprouniadm,estcla, ".
					...
					"		    AND spg_ep1.codestpro1=substr(sno_hunidadadmin.codprouniadm,0,26)  ".
					"           AND spg_ep1.estcla=sno_hunidadadmin.estcla) as denestpro1, ".
					"		(SELECT denestpro2 ".
					"		   FROM spg_ep2 ".
					"		  WHERE codemp=sno_hunidadadmin.codemp".
					"		    AND spg_ep2.codestpro1=substr(sno_hunidadadmin.codprouniadm,0,26) ".
					"		    AND spg_ep2.codestpro2=substr(sno_hunidadadmin.codprouniadm,26,25)".
					"           AND spg_ep2.estcla=sno_hunidadadmin.estcla) as denestpro2, ".
					"		(SELECT denestpro3 ".
					"		   FROM spg_ep3 ".
					"		  WHERE codemp=sno_hunidadadmin.codemp".
					"		    AND spg_ep3.codestpro1=substr(sno_hunidadadmin.codprouniadm,0,26) ".
					"		    AND spg_ep3.codestpro2=substr(sno_hunidadadmin.codprouniadm,26,25) ".
					"		    AND spg_ep3.codestpro3=substr(sno_hunidadadmin.codprouniadm,51,25) ".
					"           AND spg_ep3.estcla=sno_hunidadadmin.estcla) as denestpro3, ".
					"		(SELECT denestpro4 ".
					"		   FROM spg_ep4 ".
					"		  WHERE codemp=sno_hunidadadmin.codemp".
					"		    AND spg_ep4.codestpro1=substr(sno_hunidadadmin.codprouniadm,0,26) ".
					"		    AND spg_ep4.codestpro2=substr(sno_hunidadadmin.codprouniadm,26,25) ".
					"		    AND spg_ep4.codestpro3=substr(sno_hunidadadmin.codprouniadm,51,25) ".
					"		    AND spg_ep4.codestpro4=substr(sno_hunidadadmin.codprouniadm,76,25) ".
					"           AND spg_ep4.estcla=sno_hunidadadmin.estcla) as denestpro4, ".
					"		(SELECT denestpro5 ".
					"		   FROM spg_ep5 ".
					"		  WHERE codemp=sno_hunidadadmin.codemp".
					"		    AND spg_ep5.codestpro1=substr(sno_hunidadadmin.codprouniadm,0,26) ".
					"		    AND spg_ep5.codestpro2=substr(sno_hunidadadmin.codprouniadm,26,25) ".
					"		    AND spg_ep5.codestpro3=substr(sno_hunidadadmin.codprouniadm,51,25) ".
					"		    AND spg_ep5.codestpro4=substr(sno_hunidadadmin.codprouniadm,76,25) ".
					"		    AND spg_ep5.codestpro5=substr(sno_hunidadadmin.codprouniadm,101,25)".
					...
					"   GROUP BY codemp,minorguniadm,ofiuniadm,uniuniadm,depuniadm,prouniadm,desuniadm,codprouniadm,estcla ".
