...
$io_fun_seguridad->uf_load_seguridad("SSS","sigesp_sss_r_traspasos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<html>
<head>
<title>Reporte de Traspasos de Usuarios</title>
...
else
{
	...
	if ($ls_operacion=="REPORT")
	{
		...
		$ld_fechasta=$_POST["txtfechasta"];
		$ls_evento="REPORT";
		$ls_descripcion="Generó un reporte de Traspasos de Usuarios. Desde el  ". $ld_fecdesde ." hasta el ".$ld_fechasta;
...
?>	
  ...
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="438" colspan="2" class="titulo-ventana">Reporte de Traspasos de Usuarios</td>
    </tr>
  </table>
	...
	function ue_mostrar_reporte()
	{
		...
		if(li_imprimir)
		{
			...
			else
			{
			 ...
			 if (valido)
			 {
			  window.open("reportes/sigesp_sss_rpp_traspasos.php?fecdesde="+ld_fecdesde+"&fechasta="+ld_fechasta+"&bddestino="+ls_bddestino+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			 } 
			}
		}
		else
