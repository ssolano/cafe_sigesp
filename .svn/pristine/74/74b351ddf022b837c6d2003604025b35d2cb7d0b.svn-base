...
print "<td width=100 style=text-align:center>Cuenta Contable</td>";
print "</tr>";
if ($ls_operacion=="BUSCAR")
   {
	 $ls_sql     = "SELECT cod_pro,nompro,rifpro,sc_cuenta 
	                  FROM rpc_proveedor 
	      ...
	      while ($row=$io_sql->fetch_row($rs_data))
	            {
				  ...
				  print "<td width=100 style=text-align:right>".$ls_cuentac."</td>";
				  print "</tr>";			
	            }
		}
	 else
