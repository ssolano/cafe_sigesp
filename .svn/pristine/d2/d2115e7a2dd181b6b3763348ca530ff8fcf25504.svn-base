        ...
        <td height="265" colspan="6"><div align="center">
          <table width="593" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
            ...
            <tr class="formato-blanco">
              ...
              <td height="22" colspan="3"><input name="txtpgasto" type="text" id="txtpgasto" value="<?php print $ls_pgasto ?>" maxlength="30" onKeyPress="return keyRestrict(event,'x'+'-');" <?php print $ls_readonly_spg;?>  >
