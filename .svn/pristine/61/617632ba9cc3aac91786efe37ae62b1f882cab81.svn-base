<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->line(50,50,555,50);
		$io_pdf->addJpegFromFile('../../shared/imagebank/cintillo.jpg',50,720,510,45); // Agregar Logo
                //$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],50,700,150,51); // Agregar Logo
			...
			for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
			{
				...
				if($lb_valido)
				{
					...
					for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
					{
						...
						$ls_cedper=number_format($io_report->DS_detalle->data["cedper"][$li_s],0,'','.');
						...
						$li_texto=$io_pdf->addTextWrap(50,$li_pos-20,500,$li_tamletpiecont,$ls_piepagcont,'center');
						$li_pos=$li_pos-$li_tamletpiecont;
						$li_texto=$io_pdf->addTextWrap(50,$li_pos-20,500,$li_tamletpiecont,$li_texto,'center');
						$li_pos=$li_pos-$li_tamletpiecont;
						$io_pdf->addTextWrap(50,$li_pos-20,500,$li_tamletpiecont,$li_texto,'center');
