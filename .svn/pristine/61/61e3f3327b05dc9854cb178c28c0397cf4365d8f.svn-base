...
<html>
<head>
<title>Catálogo de Personal - Sueldos</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_rep_sueldos.js"></script>

<link href="../../../shared/css/ventanas.css" rel="stylesheet" type="text/css">
<link href="../../../shared/css/tablas.css" rel="stylesheet" type="text/css">
</head>

<body onLoad="javascript:ue_ver_personal_sueldos();">
<form name="form1" method="post" action="">
 <table width="500" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  <td colspan="2" class="titulo-ventana">
	  Cat&aacute;logo de Personal - Sueldos </td>
	</tr>
	...
	<tr>
	  ...
	  <td width="69%"><label>
	  <input name="txtcodper" type="text" id="txtcodper" onKeyPress="return validaCajas(this,'i',event,50);" onKeyUp="ue_ver_personal_sueldos(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td><div align="right">Nombre    </div>
	  <td><label>
	    <input name="txtnomper" type="text" id="txtnomper" onKeyPress="return validaCajas(this,'s',event,50);" onKeyUp="ue_ver_personal_sueldos(this);">
	  </label>    
	  <td>    
    </tr>
	<tr>
	  ...
	  <td><label>
	    <input name="txtapeper" type="text" id="txtapeper" onKeyPress="return validaCajas(this,'s',event,50);" onKeyUp="ue_ver_personal_sueldos(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td colspan="2">    
