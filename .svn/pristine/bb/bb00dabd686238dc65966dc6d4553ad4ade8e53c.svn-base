...
function catalogo_estpro2()
{
	...
	{
		pagina="sigesp_spi_cat_public_estpro2.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&hidestcla="+ls_estcla;
...
function catalogo_estpro3()
{
	...
	if(<?php print $li_estmodest?>==1)
	{
		...
		{
			pagina="sigesp_spi_cat_public_estpro3.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&hidestcla="+ls_estcla;
...
function catalogo_estpro4()
{
	...
	{
		pagina="sigesp_spi_cat_public_estpro4.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&hidestcla="+ls_estcla;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
...
function catalogo_estpro5()
{
	...
	{
		pagina="sigesp_spi_cat_public_estpro5.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&codestpro4="+codestpro4+"&denestpro4="+denestpro4+"&hidestcla="+ls_estcla;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
