<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$ad_fecha,&$io_pdf)
	{
		...
		//CUADRO INFERIOR OLGA
		$io_pdf->Rectangle(55,60,530,70); 
		$io_pdf->line(55,117,585,117);	//HORIZONTAL	
		//$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el título
		//$io_pdf->addText(43,63,7,"FIRMA Y SELLO"); // Agregar el título
		//$io_pdf->line(130,60,130,130);	//VERTICAL	
		$io_pdf->addText(150,122,7,"APROBADO POR"); // Agregar el título
		$io_pdf->addText(150,63,7,"ANALISTA"); // Agregar el título
		$io_pdf->line(300,60,300,130);	//VERTICAL		
		$io_pdf->addText(390,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(390,63,7,"GTE. ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->line(410,60,410,60);	//VERTICAL		
		//$io_pdf->addText(470,122,7,"PROVEEDOR"); // Agregar el título
		//$io_pdf->addText(455,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->line(55,73,585,73); //HORIZONTAL
		$io_pdf->restoreState();
		$io_pdf->closeObject();
