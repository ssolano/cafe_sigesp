  ...
  if (li_imprimir=='1') 
     {
		  if(f.rb[0].checked==true)
		  {
			...
			{
				pagina="reportes/sigesp_scb_rpp_pagos_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&tiprep="+ls_tiprep+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte;
		  ...
		  else
		  {
			...
			{
				pagina="reportes/sigesp_scb_rpp_pagos_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&probendes="+ls_probendesde+"&probenhas="+ls_probenhasta+"&tiprep="+ls_tiprep+"&tipproben="+ls_tipproben+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&nomban="+ls_nomban+"&dencta="+ls_dencta+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
			else
			{
