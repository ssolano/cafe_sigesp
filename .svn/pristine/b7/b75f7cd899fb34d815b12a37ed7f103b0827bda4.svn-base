...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_comparados_forma0705.php";
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="297" align="center"><div align="left">
          <?php 
		  }
		 if($li_estmodest==1)
		 {
    ...
    <tr>
      <td height="13" colspan="3" align="center"><table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    if(estmodest==1)
	{
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_spg_rpp_comparados_forma0705.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_spg_rpp_comparados_forma0705.php?combo="+combo+"&txtetiqueta="+txtetiqueta
			   +"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
			   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&tipoformato="+tipoformato
...
// esos no especificaban si era proyecto o programa
/*function catalogo_estpro2()
{
	f=document.form1;
	codestpro1=f.codestpro1.value;
