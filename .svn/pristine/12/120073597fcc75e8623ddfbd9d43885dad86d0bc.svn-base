...
{ 
	...
	$ls_sql="INSERT INTO sob_anticipo (codemp,codcon ,codant ,fecant,fecintant,porant,monto,conant,montotant,sc_cuenta,estant)
	         VALUES ('".$ls_codemp."','".$as_codcon."','".$as_codant."','".$af_fecant."','".$af_fecintant."','".$ad_porant."','".$ad_monto."','".$as_conant."','".$ad_montotant."','".$as_sc_cuenta."',1)";
