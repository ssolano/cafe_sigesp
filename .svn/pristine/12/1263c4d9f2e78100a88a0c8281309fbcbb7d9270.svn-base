...
function uf_limpiar_variables()
{
	...
	global $ls_chevau,$ls_conmov,$ls_disabled,$ls_docnum,$ls_nombenalt,$ld_monret,$li_estciespg,$li_estciespi;
  ...
  <table width="557" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22"><span style="text-align:left">
        <input name="txtfecmov" type="text" id="txtfecmov" value="<?php echo $ls_fecmov ?>" size="20" maxlength="10" style="text-align:center" readonly="readonly" />
      <?php
	    if ($ls_operacion=='CARGAR_DT')
		   {
	  ?>
