...
class sigesp_sep_class_report
{
	...
	function uf_select_solicitud($as_numsol)
	{
		...
		$ls_sql="SELECT sep_solicitud.codemp, sep_solicitud.numsol, sep_solicitud.codtipsol, sep_solicitud.coduniadm,".
				...
				"       sep_solicitud.monbasinm, sep_solicitud.montotcar, sep_solicitud.tipo_destino, sep_solicitud.cod_pro,".
				"       sep_solicitud.ced_bene,spg_unidadadministrativa.denuniadm, sep_solicitud.nombenalt, ".
				"       (SELECT dentipsol".
	...
	function uf_select_dt_spgcuentas($as_numsol)
	{
		...
		$ls_sql="SELECT substr(codestpro1,'".$li_longestpro1."','".$this->ls_loncodestpro1."') as codestpro1,substr(codestpro2,'".$li_longestpro2."','".$this->ls_loncodestpro2."') as codestpro2, ".
		        "       substr(codestpro3,'".$li_longestpro3."','".$this->ls_loncodestpro3."') as codestpro3, substr(codestpro4,'".$li_longestpro4."','".$this->ls_loncodestpro4."') as codestpro4, substr(codestpro5,'".$li_longestpro5."','".$this->ls_loncodestpro5."') as codestpro5, spg_cuenta, monto,estcla".
