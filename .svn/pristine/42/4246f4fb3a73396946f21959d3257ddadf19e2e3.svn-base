...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_load_data(&$as_parametros)
   {
		...
		//	  Description: Funci�n que carga todas las variables necesarias en la p�gina
		//	   Creado Por: Ing. N�stor Falc�n.
		// Fecha Creaci�n: 27/05/2007								Fecha �ltima Modificaci�n : 27/05/2007
		//////////////////////////////////////////////////////////////////////////////
...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22"><label>
          <!--input name="txtfecregcot" type="text" class="sin-borde" id="txtfecregcot" value="print $ls_fecregcot" size="15" maxlength="12" readonly /-->
		  <input name="txtfecregcot" type="text" id="txtfecregcot" value="<?php print $ls_fecregcot ?>" size="15" maxlength="12" />
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="22" colspan="5"><label>
          <input name="txtobscot" type="text" id="txtobscot" value="<?php print $ls_obscot ?>" size="114" maxlength="254" style="text-align:left" tabindex="3" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz����� '+'�!:;_�#@/?�%&$*-,.+(){}[]='); " <?php echo $ls_disabled; ?> />
        </label></td>
      </tr>
      <tr>
        <td height="22" style="text-align:right">Forma de Pago</td>
        <td height="22"><label>
          <select name="cmbformapago" id="cmbformapago" tabindex="4" <?php echo $ls_disabled; ?>>
	...
	if (((lb_existe=="TRUE")&&(li_cambiar==1))||(lb_existe=="FALSE")&&(li_incluir==1))
	   {
		 ...
		 if (ls_estcot=="1")
		    {
			  lb_valido = false;
			  alert("La Cotizaci�n ya ha sido procesada, No puede ser modificada !!!.");
		    }
	     else
		    {
			  ...
			  if (ls_tipcot!='-')
			     {
				   ...
				   if (lb_valido)
					  {
						lb_valido = ue_validarcampo(ls_numcot,"El N�mero de Cotizaci�n no puede estar vacio.",f.txtnumcot);
					  }
				   if (lb_valido)
					  {
						lb_valido = ue_validarcampo(ls_obscot,"La Observaci�n de la Cotizaci�n no puede estar vacia.",f.txtobscot);
					  }
				   if (lb_valido)
					  {
				   ...
				   if (lb_valido)
				      {
					    lb_enciva = false;
						ld_poriva = 0;
						if (ls_tipcot=='B')//Cotizaci�n de Tipo Bienes.
						   {
										...
										if (ld_totart<=0)
									       {
										     ...
										     //lb_valido = false;
										     alert("El Total del Bien/Material "+ls_codart+" - "+ls_denart+" se guardara con valor Cero.")
									       }
								      }
							    }
							 else
							    {
								  alert("La Cotizaci�n debe tener al menos un Bien/Material incorporado !!!");
								  lb_valido = false;
							    }
						   }
					     else
										...
										if (ld_totser<=0)
									       {
										     ...
										     //lb_valido = false;
										     alert("El Total del Servicio "+ls_codser+" - "+ls_denser+" se guardara con valor Cero.");
								 	       }
								      }
							    }
							 else
							    {
								  alert("La Cotizaci�n debe tener al menos un Servicio incorporado !!!");
								  lb_valido = false;
							    }
						   } 
					  } 
			     ...
			     {
	               alert("Debe seleccionar el Tipo de Cotizaci�n a Registrar !!!");
				 }
			}
	   }
    else
		 ...
		 if (ls_tipcot=="S")
		    {
			  ...
			  if (ls_codser!="")
			     {
				   if ((ld_canser>0)||(ld_preser>0))				   //Si la cantidad de art�culos � el precio es mayor que cero calculamos
				      {
					    if (li_incorpora=='1')
					       { 
					         if ((ld_porcre>0) && (ls_tipconpro=='O' || ls_tipconpro=='E'))
...
function ue_reload()
{
	...
	ls_tipcot  = f.cmbtipcot.value;// Para saber si es de bienes, servicios � conceptos
	if(ls_tipcot=="B")
	{
		 ...
		 if (lb_existe=="TRUE")
		    {
			  ...
			  if (ls_tipcot!='-')
			     ...
			     {
			       alert("Debe seleccionar un Tipo de Cotizaci�n v�lida (Bienes/Servicios) !!!");
			     }
		    }
		 else
		    { 
