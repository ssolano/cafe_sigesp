...
function uf_select_contrato ($as_codcontrato,&$aa_data)
	...
	{ 
		...
		if($as_lapgarcon=="")
			$as_lapgarcon=0;			
		$this->io_keygen->uf_verificar_numero_generado("SOB","sob_contrato","codcon","SOBCON",6,"","","",&$as_codcon);
		$ls_sql="INSERT INTO sob_contrato ( codemp, codcon ,codasi,monto, feccon,fecinicon, placon,placonuni, mulcon, tiemulcon, mulreuni,lapgarcon, lapgaruni,  codtco,monmaxcon, pormaxcon,  obscon,  porejefiscon, porejefincon, monejefincon,estcon,fecfincon,precon)
		         VALUES ('".$ls_codemp."','".$as_codcon."','".$as_codasi."','".$ad_monto."','".$af_feccon."','".$af_fecinicon."','".$ad_placon."','".$as_placonuni."','".$ad_mulcon."','".$ad_tiemulcon."','".$as_mulconuni."','".$as_lapgarcon."','".$as_lapgaruni."','".$as_codtco."','".$ad_monmaxcon."','".$ad_pormaxcon."','".$as_obscon."',0,0,0,1,'".$ad_fecfincon."','".$ls_precon."')";
	...
	function uf_update_contrato($as_codcon ,$as_codasi,$ad_monto,$af_feccon, $af_fecinicon,$ad_placon, $as_placonuni,$ad_mulcon,$ad_tiemulcon,$as_mulconuni, $as_lapgarcon,$as_lapgaruni,$as_codtco ,$ad_monmaxcon,$ad_pormaxcon,$as_estcon,$as_obscon,$ad_fecfincon,$ls_precon,$aa_seguridad)
	{
		//////////////////////////////////////////////////////////////////////////////
