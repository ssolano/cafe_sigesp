<?php
//==========================================================================================
// ezpdf_plus: Modificada y adaptada por EDGAR ALEXANDER QUINTERO URBANEJA 2008-2009
//==========================================================================================
/**
* Cpdf
*
...
function PRVTadjustWrapText($text,$actual,$width,&$x,&$adjust,$justification){
   ...
   switch ($justification){
    ...
    case 'full':
	  ...
	  $text=str_replace($vocales_acento,$vocales,$text); //Sustituye las vocales con acento y la ñ
	  $text=str_replace($otras_letras,$vocales,$text);
	  for ($i=0;$i<$nb;$i++){ 		
								//Get next character
								$c=$text[$i]; //$s es la variable que almacena el texto
																
								if($c==' ') //Si encuentra un separador incrementa el contador
								{
									$sep=$i;
									$ls+=$this->getCaracterWidth($c);
									$ns++; //número de separador
								}
								
								
								$l+=$this->getCaracterWidth($c); //Es el ancho total del texto
