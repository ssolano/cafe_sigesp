	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   ...
						 			   'unidad'=>array('justification'=>'center','width'=>135), // Justificación y ancho de la columna
						 			   'cosuni'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
						 			   ...
						 			   'montot'=>array('justification'=>'right','width'=>40))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
