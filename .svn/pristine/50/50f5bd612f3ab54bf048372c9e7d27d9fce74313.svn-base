...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_imprimir()
	{
			...
			if(li_imprimir==1)
			{
				...
				{
					pantalla="reportes/sigesp_cxp_rpp_solicitudes.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&tiporeporte="+tiporeporte+"";
