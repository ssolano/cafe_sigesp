...
//     de la tabla, es decir añadir color, justificación, etc, para el encabezado y otro para 
//     la tabla.
// 2.- Las lineas de las tablas tienen ahora 6 atributos distintos. Se le pueden 
