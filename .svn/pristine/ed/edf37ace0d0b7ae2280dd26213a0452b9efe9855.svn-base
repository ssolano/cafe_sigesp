...
elseif($ls_operacion=="ue_removercuenta")
{
	...
	for($li_i=1;$li_i<=$li_filascuentas;$li_i++)
	{
		...
		{		
		    ...
		    $ls_estcla     = $_POST["txtestcla".$li_temp];
		    ...
		    $la_objectcuentas[$li_temp][5]="<a href=javascript:ue_removercuenta(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.gif alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}
	}
	$la_objectcuentas[$li_filascuentas][1]="<input name=txtcodcue".$li_filascuentas." type=text id=txtcodcue".$li_filascuentas." class=sin-borde style= text-align:center size=40 readonly><input name=codest1".$li_filascuentas." type=hidden id=codest1".$li_filascuentas."><input name=codest2".$li_filascuentas." type=hidden id=codest2".$li_filascuentas."><input name=codest3".$li_filascuentas." type=hidden id=codest3".$li_filascuentas."><input name=codest4".$li_filascuentas." type=hidden id=codest4".$li_filascuentas."><input name=codest5".$li_filascuentas." type=hidden id=codest5".$li_filascuentas.">";
	$la_objectcuentas[$li_filascuentas][2]="<input name=txtestcla".$li_filascuentas." type=text id=txtestcla".$li_filascuentas." class=sin-borde style= text-align:center size=20 readonly>";
...
{   
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
	    ...
	    $la_objectpartidas[$li_i][8]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." class=sin-borde size=5 style= text-align:center value='".$io_funcsob->uf_convertir_numerocadena($ls_cantpar)."' onKeyPress=return(currencyFormat(this,'.',',',event)) $ls_readonly>";
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
       ...
       <tr class="formato-blanco">
        ...
        <input name="txtnomproasi" type="text" id="txtnomproasi"  style="text-align:left" class="sin-borde" value="<?php print $ls_nomproasi ?>" size="70" maxlength="100" readonly="true">        </td></tr>
      <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
      ...
      <tr class="formato-blanco">
        ...
        <td><input name="txtmonparasi" type="text" id="txtmonparasi"  style="text-align: right" value="<?php print $ls_monparasi ?>" size="20" maxlength="20" readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="23">&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td><input name="txtbasimpasi" type="text" id="txtbasimpasi"  style="text-align: right" value="<?php print $ls_basimpasi ?>" size="20" maxlength="20" onKeyPress="return(currencyFormat(this,'.',',',event))" onBlur="uf_validarbasimp();"></td>
      </tr>
      <tr class="formato-blanco">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td><input name="txtmontotasi" type="text" id="txtmontotasi"  style="text-align: right" value="<?php print $ls_montotasi ?>" size="20" maxlength="20"  readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="9"><div align="center">
