...
<html>
<head>
<title>Definici&oacute;n de Causas de Retiro</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_def_causaretiro.js"></script>
</head>
          ...
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr >
              ...
              <td colspan="2" class="titulo-ventana">
			    Definición de Causas de Retiro			  </td>
            </tr>
            <tr>
              <td></td>
              <td >&nbsp;</td>
            ...
            <tr>
              ...
              <td width="334" ><input name="txtcodcauret" type="text" id="txtcodcauret" style="text-align:center" value="" size="4" maxlength="2">
                <label></label></td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              ...
              <td>
			    <input name="txtdencauret" id="txtdencauret" value="" type="text" size="45" onKeyPress="return validaCajas(this,'s',event,45);" onKeyUp="changeCase(this)">			  </td>
            </tr>
            <tr>
              <td></td>
              <td height="16">&nbsp;</td>
