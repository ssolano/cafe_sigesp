...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_load_variables()
   {
		...
		global $ls_codcarper,$ld_fecregsolcot,$ls_chkact,$ls_distipmat,$ls_distipact,$li_estciespg,$li_estciespi;
...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <!--input name="txtfecregsolcot" type="text" class="sin-borde" id="txtfecregsolcot" value="echo $ld_fecregsolcot" size="15" maxlength="10" style="text-align:left" readonly /-->
		<input name="txtfecregsolcot" type="text" id="txtfecregsolcot" value="<?php echo $ld_fecregsolcot ?>" size="15" maxlength="10" style="text-align:left" /></td>
		</td>
      </tr>
      <tr>
