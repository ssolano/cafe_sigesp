				...
				<tr class="formato-blanco">
				  ...
				  <td height="79" colspan="8" align="center" valign="top" class="sin-borde">				  <table width="500" height="111" border="0" cellpadding="0"  cellspacing="0" >
                    <tr class="letras-pequeñas">
                      ...
                      <td width="218"><input name="txtplacon"  style="text-align:center "  type="text" id="txtfecasi" value="<?php print $ls_placon?>" size="11" maxlength="11" readonly="true">
&nbsp;&nbsp;&nbsp;
                      </td>
                    </tr>
                    <tr class="letras-pequeñas">
      ...
      <tr class="formato-blanco">
        ...
        <td width="88" height="39"><input name="txtfecact" type="text" id="txtfecact"  style="text-align:center" value="<?php print $ls_fecact ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
        ...
        <td height="26"><input name="txtfecfinact"   type="text" id="txtfecfinact2"  style="text-align:left" value="<?php print $ls_fecfinact ?>" size="11" maxlength="10"   readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="6"><input name="txtnominsact" type="text"  style="text-align: left" id="txtnominsact" readonly="true" size="50" value="<?php print $ls_nominsact?>" maxlength="50">
&nbsp;&nbsp;&nbsp;&nbsp;C.I.
...
&nbsp; C.I.V.
    ...
    <a href="javascript:ue_catinspectores();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"  ></a>
...
function ue_nuevo()
{
  ...
  else
  {
	  ...
	  f.action="sigesp_sob_d_actafinalizacion.php";
	  f.submit();  
  }	
}
function ue_buscar()
