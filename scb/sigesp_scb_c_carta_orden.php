...
function  uf_cargar_programaciones($as_proben,$as_codigo,$as_codban,$as_ctaban,$object,$li_rows,$ai_tipvia,$as_numordpagmin,$as_codtipfon)
{
		...
		$ls_sql = "SELECT cxp_solicitudes.numsol, cxp_solicitudes.cod_pro, cxp_solicitudes.ced_bene, $ls_straux
					      ...
					      scb_ctabanco.codtipcta, scb_ctabanco.sc_cuenta, scb_tipocuenta.nomtipcta, cxp_dt_solicitudes.numrecdoc,
				     ...
				     FROM cxp_solicitudes, scb_prog_pago, scb_banco, scb_ctabanco, scb_tipocuenta, cxp_dt_solicitudes $ls_tabla					 
				    WHERE cxp_solicitudes.codemp='".$ls_codemp."'
				      ...
				      AND cxp_solicitudes.numsol=cxp_dt_solicitudes.numsol $ls_sqlaux";
