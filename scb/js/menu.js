...
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
stm_aix("p1i4","p1i0",[0,"Pago a Caficultores ","","",-1,-1,0,"sigesp_scb_p_pago_caficultores.php","_self"]);
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
...
stm_ep();
stm_aix("p4i0","p1i0",[0," Declaracion de Salarios y Otras Remuneraciones    ","","",-1,-1,0,"sigesp_scb_r_declaracionxml.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
