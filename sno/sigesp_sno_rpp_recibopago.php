<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
        */
        //--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_desnom,$as_fecingper,&$io_cabecera,&$io_pdf,$as_desubifis="")
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera1
		//		   Access: private
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->addText(40,684,'10','______________________________________________________________________________________________');
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100),'fecha'=>$as_fecingper));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
						 'fontSize' => 7, // Tamaño de Letras
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_desnom,$as_fecingper,&$io_cabecera,&$io_pdf,$as_desubifis)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_cabecera
		//		   Access: private
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$ls_desnom,$ls_fecingper,&$io_cabecera,&$io_pdf,$ls_desubifis); // Imprimimos la cabecera del registro
			}
			else
			{

                                uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$ls_desnom,$ls_fecingper,&$io_cabecera,&$io_pdf,$ls_desubifis); // Imprimimos la cabecera del registro
			}
