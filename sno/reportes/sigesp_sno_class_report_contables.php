...
class sigesp_sno_class_report_contables
{
	...
	function uf_contableaportes_presupuesto_proyecto_dt()
	{
		...
		else
		{
				...
				if(($ls_codper!=$ls_codant)||(($ls_spgcuenta!=$ls_cuentaant)&&($ls_codconc!=$ls_conceptoant)))
				{
					if($li_acumulado!=0)
					{
						...
						{							
							$ls_conta++;
							$li_montoparcial=round($row["montoparcial"],3);
							//print "MONTOS.....   ".$li_montoparcial."<br>";
			...
			//print "REGISTROS.....   ".$ls_conta."<br>";
			//print "REGISTROS 2.....   ".$ls_conta2."<br>";
			/*if((number_format($li_acumulado,3,".","")!=number_format($li_totalant,3,".",""))&&($li_pordiames<1))
			{
				print "TOTALANT.....   ".$li_totalant."<br>";
				print "ACUMULADO.....   ".$li_acumulado."<br>";
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ls_sql="SELECT denominacion ".
						...
						"   AND status = 'C'".
						"   AND estcla = '".$ls_estcla."'".
						"   AND codestpro1 = '".substr($ls_programatica,1,25)."'".
						"   AND codestpro2 = '".substr($ls_programatica,26,25)."'".
						"   AND codestpro3 = '".substr($ls_programatica,51,25)."'".
						"   AND codestpro4 = '".substr($ls_programatica,76,25)."'".
