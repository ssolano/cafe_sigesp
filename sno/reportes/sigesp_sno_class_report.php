...
class sigesp_sno_class_report
{
										...
										$as_codpai,$as_codest,$as_codmun,$as_codpar,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personalnomina.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper,sno_personal.sexper, sno_tipopersonal.destipper, ".
				"		sno_personal.fecingper, sno_personalnomina.fecculcontr, sno_personalnomina.fecingper as fecingnom, ".
				...
				"          sno_personal.fecegrper, sno_personal.fecsitu, sno_personal.fecnacper, ".
                                "          sno_personal.sexper, sno_tipopersonal.destipper".
				"   ".$ls_union.
				"   ".$ls_orden;  
		$this->rs_data=$this->io_sql->select($ls_sql);
	...
	function uf_listadobanco_personal($as_codban,$as_suspendidos,$as_tipcueban,$as_quincena,$as_subnomdes,$as_subnomhas,$as_codperdes,$as_codperhas,$as_orden,$as_codubifis=null)
	{
		...
		switch($as_orden)
		{
		 ...
		 if ($as_codubifis !== NULL){
                    $where_codubifis = " AND sno_personalnomina.codubifis = '$as_codubifis' "; //para reporte por ubicacion fisica
                }else{
                    $where_codubifis = " ";
                }
		
		$ls_sql="SELECT sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, ".$ls_monto.", sno_personalnomina.codcueban, sno_personal.codran, sno_ubicacionfisica.desubifis, sno_ubicacionfisica.codubifis, ".
				 "		 (SELECT sno_rango.desran FROM sno_rango ".
				 "        WHERE sno_rango.codemp='".$this->ls_codemp."'".
				 "          AND sno_rango.codcom=sno_personal.codcom".
				...
				"   AND sno_personal.codemp = sno_personalnomina.codemp ".
				"	AND sno_personal.codper = sno_personalnomina.codper ".
				"   AND sno_personalnomina.codubifis =  sno_ubicacionfisica.codubifis " . $where_codubifis.
				$ls_orden;
		$this->rs_data_detalle=$this->io_sql->select($ls_sql);
		if($this->rs_data_detalle===false)
		{
									...
									$as_codubifis,$as_codpai,$as_codest,$as_codmun,$as_codpar,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.nacper,".
				...
				"         sno_personalnomina.fecingper,sno_personal.codorg,sueobr,tiponom,sno_personalnomina.obsrecper, sno_personalnomina.codded, sno_tipopersonal.codded ".
				"   ".$ls_orden;
                //echo $ls_sql; exit();
		$this->rs_data=$this->io_sql->select($ls_sql);
		if($this->rs_data===false)
	...
	function uf_recibopago_conceptopersonal($as_codper,$as_conceptocero,$as_conceptop2,$as_conceptoreporte,$as_tituloconcepto,$as_quincena)
	{
		...
		$ls_sql="SELECT sno_concepto.codconc, ".$ls_campo." as nomcon, ".$ls_campomonto.", sno_salida.tipsal, abs(sno_conceptopersonal.acuemp) AS acuemp, ".
				...
				"			AND sno_constantepersonal.codcons = sno_concepto.consunicon ) AS unidad ".
                                ",(SELECT unicon FROM sno_constante WHERE sno_concepto.consunicon = sno_constante.codcons AND sno_constante.codemp = '".$this->ls_codemp."' AND sno_constante.codnom = '".$this->ls_codnom."' ) as denunidad". //CAMB //PARA LAS UNIDADES DE LOS CONCEPTOS HORAS EXTRAS
