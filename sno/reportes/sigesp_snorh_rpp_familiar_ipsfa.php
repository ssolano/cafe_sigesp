   ...
   function uf_print_cabecera_unidad($as_denominacion, $as_cod1, $as_cod2, $as_cod3, $as_cod4, $as_cod5, &$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center',
						 'cols'=>array('denominacion'=>array('justification'=>'left','width'=>500))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);	
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(3,2.1,3,3); // Configuración de los margenes en centímetros
