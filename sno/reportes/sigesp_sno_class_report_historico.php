...
class sigesp_sno_class_report_historico
{
										...
										$as_codpai,$as_codest,$as_codmun,$as_codpar,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		if(($li_vac_reportar==1)&&($ls_vac_codconvac!=""))
		{
			$ls_union="UNION ".
					  ...
					  "		MAX(sno_thpersonalnomina.obsrecper) As obsrecper, ".
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.fecingper,sno_personal.sexper, sno_tipopersonal.destipper,	 ".
				"		sno_thpersonalnomina.codcueban, sno_thunidadadmin.desuniadm, sno_thunidadadmin.codprouniadm, MAX(sno_thpersonalnomina.sueper) AS sueper, ".
			    "		sno_thunidadadmin.minorguniadm, sno_thunidadadmin.ofiuniadm, sno_thunidadadmin.uniuniadm, sno_thunidadadmin.depuniadm, sno_thunidadadmin.prouniadm, ".
				"		MAX(sno_thpersonalnomina.codgra) AS codgra, MAX(sno_personal.nacper) AS nacper, MAX(sno_ubicacionfisica.desubifis) AS desubifis, MAX(sno_thpersonalnomina.descasicar) AS descasicar, ".
			    "		MAX(sno_thpersonalnomina.obsrecper) As obsrecper, ".
			    ...
			    "			 AND sno_thresumen.codperi = sno_thsalida.codperi) AS totalaporte, ".
				"  ".$ls_descar.
				"  FROM sno_personal, sno_thpersonalnomina, sno_thsalida, sno_thunidadadmin, sno_ubicacionfisica, sno_tipopersonal ".
				" WHERE sno_thpersonalnomina.codemp='".$this->ls_codemp."' ".
				"   AND sno_thpersonalnomina.codnom='".$this->ls_codnom."' ".
				"   AND sno_thpersonalnomina.anocur='".$this->ls_anocurnom."' ".
				"   AND sno_thpersonalnomina.codperi='".$this->ls_peractnom."' ".
			    ...
			    "   AND sno_ubicacionfisica.codemp = sno_thpersonalnomina.codemp ".
				"   AND sno_ubicacionfisica.codubifis = sno_thpersonalnomina.codubifis ".
                                "   AND sno_tipopersonal.codtipper=sno_thpersonalnomina.codtipper  ".
				"   AND sno_tipopersonal.codded = sno_thpersonalnomina.codded ". //RESOLVER PROBLEMA DE TRIPLICAR PERSONAL EN REPORTES PAGONOMINA HISTORICO //CAMB
				" GROUP BY sno_thpersonalnomina.codemp, sno_thsalida.codemp, sno_thpersonalnomina.codnom, sno_thsalida.codnom,  sno_thpersonalnomina.anocur, sno_thsalida.anocur, sno_thpersonalnomina.codperi, sno_thsalida.codperi,".
				"		   sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, ".
				"		   sno_personal.fecingper, sno_thpersonalnomina.codcar, sno_thpersonalnomina.codasicar, ".
				"		   sno_thpersonalnomina.codcueban, sno_thunidadadmin.desuniadm, sno_thunidadadmin.codprouniadm, ".
				"          sno_thunidadadmin.minorguniadm, sno_thunidadadmin.ofiuniadm, sno_thunidadadmin.uniuniadm, ".
				"    	   sno_thunidadadmin.depuniadm, sno_thunidadadmin.prouniadm, sno_ubicacionfisica.codpai, ".
			    "        sno_ubicacionfisica.codest,sno_ubicacionfisica.codmun,sno_ubicacionfisica.codpar,sno_personal.sexper, sno_tipopersonal.destipper       ".
				"   ".$ls_union.
				"   ".$ls_orden;
		$this->rs_data=$this->io_sql->select($ls_sql);
	...
	function uf_recibopago_conceptopersonal($as_codper,$as_conceptocero,$as_conceptop2,$as_conceptoreporte,$as_tituloconcepto,$as_quincena)
	{
		...
		$ls_sql="SELECT sno_thconcepto.codconc, ".$ls_campo." as nomcon, ".$ls_campomonto.", sno_thsalida.tipsal, abs(sno_thconceptopersonal.acuemp) AS acuemp, ".
				...
				"			AND sno_thconstantepersonal.codcons = sno_thconcepto.consunicon ) AS unidad ".
                                ", (SELECT unicon FROM sno_thconstante WHERE sno_thconcepto.consunicon = sno_thconstante.codcons AND sno_thconstante.codemp = '".$this->ls_codemp."' AND sno_thconstante.codnom = '".$this->ls_codnom."' AND sno_thconstante.codperi = '".$this->ls_peractnom."' AND sno_thconstante.anocur = '".$this->ls_anocurnom."'  ) as denunidad ". //CAMB //UNIDAD RECIBO PAGO HORAS EXTRAS HISTORICO
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_listadobanco_personal($as_codban,$as_suspendidos,$as_tipcueban,$as_quincena,$as_subnomdes,$as_subnomhas,$as_codperdes,$as_codperhas,$as_orden, $as_codubifis=null)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		switch($as_orden)
		{
			...
			case "5": // Ordena por Rango del Personal
                ...
                if ($as_codubifis !== NULL){
                    $where_codubifis = " AND sno_thpersonalnomina.codubifis = '$as_codubifis' "; //para reporte por ubicacion fisica
                }else{
                    $where_codubifis = " ";
                }
                
		$ls_sql="SELECT sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, ".$ls_monto.", sno_thpersonalnomina.codcueban, sno_personal.codran, sno_ubicacionfisica.desubifis, sno_ubicacionfisica.codubifis, ".
				 "		 (SELECT sno_rango.desran FROM sno_rango ".
				 "        WHERE sno_rango.codemp='".$this->ls_codemp."'".
				 "          AND sno_rango.codcom=sno_personal.codcom".
				 "          AND sno_rango.codran=sno_personal.codran) AS denran ".
				"  FROM sno_personal, sno_thpersonalnomina, sno_thresumen, sno_ubicacionfisica  ".
				" WHERE sno_thpersonalnomina.codemp='".$this->ls_codemp."' ".
				"   AND sno_thpersonalnomina.codnom='".$this->ls_codnom."' ".
				"   AND sno_thpersonalnomina.anocur='".$this->ls_anocurnom."' ".
				"   AND sno_thpersonalnomina.codperi='".$this->ls_peractnom."' ".
				...
				"   AND sno_thpersonalnomina.codperi = sno_thresumen.codperi ".
				"   AND sno_thpersonalnomina.codper = sno_thresumen.codper ". 
                                "   AND sno_thpersonalnomina.codubifis =  sno_ubicacionfisica.codubifis " . $where_codubifis.
				$ls_orden;
		$this->rs_data_detalle=$this->io_sql->select($ls_sql);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
        ...
        function uf_ubicaciones_fisicas($as_codban,$as_suspendidos,$as_tipcueban,$as_quincena,$as_subnomdes,$as_subnomhas,$as_codperdes,$as_codperhas,$as_orden, $as_codubifis=null)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_listadobanco_personal
		//		   Access: public (desde la clase sigesp_sno_rpp_listadobanco)  
		...
		$ls_sql="SELECT  sno_ubicacionfisica.desubifis, sno_ubicacionfisica.codubifis ".
				"  FROM sno_personal, sno_thpersonalnomina, sno_thresumen, sno_ubicacionfisica  ".
				" WHERE sno_thpersonalnomina.codemp='".$this->ls_codemp."' ".
				"   AND sno_thpersonalnomina.codnom='".$this->ls_codnom."' ".
				"   AND sno_thpersonalnomina.anocur='".$this->ls_anocurnom."' ".
				...
				"   AND sno_thpersonalnomina.codper = sno_thresumen.codper ". 
                                "   AND sno_thpersonalnomina.codubifis =  sno_ubicacionfisica.codubifis" . $where_codubifis.
                                " GROUP BY sno_ubicacionfisica.desubifis, sno_ubicacionfisica.codubifis ORDER BY sno_ubicacionfisica.desubifis ASC" ;
				
		$this->rs_data_ubicaciones=$this->io_sql->select($ls_sql);
                //echo $ls_sql . "<br/>"; die(); //CAMB //DEBUG
		if($this->rs_data_ubicaciones===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_ubicaciones_fisicas ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $lb_valido;
	}// end function uf_ubicaciones_fisicas
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_listadobancotaquilla_personal($as_codban,$as_suspendidos,$as_quincena,$as_subnomdes,$as_subnomhas,$as_codperdes,$as_codperhas,$as_orden, $as_codubifis=null)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_relacionvacacion_personal($as_codper,$as_codvac,$as_conceptocero,&$rs_data)
	{
		...
		$ls_sql="SELECT sno_thpersonalnomina.codemp, sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.fecingper, ".
				...
				"  AND sno_thpersonalnomina.codnom = sno_thunidadadmin.codnom ".
				"  AND sno_thpersonalnomina.codnom = sno_thvacacpersonal.codnom ".
				"  AND sno_thpersonalnomina.codnom = sno_thsalida.codnom ".
				"  AND sno_thpersonalnomina.anocur = sno_thunidadadmin.anocur ".
				...
				"  sno_thvacacpersonal.diapervac,sno_thvacacpersonal.diaadivac,sno_thpersonalnomina.codnom,sno_thpersonalnomina.codcar ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
