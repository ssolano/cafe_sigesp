...
class sigesp_sno_class_report_historico_contables
{
	...
	function uf_contableaportes_presupuesto_proyecto()
	{
		...
		$lb_valido=true;
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que se integran directamente con presupuesto
		$ls_sql="SELECT sno_thconcepto.codpro as programatica, sno_thconcepto.estcla, spg_cuentas.spg_cuenta AS cueprepatcon, MAX(spg_cuentas.denominacion) AS denominacion, ".
				"		SUM(sno_thsalida.valsal) as total, ".
				"       SUBSTR(sno_thconcepto.codpro,1,25) AS proy1, ".
       			"		SUBSTR(sno_thconcepto.codpro,26,25) AS proy2, ".
				"		SUBSTR(sno_thconcepto.codpro,51,25) AS proy3, ".
				"		SUBSTR(sno_thconcepto.codpro,76,25) AS proy4, ".
				"		SUBSTR(sno_thconcepto.codpro,101,25) AS proy5 ".
				"  FROM sno_thpersonalnomina, sno_thunidadadmin, sno_thsalida, sno_thconcepto, spg_cuentas ".
				" WHERE sno_thsalida.codemp='".$this->ls_codemp."' ".
				"   AND sno_thsalida.codnom='".$this->ls_codnom."' ".
				"   AND sno_thsalida.anocur='".$this->ls_anocurnom."' ".
		...
		// entonces las buscamos según la estructura de la unidad administrativa a la que pertenece el personal
		$ls_sql=$ls_sql." UNION ".
				"SELECT sno_thunidadadmin.codprouniadm as programatica, sno_thunidadadmin.estcla, spg_cuentas.spg_cuenta AS cueprepatcon, MAX(spg_cuentas.denominacion) AS denominacion, ".
				"		SUM(sno_thsalida.valsal) as total, ".
				"		SUBSTR(sno_thunidadadmin.codprouniadm,1,25) AS proy1, ".
       			"		SUBSTR(sno_thunidadadmin.codprouniadm,26,25) AS proy2, ".
       			"		SUBSTR(sno_thunidadadmin.codprouniadm,51,25) AS proy3, ".
       			"		SUBSTR(sno_thunidadadmin.codprouniadm,76,25) AS proy4, ".
       			"		SUBSTR(sno_thunidadadmin.codprouniadm,101,25) AS proy5 ".
				"  FROM sno_thpersonalnomina, sno_thunidadadmin, sno_thsalida, sno_thconcepto, spg_cuentas ".
				" WHERE sno_thsalida.codemp='".$this->ls_codemp."' ".
				"   AND sno_thsalida.codnom='".$this->ls_codnom."' ".
				"   AND sno_thsalida.anocur='".$this->ls_anocurnom."' ".
	...
	function uf_contableaportes_presupuesto_proyecto_dt()
	{
		...
		// Buscamos todas aquellas cuentas presupuestarias de los conceptos que se integran directamente con presupuesto
		$ls_sql="SELECT MAX(sno_thproyecto.estproproy) AS estproproy, sno_thproyecto.estcla, spg_cuentas.spg_cuenta, ".
				...
				"		MAX(SUBSTR(sno_thproyecto.estproproy,1,25)) AS proy1, ".
          		"		MAX(SUBSTR(sno_thproyecto.estproproy,26,25)) AS proy2, ".
          		"		MAX(SUBSTR(sno_thproyecto.estproproy,51,25)) AS proy3, ".
          		"		MAX(SUBSTR(sno_thproyecto.estproproy,76,25)) AS proy4, ".
          		"		MAX(SUBSTR(sno_thproyecto.estproproy,101,25)) AS proy5 ".
