            ...
            <tr>
              ...
              <td><div align="left">
                  <select name="cmbmet" id="cmbmet">
                    ...
                    <option value="1" <?php print $la_cmbmet[0];?>>Accord Ticket Multivalor</option>
					...
					<option value="14" <?php print $la_cmbmet[13];?>>Banco de Venezuela Alimentaci&oacute;n</option>
                  </select>
              </div></td>
            </tr>
            <tr>
             ...
             <tr>
              ...
              <td><label>
                <input name="txtcodcli" type="text" id="txtcodcli" size="20" maxlength="15" value="<?php print $ls_codcli;?>">
              </label></td>
            </tr>
             <tr>
              <td height="22"><div align="right">Punto de Entrega </div></td>
              <td><label>
                <input name="txtpunent" type="text" id="txtpunent" size="20" maxlength="15" value="<?php print $ls_punent;?>">
              </label></td>
            </tr>
            <tr>
              <td height="22">&nbsp;</td>
