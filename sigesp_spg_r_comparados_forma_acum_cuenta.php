...
<form name="form1" method="post" action="">
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td width="300" height="17" colspan="3" align="center">&nbsp;</td>
    </tr>
...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		{
		   pagina="reportes/sigesp_spg_rpp_comp_ejec_finan_acum_cuenta.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		           +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		           +"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato
	...
	{   codestpro4  = f.codestpro4.value;
		...
		else
		{
		   pagina="reportes/sigesp_spg_rpp_comp_ejec_finan_acum_cuenta.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		           ...
		           +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato
				   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas
				   +"&estclades="+estclades+"&estclahas="+estclahas;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
