<?php 
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(500,740,12,"Pag."); // Agregar texto
	...
	function uf_cabezera($as_nomresalm,$as_nompro,$as_nomreppro,$as_nombre,&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
	    $la_data=array(array('name'=>'Entre el <b>'.trim($as_nombre).'</b> representado en este acto por el ciudadano _____________________'),
	...
	function uf_cabezera_detalle(&$io_pdf)
	{
		...
		$la_data=array(array('codart'=>'<b>Codigo</b>','denart'=>'<b>Denominacion</b>','canart'=>'<b>Cantidad</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'center','width'=>130), // Justificaci�n y ancho de la 
									   ...
									   'preuniart'=>array('justification'=>'center','width'=>130))); // Justificaci�n y ancho de la 
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>306, // Orientaci�n de la tabla
						 'cols'=>array('codart'=>array('justification'=>'center','width'=>130), // Justificaci�n y ancho de la 
						 			   'denart'=>array('justification'=>'left','width'=>230), // Justificaci�n y  
						 			   'canart'=>array('justification'=>'right','width'=>60), // Justificaci�n y  
									   'preuniart'=>array('justification'=>'right','width'=>130))); // Justificaci�n y ancho de la 
