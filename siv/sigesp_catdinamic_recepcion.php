	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($li_row>0)
		{
			while($row=$io_sql->fetch_row($rs_cta))
			{
				...
				if($ls_estrevrec=="0")
				{
					print "<td><a href=\"javascript: aceptar_copiar_reverso('$ls_numconrec','$ls_numordcom','$ls_obsrec','$ls_codpro','$ls_nompro','$ls_codalm','$ls_nomfisalm','$ls_estpro','$ls_estrec','$ls_estrevrec','$ld_fecrec');\"><img src=../shared/imagebank/tools15/aprobado.gif alt=Aceptar title='Copiar el Reverso' width='15' height='15' border=0></a></td>";
				}
				else
				{
