...
<?php 
	...
	{
		require_once("sigesp_apr_carga_solicitudes.php");
						...
						<td height="20"><div id="tipodoc" align="left">
							...
							if($ls_operacion=="")
							{
								...
								require_once("../shared/class_folder/sigesp_include.php");
                                                                require_once("sigesp_apr_solicitudes_cxp.php");
                                                                
								$sig_con=new sigesp_include();
								$io_con=$sig_con->uf_conectar();
								$io_conexion_destino      = $sig_con->uf_conectar_otra_bd($_SESSION["ls_hostname_destino"], $_SESSION["ls_login_destino"], $_SESSION["ls_password_destino"], $_SESSION["ls_database_destino"], $_SESSION["ls_gestor_destino"]);
