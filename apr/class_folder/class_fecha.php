...
class class_fecha_apr
{
	...
	function class_fecha_apr()
	{
		...
		$this->io_connect=$this->io_include->uf_conectar_otra_bd($_SESSION["ls_hostname_destino"], $_SESSION["ls_login_destino"], $_SESSION["ls_password_destino"], $_SESSION["ls_database_destino"], $_SESSION["ls_gestor_destino"]);
 	...
 	{ ////////////////////////////////////////////////////////////////////////////////////////////	
	  ...
	  ////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $ls_sql="";
                 $as_fecha=$this->uf_convert_date_to_db($as_fecha);
		 $li_mes = intval(substr($as_fecha,5,2));		 
		 $ls_sql="SELECT m01,m02,m03,m04,m05,m06,m07,m08,m09,m10,m11,m12 FROM sigesp_empresa WHERE codemp = '".$as_codemp."'";
