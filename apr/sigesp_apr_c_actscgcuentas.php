		...
		else
		{
			...
			while(($row=$this->io_sql_origen->fetch_row($io_recordset))&&$lb_valido){
                                ...
                                if ($ls_sccuentao!=$ls_sccuentaonext){
                                    ...
                                    $ao_object[$ai_totrows][2]="<input name=txtsccuentaact".$ai_totrows." type=text id=txtsccuentaact".$ai_totrows." class=sin-borde size=50 maxlength=25 value='".$ls_cuentadestino."' readonly><a href=javascript:ue_search_scg('".$ai_totrows."');><img src='../shared/imagebank/tools20/buscar.gif' alt='Buscar' width='20' height='20' border='0'></a>";
