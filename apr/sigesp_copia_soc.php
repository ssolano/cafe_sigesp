				    ...
				    if (!empty($ls_codemp))
				       {
						 ...
						 $ls_sql = "INSERT INTO soc_servicios (codemp, codser, codtipser, denser, preser, spg_cuenta) 
						                               VALUES ('".$ls_codemp."','".$ls_codser."','".$ls_codtipser."','".$ls_denser."',".$ld_preser.",'".$ls_spgcta."')";
					     $li_row = $this->io_sql_destino->execute($ls_sql);
					     if ($li_row===false)
					        {
							  $lb_valido=false;
