<?php
	...
	$io_fun_apr->uf_load_seguridad("APR","sigesp_apr_actestructura.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$ls_ruta="resultado";
	@mkdir($ls_ruta,0755);
?>
...
<?php
require_once("sigesp_apr_c_actestructura.php");
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" align="center">Actualizar Estructuras Presupuestarias </td>
    </tr>
    <tr>
...
function ue_guardar()
{
	...
	f.action="sigesp_apr_actestructura.php";
	f.submit();
}

function ue_search_estpre1(fila)
{
	pagina="sigesp_apr_cat_estpre1.php?fila="+fila;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=610,height=400,resizable=yes,location=no");
}

function ue_search_estpre2(fila)
{
	pagina="sigesp_apr_cat_estpre2.php?fila="+fila;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=610,height=400,resizable=yes,location=no");
}

function ue_search_estpre3(fila)
{
	pagina="sigesp_apr_cat_estpre3.php?fila="+fila;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=610,height=400,resizable=yes,location=no");
}

function ue_search_estpre4(fila)
{
	pagina="sigesp_apr_cat_estpre4.php?fila="+fila;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=610,height=400,resizable=yes,location=no");
}

function ue_search_estpre5(fila)
{
	pagina="sigesp_apr_cat_estpre5.php?fila="+fila;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=610,height=400,resizable=yes,location=no");
}
