...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		{
		   pagina="reportes/sigesp_spg_rpp_comparados_forma0516.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		   +"&codestpro3h="+codestpro3h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes
