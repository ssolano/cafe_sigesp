...
function ue_showouput()
{
	...
	{
	   pagina="reportes/sigesp_spg_rpp_comparados_forma0518.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
...
function catalogo_estprohas2()
{
	...
	if((codestpro1h!=""))
	{
		pagina="sigesp_cat_public_estpro2.php?codestpro1="+codestpro1h+"&tipo=rephas0415&estcla="+estcla;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
