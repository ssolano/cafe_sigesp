...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_comparados_forma0402.php";
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td width="293" height="17" colspan="3" align="center"><div align="left"><span class="Estilo2"></span></div></td>
    </tr>
    ...
    <tr>
      <td height="14" colspan="3" align="center"><table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		...
		{
		   pagina="reportes/sigesp_spg_rpp_comp_ejec_finan_forma0407.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
	...
	else
	{
		...
		else
		{
		   pagina="reportes/sigesp_spg_rpp_comp_ejec_finan_forma0407.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		  		 ...
		  		 +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes
