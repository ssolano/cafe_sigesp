...
<script language="JavaScript">
	function aceptar(empresa,codigo,cedula,nombre,apellido,telefono,nota,status,codviejo,foto,ultingusu)
	{
	...
	function ue_search()
	{
		...
		f.action="sigesp_cat_usuarios.php";
		f.submit();
	}
</script>
</html>
