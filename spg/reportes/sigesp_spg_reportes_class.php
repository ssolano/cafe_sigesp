		 ...
		 if($lb_valido)
		 {
			if ($ai_numrows)
			{
				 ...
				 { 
						 ...
						 if ($li_encontrado<=0) // IMPRIMIR PROYECTO
							{
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('proyecto2'=>$ls_estpro1_aux,'accion2'=>$ls_estpro2_aux,'ejecutora2'=>$ls_estpro3_aux,'operacion'=>$ls_operacion),'proyecto');
						  //print "Encontrado => ".$li_encontrado.'<br>';
						 
						 if ($li_encontrado<=0)  // IMPRIMIR ACCION
							{
							 $this->io_dsreport->insertRow("proyecto","");
						...
						if (strtoupper($_SESSION["ls_gestor"]) <> "INFORMIX")
						{
						 ...
						 if ($li_encontrado<=0) // IMPRIMIR PARTIDAS ...
							{
							 $this->io_dsreport->insertRow("proyecto","");
							 $this->io_dsreport->insertRow("accion","");
							 $this->io_dsreport->insertRow("ejecutora","");
							 $this->io_dsreport->insertRow("partida",$la_cuenta[0]); // Partidas...
							 $this->io_dsreport->insertRow("generica","");
							 $this->io_dsreport->insertRow("especifica","");
							 $this->io_dsreport->insertRow("subespecifica","");
							 $this->io_dsreport->insertRow("proyecto2",$ls_estpro1_aux);
						 ...
						 if ($li_encontrado<=0) // IMPRESION GENERICA
							{
							 $this->io_dsreport->insertRow("proyecto","");
							 $this->io_dsreport->insertRow("accion","");
							 $this->io_dsreport->insertRow("ejecutora","");
							 $this->io_dsreport->insertRow("partida","");
							 $this->io_dsreport->insertRow("generica",$la_cuenta[1]); // generica
							 $this->io_dsreport->insertRow("especifica","");
							 $this->io_dsreport->insertRow("subespecifica","");
							 $this->io_dsreport->insertRow("proyecto2",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("accion2",$ls_estpro2_aux);
						 ...
						 if ($li_encontrado<=0) // IMPRESION ESPECIFICA
							{
							 $this->io_dsreport->insertRow("proyecto","");
							 $this->io_dsreport->insertRow("accion","");
							 $this->io_dsreport->insertRow("ejecutora","");
							 $this->io_dsreport->insertRow("partida","");
							 $this->io_dsreport->insertRow("generica","");
							 $this->io_dsreport->insertRow("especifica",$la_cuenta[2]); // especifica
							 $this->io_dsreport->insertRow("subespecifica","");
							 $this->io_dsreport->insertRow("proyecto2",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("accion2",$ls_estpro2_aux);
							 $this->io_dsreport->insertRow("ejecutora2",$ls_estpro3_aux);
						 ...
						 if ($ls_subespaux!='00')
							{
							 ...
							 else
							 {
							  $this->uf_select_data("SELECT spg_cuentas.denominacion as denctaspg, sum(spg_dtmp_cmp.monto) as monto
							   ...
							   if ($li_encontrado<=0) // IMPRESION SUBESPECIFICA
								  {
									 $this->io_dsreport->insertRow("proyecto","");
									 $this->io_dsreport->insertRow("accion","");
									 $this->io_dsreport->insertRow("ejecutora","");
									 ...
									 $this->io_dsreport->insertRow("generica","");
									 $this->io_dsreport->insertRow("especifica","");
									 $this->io_dsreport->insertRow("subespecifica",$la_cuenta[3]); // subespecifica
									 $this->io_dsreport->insertRow("proyecto2",$ls_estpro1_aux);
									 $this->io_dsreport->insertRow("accion2",$ls_estpro2_aux);
									 $this->io_dsreport->insertRow("ejecutora2",$ls_estpro3_aux);
									 $this->io_dsreport->insertRow("partida2",$la_cuenta[0]);
