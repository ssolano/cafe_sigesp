<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,&$io_pdf,$ls_tipo_fuente,$unidad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if($ls_tipo_fuente=='01'){$fuente='ORDINARIOS';}else{$fuente='EXTRAORDINARIOS';}
		$anio = date('Y');
		...
		$io_pdf->addText(30,760,6,"(1)CÓDIGO PRESUPUESTARIO Y DENOMINACIÓN DEL ENTE:A1554 - COORPORACIÓN VENEZOLANA DE CAFÉ, S.A.");
		$io_pdf->addText(30,750,6,"ÓRGANO DE ADSCRIPCIÓN: MINISTERIO DEL PODER POPULAR PARA LA AGRICULTURA Y TIERRA");
		$io_pdf->addText(30,740,6,"PERÍODO PRESUPUESTARIO: AÑO ".$anio);
		//$io_pdf->addText(383,750,8,"<b>PÁGINA N°.</b>");
		//$io_pdf->addText(510,745,8,"COD.");
		$io_pdf->addText(520,695,6,"FECHA:".$ad_fecha);
		$io_pdf->addText(30,705,7,"FUENTE DE FINANCIAMIENTO: ".$fuente);
		$io_pdf->addText(350,705,7,"UNIDAD ADMINISTRADORA: ".$unidad);
		//$io_pdf->addText(180,730,10,$as_titulo);
		$io_pdf->addText($tm,725,8,$as_titulo);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->Rectangle(19,80,570,50);

        $io_pdf->Rectangle(19,40,570,60);
		$io_pdf->line(19,80,590,80);		
		$io_pdf->line(90,40,90,100);		
		$io_pdf->line(160,40,160,100);		
		$io_pdf->line(230,40,230,100);
		$io_pdf->line(300,40,300,130);		
		$io_pdf->line(370,40,370,100);	
		$io_pdf->line(440,40,440,130);
		$io_pdf->line(510,40,510,100);
		
		
		$io_pdf->addText(80,110,7,"<b>COORPORACIÓN VENEZOLANA DEL CAFÉ</b>"); // Agregar el título
		$io_pdf->addText(305,115,7,"<b>     MINISTERIO DEL PODER POPULAR</b>"); // Agregar el título
		$io_pdf->addText(317,107,7,"<b>PARA LA AGRICULTURA Y TIERRA</b>"); // Agregar el título
		//$io_pdf->addText(305,115,7,"<b>VICEPRESIDENCIA DE LA REPÚBLICA</b>"); // Agregar el título
		//$io_pdf->addText(317,107,7,"<b>BOLIVARIANA DE VENEZUELA</b>"); // Agregar el título
		$io_pdf->addText(450,110,7,"<b>OFICINA NACIONAL DE PRESUPUESTO</b>"); // Agregar el título
		

			
		$io_pdf->addText(23,90,4,"RESPONSABLE DEL PROYECTO:"); // Agregar el título
		$io_pdf->addText(100,90,4,"GCIA. ADMIN. Y FINANZAS:"); // Agregar el título
		$io_pdf->addText(175,90,4,"GCIA. PLANIFICACIÓN"); // Agregar el título
		$io_pdf->addText(180,85,4,"Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(235,90,4,"PRESIDENTE COORPORACIÓN"); // Agregar el título
		$io_pdf->addText(315,90,4,"DIR. PLANIFICACIÓN"); // Agregar el título
		$io_pdf->addText(317,85,4,"Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(377,92,4,"                MINISTRO"); // Agregar el título
		//$io_pdf->addText(379,87,4,"       LA REPÚBLICA"); // Agregar el título
		//$io_pdf->addText(375,82,4,"BOLIVARIANA DE VENEZUELA");
		$io_pdf->addText(465,90,4,"DIRECTOR"); // Agregar el título
		$io_pdf->addText(530,90,4,"DIRECTOR GENERAL"); // Agregar el título
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	  ...
	  $ld_fecha       = $_GET["fecha"];
	  $ls_tipo_fuente  = $_GET["fuentefin"];
	  $ls_tipo_unidad  = $_GET["unidad"];
	  ...
	  if ($lb_valido==false)
	   ...
	   else
		 {
			...
			uf_print_encabezado_pagina($ls_titulo,$ls_procede,$ld_fecha,$io_pdf,$ls_tipo_fuente,$ls_tipo_unidad); // Imprimimos el encabezado de la página
