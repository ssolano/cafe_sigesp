<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_procede,$ad_fecha,&$io_pdf,$ls_tipo_fuente,$unidad)
	{
		...
		$io_pdf->addText(30,750,6,"ÓRGANO DE ADSCRIPCIÓN: VICEPRESIDENCIA DE LA REPÚBLICA BOLIVARIANA DE VENEZUELA");
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(377,93,4,"  VICEPRECIDENTE DE"); // Agregar el título
		$io_pdf->addText(379,88,4,"       LA REPÚBLICA"); // Agregar el título
		$io_pdf->addText(375,83,4,"BOLIVARIANA DE VENEZUELA");
