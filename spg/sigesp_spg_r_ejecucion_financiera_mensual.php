...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			{
				   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_mensual.php?codestpro1="+codestpro1
				   ...
				   +"&cmbmesdes="+cmbmesdes+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
		...
		else
		{
			...
			else
			{
				   ...
				   +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
				   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&estclades="+estclades
				   +"&estclahas="+estclahas;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			{
			   pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_mensual_excel.php?codestpro1="+codestpro1
			   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
			   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
			   +"&cmbmesdes="+cmbmesdes+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
			   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&estclades="+estclades
		...
		else
		{
			...
			else
			{
			   ...
			   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
			   +"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&codestpro4h="+codestpro4h
			   +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes
