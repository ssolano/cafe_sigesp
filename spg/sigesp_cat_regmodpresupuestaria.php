...
if($ls_operacion=="BUSCAR")
{
 ...
 print "<td align='center'>Mes Disminucion</td>";
 print "<td align='center'>Mes Aumento</td>";
                    ...
                    ls_denestpro3,ls_denestpro4,ls_denestpro5,ls_estcla,ls_spg_cuenta,ls_mesaum,ls_mesdis,ld_fecha,ld_monto)
{
 ...
 f.action="sigesp_spg_p_modprog.php";
 f.submit();
 close();
}
...
function ue_search()
  {
	  ...
	  { 
	   ...
	   f.action="sigesp_cat_regmodpresupuestaria.php";
	   f.submit();
	  } 
  }
