...
class sigesp_scv_class_report
{
	...
	function uf_select_solicitudpago_spg($as_codemp,$as_codsolvia)	
	{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		$ls_sql= "SELECT codestpro1, codestpro2, spg_cuenta, estcla, ".
				 "      (SELECT denestpro1 ".
				 "		  FROM spg_ep1 ".
				 "      WHERE spg_ep1.codestpro1 = scv_dt_spg.codestpro1 AND spg_ep1.estcla = scv_dt_spg.estcla) AS denestpro1, ".
				 "      (SELECT denestpro2 ".
				 "		  FROM spg_ep2 ".
				 "      WHERE spg_ep2.codestpro1 = scv_dt_spg.codestpro1 ".
				 "		   AND spg_ep2.codestpro2 = scv_dt_spg.codestpro2 AND spg_ep2.estcla = scv_dt_spg.estcla) AS denestpro2 ".
				 "  FROM scv_dt_spg ".
				 " WHERE codemp='".$as_codemp."'".
				 "   AND codsolvia='".$as_codsolvia."'".
				 " GROUP BY spg_cuenta, codestpro1, codestpro2,estcla  ";
