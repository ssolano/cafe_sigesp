...
class intGastosDao extends ADOdb_Active_Record
{
	...
	{
		global $db;
		$sql0="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4050102%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs0 = $db->Execute($sql0);
		$sql1="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070103%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs1 = $db->Execute($sql1);
		$sql2="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070104%' and {$this->_table}.codemp='{$this->codemp}'";
		//echo $sql2;
		$Rs2 = $db->Execute($sql2);
		$sql3="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070303%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs3 = $db->Execute($sql3);
		$sql4="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070304%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs4 = $db->Execute($sql4);
	...
	{
		global $db;
		$sql1="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070101%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs1 = $db->Execute($sql1);
		$sql2="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070102%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs2 = $db->Execute($sql2);
		$sql3="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070301%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs3 = $db->Execute($sql3);
		$sql4="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_int_cuentas.enero+spe_int_cuentas.febrero+spe_int_cuentas.marzo+spe_int_cuentas.abril+spe_int_cuentas.mayo+spe_int_cuentas.junio+spe_int_cuentas.julio+spe_int_cuentas.agosto+spe_int_cuentas.septiembre+spe_int_cuentas.octubre+spe_int_cuentas.noviembre+spe_int_cuentas.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_int_cuentas on sigesp_plan_unico_re.sig_cuenta=substr(spe_int_cuentas.sig_cuenta,1,9) where spe_int_cuentas.sig_cuenta like '4070302%' and {$this->_table}.codemp='{$this->codemp}'";
		$Rs4 = $db->Execute($sql4);
...
public function tieneMovimiento2($grupoCuenta)
{
		...
		{
			$sql="select * from sfp_dt_cmp_variacion inner join sigesp_sfp_cmp 
				on sfp_dt_cmp_variacion.comprobante=sigesp_sfp_cmp.comprobante 
				where sfp_dt_cmp_variacion.sig_cuenta like '{$grupoCuenta}%' and sigesp_sfp_cmp.codemp='{$this->codemp}' 
				and sigesp_sfp_cmp.ano_presupuesto={$this->ano_presupuesto}";
			//if($grupoCuenta=="40505")
			 //ver($sql);
			$rs=$db->Execute($sql);
			if($rs->RecordCount()>0)
			{
