...
{
	global $db;
	$sql1="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_plan_ingr.enero+spe_plan_ingr.febrero+spe_plan_ingr.marzo+spe_plan_ingr.abril+spe_plan_ingr.mayo+spe_plan_ingr.junio+spe_plan_ingr.julio+spe_plan_ingr.agosto+spe_plan_ingr.septiembre+spe_plan_ingr.octubre+spe_plan_ingr.noviembre+spe_plan_ingr.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_plan_ingr on sigesp_plan_unico_re.sig_cuenta=substr(spe_plan_ingr.sig_cuenta,1,9) where spe_plan_ingr.sig_cuenta like '3050103%'";
	$Rs1 = $db->Execute($sql1);
	$sql2="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_plan_ingr.enero+spe_plan_ingr.febrero+spe_plan_ingr.marzo+spe_plan_ingr.abril+spe_plan_ingr.mayo+spe_plan_ingr.junio+spe_plan_ingr.julio+spe_plan_ingr.agosto+spe_plan_ingr.septiembre+spe_plan_ingr.octubre+spe_plan_ingr.noviembre+spe_plan_ingr.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_plan_ingr on sigesp_plan_unico_re.sig_cuenta=substr(spe_plan_ingr.sig_cuenta,1,9) where spe_plan_ingr.sig_cuenta like '3050104%'";
	$Rs2 = $db->Execute($sql2);
	$sql3="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_plan_ingr.enero+spe_plan_ingr.febrero+spe_plan_ingr.marzo+spe_plan_ingr.abril+spe_plan_ingr.mayo+spe_plan_ingr.junio+spe_plan_ingr.julio+spe_plan_ingr.agosto+spe_plan_ingr.septiembre+spe_plan_ingr.octubre+spe_plan_ingr.noviembre+spe_plan_ingr.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_plan_ingr on sigesp_plan_unico_re.sig_cuenta=substr(spe_plan_ingr.sig_cuenta,1,9) where spe_plan_ingr.sig_cuenta like '3050203%'";
	$Rs3 = $db->Execute($sql3);
	$sql4="select sigesp_plan_unico_re.sig_cuenta, denominacion,(spe_plan_ingr.enero+spe_plan_ingr.febrero+spe_plan_ingr.marzo+spe_plan_ingr.abril+spe_plan_ingr.mayo+spe_plan_ingr.junio+spe_plan_ingr.julio+spe_plan_ingr.agosto+spe_plan_ingr.septiembre+spe_plan_ingr.octubre+spe_plan_ingr.noviembre+spe_plan_ingr.diciembre) as montoglobal from sigesp_plan_unico_re inner join spe_plan_ingr on sigesp_plan_unico_re.sig_cuenta=substr(spe_plan_ingr.sig_cuenta,1,9) where spe_plan_ingr.sig_cuenta like '3050204%'";
	$Rs4 = $db->Execute($sql4);
