...
<form name="form1" method="post" action="">
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td width="302" height="17" colspan="3" align="center">&nbsp;</td>
    </tr>
...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		{
		   pagina="reportes/sigesp_spg_rpp_comparados_forma0517.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
	...
	else
	{
		...
		else
		{
		   ...
		   pagina="reportes/sigesp_spg_rpp_comparados_forma0517.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		   ...
		   +"&codestpro5h="+codestpro5h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes
