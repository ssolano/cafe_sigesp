<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","sigesp_scg_r_comparados_oaf.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/sigesp_scg_rpp_comparado_oaf.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/sigesp_scg_rpp_comparado_oaf.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&nivel="+li_nivel+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
