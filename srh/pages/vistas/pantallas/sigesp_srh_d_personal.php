  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecfevid', '%d/%m/%Y');" value=" ... " />          </td>
        ...
        <tr>
          ...
          <td colspan="2"><div align="left">
            ...
            <input name="chkcajahoper" type="checkbox" class="sin-borde" id="chkcajahoper" value="1" onClick="javascript: ue_chequear_caja_ahorro();"  >
          </div></td>
        </tr>
		<tr>
          <td height="22"><div align="right">Porcentaje Caja de Ahorro </div></td>
          <td colspan="2"><div align="left">
              <input name="txtporcajahoper" type="text" id="txtporcajahoper"  size="8" maxlength="5" style="text-align:left" onKeyPress='return validarreal2(event,this);' readonly>
          </div></td>
        </tr>
        <tr>
