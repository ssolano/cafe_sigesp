...
class sigesp_sss_c_derechousuarios
{
	...
	function  uf_sss_insert_permisos_internos($as_codemp,$as_codusu,$as_codsis,$as_codintper,$aa_seguridad)
	{
		...
		$lb_existe=$this->uf_select_permisos_internos_defecto($as_codemp,$as_codsis,$as_codusu,$ls_auxcodintper);
		if(!$lb_existe)
		{
			$this->io_sql->begin_transaction();
    ...
    function uf_select_permisos_internos_defecto($as_codemp,$as_codsis,$as_codusu,&$aa_codintper)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_select_permisos_internos_defecto
		//         Access: public (sigesp_c_permisos_globales)
		//      Argumento: $as_codemp    // codigo de empresa
		//      		   $as_codsis    // codigo del sistema
		//      		   $as_codusu    // codigo de usuario
		//      		   $aa_codintper // arreglo de los codigos internos de permisologia
		//    Description: Función que se encarga de verificar si el usuario tiene codigos internos de permisos por defecto  
		...
		return $lb_valido;
	}  //  end  function uf_select_permisos_internos_defecto
