...
function ue_cancelar()
{
   ...
   deshabilitar("txtfecliq,txtnumliq,txtcodper,txtnomper,txtapeper,txtcodnom,txtdennom,txtcargo,txtfecingper,txtsalintper,txtsalintdia,txtano,txtmes,txtdia,cmbcauret,txtfecdes,txtfechas,txtdescripcion,txtdiasal,txtmonto,cmbarticulo,txtsc_cta_ps,btnantiguedad,btnvacacion,btnbonvac,btncalcular,btnincluir,btndeudaanterior");
   scrollTo(0,0);
}
/*****************************************************************
...
function ue_tiempo_servicio()
{
	if ( (ue_valida_null($('txtfecingper')))&& (ue_valida_null($('txtfecegrper'))) )
	{
		...
		ls_ano = restarFechas("txtfecingper","txtfecegrper","a");
		ls_mes = restarFechas("txtfecingper","txtfecegrper","m");
		//años
...
{ 
	ue_cancelar();
	$('hidguardar').value = "modificar";
	var cajas = new Array('txtnumliq','txtnomper','txtapeper','txtcodper','txtcodnom','txtdennom','cmbcauret','txtfecliq','txtfecingper','txtfecegrper','txtsalintper','txtcargo','txtano','txtmes','txtdia','txtasignacion','txtdeduccion','txttotal','txtestliq','txtdedicacion','txttipopersonal');
...
function ue_aplicar_articulo(literal)
{
	...
	{      
                $('hidtiempo').value  = ls_tiempo;
		li_dias = ue_calcular_dias_acum( li_meses );
...
//--------------------------------------------------------------------------------------------------------------------------------------------//
function ue_calcular_dias_acum( ai_meses )
{       
