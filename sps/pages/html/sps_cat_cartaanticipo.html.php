...
<html>
<head>
<title>Catálogo de Cartas de Anticipos</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_cartaanticipo.js"></script>
...
<form name="form1" method="post" action="">
 <table width="400" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  ...
	  Cat&aacute;logo de Cartas de Anticipos </td>
	</tr>
