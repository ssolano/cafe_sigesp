...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_spg_cuenta.js"></script>

<link href="../../../shared/css/ventanas.css" rel="stylesheet" type="text/css">
<link href="../../../shared/css/tablas.css" rel="stylesheet" type="text/css">
</head>

<body onLoad="javascript:ue_ver_spg_cuentas();">
<form name="form1" method="post" action="">
 <table width="500" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  <td colspan="2" class="titulo-ventana">
	  Cat&aacute;logo de Cuentas Presupuestarias </td>
	</tr>
	...
	<tr>
	  ...
	  <td width="69%"><label>
	  <input name="txtcodigo" type="text" id="txtcodigo" onKeyPress="return validaCajas(this,'i',event,50);" onKeyUp="ue_ver_spg_cuentas(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td><div align="right">Denominación    </div>
	  <td><label>
	    <input name="txtdenominacion" type="text" id="txtdenominacion" onKeyPress="return validaCajas(this,'s',event,50);" onKeyUp="ue_ver_spg_cuentas(this);">
	  </label>      
	  <td>        </tr>
	<tr>
	  <td colspan="2">    
