...
<html>
<head>
<title>Convertidor Prestaciones Sociales</title>
...
<script type="text/javascript" language="javascript1.2" src="../js/sps_conv_prestaciones.js"></script>
</head>
        ...
        <td width="516" height="174">
		 <div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr >
              <td></td>
              <td colspan="2" class="titulo-ventana">Convertidor Prestaciones Sociales </td>
            </tr>
            <tr>
              <td></td>
              <td >&nbsp;</td>
