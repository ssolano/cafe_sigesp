...
<script type="text/javascript" language="javascript1.2" src="../js/sps_cat_personal_anticipo.js"></script>
...
<form name="form1" method="post" action="">
 <table width="596" border="0"  class="formato-blanco" >
	<tr class="titulo-celda">
	  ...
	  Cat&aacute;logo de Personal - Anticipos </td>
	</tr>
	<tr><td colspan="2"></tr>
	<tr>
	  <td colspan="2">	  </tr>
	...
	<tr>
	  ...
	  <td><label></label>      
	    <label>
	    <input name="btnbuscar" type="button" id="btnbuscar" value="Buscar" onClick="ue_ver_anticipo();">
      </label>	  </tr>
	<tr>
	  <td colspan="2">	  </tr>
	<tr><td colspan="2">
 ...
 <table id="data_grid_header" width="600" class="fondo-tabla" cellpadding="1" cellspacing="1">
  <tr class="estilo-celda">
   <td width="120" class="titulo-celda"> Código </font></td>
   <td width="170" class="titulo-celda"> Nombre </font></td>
   <td width="170" class="titulo-celda"> Apellido </font></td>
   <td width="140" class="titulo-celda"> Fecha Anticipo </font></td>
  </tr>
 </table>
