...
if  (array_key_exists("cmbbanco",$_POST))
	{
	  ...
	  $ls_tipoctabanco=$_POST["cmbtipoctabanco"];
      $lr_datos["banco"]=$ls_banco;
      $lr_datos["tipoctabanco"]=$ls_tipoctabanco;
    }
else
	{
	  $ls_banco="---";
 ...
 <p>&nbsp;  </p>
   ...
   <table width="770"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <?php 
    	 $ls_corriente    = "";
         $ls_ahorro  = "";
         $ls_tipoctaban = $row["tipoctaban"];
		 if ($ls_tipoctaban=="0")    
            {
              $ls_corriente    = "selected";
			}
         elseif($ls_ahorro=="1")
            {
              $ls_ahorro  = "selected";
    ...
    ?>
    <tr>
      <td height="22" align="right">Tipo de Cuenta </td>
      <td height="22" colspan="4"><select name="cmbtipoctabanco" class="contorno" id="cmbtipoctabanco" style="width:120px" tabindex="18">
        <option value="0">---seleccione---</option>
        <option value="1" <?php print $ls_corriente ?>>Corriente</option>
        <option value="2" <?php print $ls_ahorro  ?>>Ahorro</option>
      </select></td>
    </tr>
    <tr>
...
function ue_nuevo()
		{
	      ...
	      {			 
				  ...
				  f.cmbtipoctabanco[0].selected=true;
				  f.txtmonmax.value="";
				  f.txtcapital.value="";
				  f.txtcuenta.value="";
				  f.txtcontable.value="";
