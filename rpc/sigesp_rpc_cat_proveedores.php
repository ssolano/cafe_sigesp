		...
		while (!$rs_data->EOF)
			  {
					$lb_existe=true;
						...
						$ls_tipoctabanco=$rs_data->fields["tipoctaban"];
						...
						'$ls_banco','$ls_tipoctabanco','$ls_cuenta','$ls_moneda','$ls_provee','$ls_contra','$ls_contable','$ls_denocontable','$ls_observacion','$ls_cedula','$ls_nomrep','$ls_cargo',
...
function aceptar(codpro,nompro,dirpro,tipoorg,telpro,faxpro,nacpro,especialidad,rifpro,nitpro,capital,monmax,banco,tipoctabanco,cuenta,moneda,provee,contra,contable,denocontable,observacion,cedula,nomrep,cargo,
				 ...
				 regSSO,fecvenSSO,regINCE,fecvenINCE,emailrep,grado,codbansig,denbansig,ls_tipconpro,registronacional,contablerecdoc,as_tipperrif,as_numpririf,as_numterrif,ctaant,denctaant,tipperpro)
  {
	...
	opener.document.form1.cmbtipoctabanco.value        = tipoctabanco;
