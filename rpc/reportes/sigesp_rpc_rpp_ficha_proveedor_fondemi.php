...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	unset($la_columna);
	unset($la_config);
	$la_columna = array('denominacion'=>'                                    Denominaci�n','recepcion'=>'Fecha Recepci�n','vencimiento'=>'Fecha Vencimiento','estatus'=>'Estatus');
		 ...
		 for ($z=1;$z<=$li_total;$z++)
			 {
			   ...
			   $io_pdf->addText(350,530,10,'<b>CUENTA:</b>');
			   $io_pdf->addText(400,530,10,$ls_cuenta);
