<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(230,725,11,$as_titulo); // Agregar el t�tulo
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>62), // Justificaci�n y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>188), // Justificaci�n y ancho de la columna
						 			   'rif'=>array('justification'=>'center','width'=>80), // Justificaci�n y ancho de la columna
						 			   'telefono'=>array('justification'=>'center','width'=>120), // Justificaci�n y ancho de la columna
						 			   'ocei'=>array('justification'=>'center','width'=>100))); // Justificaci�n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('direccion'=>array('justification'=>'left','width'=>550))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->setStrokeColor(0,0,0);
	...
	// Fecha Creaci�n: 21/04/2006 
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_columna=array('codigo'=>'<b>C�digo</b>','nombre'=>'<b>Nombre</b>','rif'=>'<b>Rif</b>','telefono'=>'<b>Tel�fono</b>','ocei'=>'<b>No OCEI</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho M�ximo de la tabla
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>62), // Justificaci�n y ancho de la columna
									   'nombre'=>array('justification'=>'left','width'=>188), // Justificaci�n y ancho de la columna
									   'rif'=>array('justification'=>'center','width'=>80), // Justificaci�n y ancho de la columna
									   'telefono'=>array('justification'=>'left','width'=>120), // Justificaci�n y ancho de la columna
									   'ocei'=>array('justification'=>'left','width'=>100))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_documentos($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('direccion'=>array('justification'=>'center','width'=>550))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_datos,$la_columna,'',$la_config);
		unset($la_datos);
		unset($la_columna);
		unset($la_config);
		$la_columna = array('denominacion'=>'                                <b>Denominaci�n</b>','recepcion'=>'<b>Fecha Recepci�n</b>','vencimiento'=>'<b>Fecha Vencimiento</b>','estatus'=>'<b>Estatus</b>');
		$la_config  = array('showHeadings'=>1,     // Mostrar encabezados
							...
							'width'=>550, // Ancho de la tabla
							'maxWidth'=>550,
							'cols'=>array('denominacion'=>array('justification'=>'left','width'=>300), // Justificaci�n y ancho de la columna Nro de Operacion.
	...
	if ($lb_valido)
    {
		...
		$io_pdf->ezSetCmMargins(4.2,3,3,3); // Configuraci�n de los margenes en cent�metros
