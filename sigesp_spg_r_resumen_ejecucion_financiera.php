...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="sigesp_spg_r_resumen_ejecucion_financiera.php";
...
<title>Resumen de Ejecuci&oacute;n Financiera de Gasto</title>
...
?>
  <table width="400" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="576" colspan="2" class="titulo-celdanew">Resumen de Ejecuci&oacute;n Financiera de Gasto </td>
    </tr>
  </table>
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
	   ...
	   ?>
        <table width="275" height="77" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="titulo-celda">
            <td height="13" colspan="9" valign="top" class="titulo-celdanew"><strong class="titulo-celdanew">Estructura Presupuestaria</strong></td>
          </tr>
          <tr class="formato-blanco">
            ...
            <td width="15" colspan="6"><a href="javascript:catalogo_estpro2();"></a><a href="javascript:catalogo_estpro3();"></a></td>
          </tr>
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td height="20">
            ...
            <td width="15" colspan="6"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
          <tr class="formato-blanco">
            <td width="54"><!--DWLayoutEmptyCell-->&nbsp;</td>
            <td width="129" height="22"><div align="right">
            ...
            <td width="75" height="22"><a href="javascript:catalogo_estpro3();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
            <td width="15" colspan="6"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
        </table>
    ...
    <tr>
      <td height="13" colspan="3" align="center"><div align="left">
        ...
        <table width="275" height="117" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          <!--DWLayoutTable-->
          <tr class="titulo-celda">
            <td height="13" colspan="4" valign="top" class="titulo-celdanew"><strong class="titulo-celdanew"> Codigo Programatico</strong></td>
          </tr>
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
            ...
            <td width="76" height="20"><a href="javascript:catalogo_estpro1();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></td>
            <td></td>
          </tr>
          <tr class="formato-blanco">
            <td><!--DWLayoutEmptyCell-->&nbsp;</td>
    ...
    <tr>
      <td height="13" colspan="3" align="center"><table width="278" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
          <td height="13" colspan="3"><strong class="titulo-celdanew"> Cuenta Presupuestaria </strong></td>
        </tr>
        <tr>
          <td width="114" height="22"><div align="right"><span class="style1 style14">Cuenta</span></div></td>
          <td width="162"><div align="left">
              <input name="txtcuenta" style="text-align:center" type="text" id="txtcuenta" size="10" maxlength="3">
			  </div>
          </td>
    ...
    <tr>
      <td colspan="3" align="center">      <div align="left">
        <table width="278" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="3"><strong class="titulo-celdanew"> Hasta la Fecha </strong></td>
          </tr>
          <tr>
            <td width="113" height="22"><div align="right">Fecha</div></td>
            <td width="163"><div align="left">
                <input name="txtfecha" style="text-align:center" type="text" id="txtfecha" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ldt_fecha ; ?>" size="15" maxlength="15" datepicker="true">
            </div></td>
          </tr>
        </table>
      </div></td>
	...
	?>
      <td height="22" colspan="3" align="center"><div align="right"><span class="Estilo1">
        <input name="estclades" type="hidden" id="estcla" value="<?php print $ls_estcla;?>">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_presupuesto.php?codestpro1="+codestpro1
					+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&txtcuenta="+txtcuenta
					+"&estcla="+estcla+"&fecha="+fecha;
		...
		else
		{
			...
			pagina="reportes/sigesp_spg_rpp_ejecucion_financiera_presupuesto.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
			+"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5
			+"&txtcuenta="+txtcuenta+"&estcla="+estcla+"&fecha="+fecha;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
	else
