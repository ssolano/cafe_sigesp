<?php
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$io_pdf->addText(50,66,10,'<b>Ley de IVA - Articulo 11. </b>La Administración Tributaria podrá designar como responsables del pago del impuesto, ');
                $io_pdf->addText(50,56,10,'en calidad de agentes de retención, a quienes por sus funciones públicas o por razón de sus actividades privadas');
