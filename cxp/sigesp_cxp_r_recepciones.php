<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","sigesp_cxp_r_recepciones.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/sigesp_cxp_rpp_recepciones.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&codtipdoc="+codtipdoc+"&registrada="+registrada+"&procesada="+procesada+"&anulada="+anulada+"&orden="+orden+"&tiporeporte="+tiporeporte+"";
