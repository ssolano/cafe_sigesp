...
function ue_catalogorecepciones()
{
	...
	if(codproben!="")
	{
			window.open("sigesp_cxp_cat_recepcion.php?tipdes="+tipdes+"&codproben="+codproben+"&nombre="+nombre+"&tipo=SOLICITUDPAGO","_blank","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
