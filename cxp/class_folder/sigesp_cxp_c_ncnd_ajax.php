	  ...
	  for ($li_i=1;$li_i<=$li_totrowpre;$li_i++)
	      {
		    ...
		    $lo_object2[$li_i][1] = "<input type=text name=txtcuentaspgncnd".$li_i." id=txtcuentaspgncnd".$li_i." class=sin-borde style=text-align:center size=22 value='".$ls_spgcta."'       readonly onClick='javascript:uf_select_filadelete($li_i);'><input type=hidden name=txtscgcuentadt".$li_i."    id=txtscgcuentadt".$li_i."  value='$ls_scgcuenta'    readonly><input type=hidden name=txtdenscgcuentadt".$li_i."    id=txtdenscgcuentadt".$li_i."  value='$ls_denctascg'><input type=hidden name=txtestcargo".$li_i."    id=txtestcargo".$li_i."  value=''>";
