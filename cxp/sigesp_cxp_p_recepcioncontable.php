<?php
   ...
   global $verificar; // Variable agragada para la carga por lotes o simultanea de datos en la recepción de documentos...
   global $ls_codrecdocV; // Variable agragada para la carga por lotes o simultanea de datos en la recepción de documentos...
   $verificar = '';
   $ls_codrecdocV = '';
   //--------------------------------------------------------------
   function uf_limpiarvariables()
   {
		...
		global $ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_estact,$ls_disabled,$ls_rifpro;
   ...
   function uf_load_variables()
   {
		...
		global $ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_estact,$ls_disabled,$ls_rifpro;
...
<?php
	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
			...
			/* Fin código agregado*/
			$verificar = 'verifica';
			uf_load_variables(); // Función modificada para la carga por lotes de la recepción de documentos...
			//uf_load_variables();
			$lb_valido=$io_cxp->uf_guardar($ls_existe,$ls_numrecdoc,$ls_tipodestino,$ls_codprovben,$ls_codtipdoc,$ld_fecregdoc,
										   ...
										   $ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_estact,$la_seguridad);
...
<input name="tipocontribuyente" type="hidden" id="tipocontribuyente" value="<?php print $ls_tipocontribuyente;?>">
          ...
          <input name="clactacont" type="hidden" id="clactacont" value="<?php print $_SESSION["la_empresa"]["clactacont"]; ?>">
